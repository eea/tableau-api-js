...
!function () {
  ...
  var e = {};!function (e) {
    ...
    var t,
      ...
      } });a.initClass(T);var E = a.EventArgs = a.mkType(a, "ss.EventArgs", function () {});a.initClass(E), E.Empty = new E();var k = a.Exception = a.mkType(a, "ss.Exception", function (e, t) {
      ...
      } });a.initClass(k);var A = a.NotImplementedException = a.mkType(a, "ss.NotImplementedException", function (e, t) {
      k.call(this, e || "The method or operation is not implemented.", t);
    });a.initClass(A, k);var V = a.NotSupportedException = a.mkType(a, "ss.NotSupportedException", function (e, t) {
      k.call(this, e || "Specified method is not supported.", t);
    });a.initClass(V, k);var N = a.JsErrorException = a.mkType(a, "ss.JsErrorException", function (e, t, i) {
      k.call(this, t || e.message, i), this.error = e;
    }, { get_stack: function get_stack() {
        return this.error.stack;
      } });a.initClass(N, k);var O = a.ArgumentException = a.mkType(a, "ss.ArgumentException", function (e, t, i) {
      k.call(this, e || "Value does not fall within the expected range.", i), this.paramName = t || null;
    });a.initClass(O, k);var F = a.ArgumentNullException = a.mkType(a, "ss.ArgumentNullException", function (e, t, i) {
    ...
    });a.initClass(R, k);var x = a.ArithmeticException = a.mkType(a, "ss.ArithmeticException", function (e, t) {
      k.call(this, e || "Overflow or underflow in the arithmetic operation.", t);
    });a.initClass(x, k);var P = a.OverflowException = a.mkType(a, "ss.OverflowException", function (e, t) {
    ...
    });a.initClass(U, k);var M = a.InvalidOperationException = a.mkType(a, "ss.InvalidOperationException", function (e, t) {
      k.call(this, e || "Operation is not valid due to the current state of the object.", t);
    });a.initClass(M, k);var H = a.NullReferenceException = a.mkType(a, "ss.NullReferenceException", function (e, t) {
      k.call(this, e || "Object is null.", t);
    });a.initClass(H, k);var L = a.KeyNotFoundException = a.mkType(a, "ss.KeyNotFoundException", function (e, t) {
      k.call(this, e || "Key not found.", t);
    });a.initClass(L, k);var j = a.AmbiguousMatchException = a.mkType(a, "ss.AmbiguousMatchException", function (e, t) {
  ...
  function () {
    var n = {};e.tab = e.tab || {}, e.tableauSoftware = e.tableauSoftware || {}, t.initAssembly(n, "vqlapishared");var r = e.tab._ApiCommand = t.mkType(n, "tab._ApiCommand", function (e, t, i, n) {
      ...
      this.$router = null, this.$handler = null, d.verifyValue(e, "router"), this.$router = e, this.$handler = t;
        ...
        E = (e.tab.ApiSelectionUpdateType = t.mkEnum(n, "tab.ApiSelectionUpdateType", { replace: "replace", add: "add", remove: "remove" }, !0), e.tab.ApiSheetSizeBehavior = t.mkEnum(n, "tab.ApiSheetSizeBehavior", { automatic: "automatic", exactly: "exactly", range: "range", atleast: "atleast", atmost: "atmost" }, !0), e.tab.ApiSheetType = t.mkEnum(n, "tab.ApiSheetType", { worksheet: "worksheet", dashboard: "dashboard", story: "story" }, !0), e.tab.ApiTableauEventName = t.mkEnum(n, "tab.ApiTableauEventName", { customviewload: "customviewload", customviewremove: "customviewremove", customviewsave: "customviewsave", customviewsetdefault: "customviewsetdefault", filterchange: "filterchange", firstinteractive: "firstinteractive", firstvizsizeknown: "firstvizsizeknown", marksselection: "marksselection", markshighlight: "markshighlight", parametervaluechange: "parametervaluechange", storypointswitch: "storypointswitch", tabswitch: "tabswitch", toolbarstatechange: "toolbarstatechange", urlaction: "urlaction", vizresize: "vizresize" }, !0), e.tab.ApiToolbarButtonName = t.mkEnum(n, "tab.ApiToolbarButtonName", { redo: "redo", undo: "undo" }, !0), e.tab.ApiToolbarPosition = t.mkEnum(n, "tab.ApiToolbarPosition", { top: "top", bottom: "bottom" }, !0), e.tab.CommandReturnHandler$1 = t.mkType(n, "tab.CommandReturnHandler$1", function (e) {
  ...
  function () {
    ...
    var n = {};e.tab = e.tab || {}, e.tableauSoftware = e.tableauSoftware || {}, t.initAssembly(n, "Tableau.JavaScript.Vql.Api");var r = e.tab._ApiBootstrap = t.mkType(n, "tab._ApiBootstrap", null, null, { initialize: function initialize() {
      ...
      if (this.$workbookTabSwitchHandler = null, this.$viz = null, this.$iframe = null, this.$staticImage = null, this.$parameters = null, this.$initialAvailableSize = null, this.$instanceId = null, this.$workbookImpl = null, this.$onFirstInteractiveCallback = null, this.$onFirstVizSizeKnownCallback = null, this.$onFirstInteractiveAlreadyCalled = !1, this.$areTabsHidden = !1, this.$isToolbarHidden = !1, this.$areAutomaticUpdatesPaused = !1, this.$messagingOptions = null, this.$vizSize = null, this.$windowResizeHandler = null, this.$initializingWorkbookImpl = !1, this.$1$CustomViewsListLoadField = null, this.$1$StateReadyForQueryField = null, this.$1$MarksSelectionField = null, this.$1$MarksHighlightField = null, this.$1$FilterChangeField = null, this.$1$ParameterValueChangeField = null, this.$1$CustomViewLoadField = null, this.$1$CustomViewSaveField = null, this.$1$CustomViewRemoveField = null, this.$1$CustomViewSetDefaultField = null, this.$1$TabSwitchField = null, this.$1$ToolbarStateChangeField = null, this.$1$StoryPointSwitchField = null, this.$1$VizResizeField = null, this.$1$UrlActionField = null, !i._Utility.hasWindowPostMessage() || !i._Utility.hasJsonParse()) throw i._TableauException.createBrowserNotCapable();this.$messagingOptions = new O(e, this), this.$viz = n, (t.isNullOrUndefined(r) || 1 !== r.nodeType) && (r = document.body), this.$parameters = new f(r, a, s), t.isValue(s) && (this.$onFirstInteractiveCallback = s.onFirstInteractive, this.$onFirstVizSizeKnownCallback = s.onFirstVizSizeKnown);
        ...
        if (!t.staticEquals(this.$1$FilterChangeField, null) && t.referenceEquals(this.$workbookImpl.get_name(), e.get_workbookName())) {
          var i = null,
            ...
            var a = t.cast(JSON.parse(t.cast(e.get_data(), String)), Array),
                o = a[0],
                l = a[1];this.$1$FilterChangeField(new E("filterchange", this.$viz, i, o, l));
          }
        }
        ...
        var n = i.SheetSizeFactory.fromSizeConstraints(e.sizeConstraints);this.$vizSize = j.$ctor(n, e.chromeHeight), t.isValue(this.$onFirstVizSizeKnownCallback) && this.$onFirstVizSizeKnownCallback(new k("firstvizsizeknown", this.$viz, this.$vizSize)), this.$parameters.fixedSize || (this.$refreshSize(), this.$addWindowResizeHandler(), this.$show());
