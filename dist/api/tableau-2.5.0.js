...
!function () {
  ...
  !function (e) {
    ...
    a.initClass(R, E);
    var P = a.ArithmeticException = a.mkType(a, "ss.ArithmeticException", function (e, t) {
      E.call(this, e || "Overflow or underflow in the arithmetic operation.", t);
    });
    a.initClass(P, E);
    var z = a.OverflowException = a.mkType(a, "ss.OverflowException", function (e, t) {
      P.call(this, e || "Arithmetic operation resulted in an overflow.", t);
    });
    a.initClass(z, P);
    var x = a.DivideByZeroException = a.mkType(a, "ss.DivideByZeroException", function (e, t) {
  ...
  function () {
    ...
    var r = e.tab._ApiBootstrap = t.mkType(n, "tab._ApiBootstrap", null, null, {
      ...
      $invokeCommand: function $invokeCommand(e, n) {
        if ("showExportImageDialog" !== e && "showExportDataDialog" !== e && "showExportCrosstabDialog" !== e && "showExportPDFDialog" !== e && "showShareDialog" !== e && "showExportPowerPointDialog" !== e && "showDownloadWorkbookDialog" !== e) throw i._TableauException.createInternalError(null);
        var r = {};
    ...
    t.initClass(r), t.initClass(a), t.initClass(l), t.initClass(s, l), t.initClass(o), t.initClass(u, Object), t.initClass(c, l), t.initClass(h), t.initClass(m, Object), t.initClass(d), t.initClass(p), t.initClass(f), t.initClass(g), t.initClass($, l), t.initClass(T), t.initClass(v, T), t.initClass(y), t.initClass(_, T), t.initClass(w, T), t.initClass(b, T), t.initClass(S, T), t.initClass(C), t.initClass(z), t.initClass(I, z), t.initClass(W, z), t.initClass(k, W), t.initClass(E, z), t.initClass(A, W), t.initInterface(V, {
