...
!function () {
  ...
  var e = {};!function (e) {
    ...
    var t,
      ...
      if (a.isValue(e) && !t.isInstanceOfType(e)) throw new z();return e;
    }, a.trunc = function (e) {
      return a.isValue(e) ? e > 0 ? Math.floor(e) : Math.ceil(e) : null;
    }, a.idiv = function (e, t) {
      if (!a.isValue(e) || !a.isValue(t)) return null;if (!t) throw new x();return a.trunc(e / t);
    }, a.imod = function (e, t) {
      if (!a.isValue(e) || !a.isValue(t)) return null;if (!t) throw new x();return e % t;
      ...
      this._message = e || "An error occurred.", this._innerException = t || null, this._error = new Error();
        ...
        return a.isInstanceOfType(e, E) ? e : e instanceof TypeError ? new H(e.message, new N(e)) : e instanceof RangeError ? new D(null, e.message, new N(e)) : e instanceof Error ? new N(e) : new E(e.toString());
    ...
    });a.initClass(R, E);var P = a.ArithmeticException = a.mkType(a, "ss.ArithmeticException", function (e, t) {
      E.call(this, e || "Overflow or underflow in the arithmetic operation.", t);
    });a.initClass(P, E);var z = a.OverflowException = a.mkType(a, "ss.OverflowException", function (e, t) {
      P.call(this, e || "Arithmetic operation resulted in an overflow.", t);
    });a.initClass(z, P);var x = a.DivideByZeroException = a.mkType(a, "ss.DivideByZeroException", function (e, t) {
      P.call(this, e || "Division by 0.", t);
    });a.initClass(x, P);var U = a.InvalidCastException = a.mkType(a, "ss.InvalidCastException", function (e, t) {
  ...
  function () {
    var n = {};e.tab = e.tab || {}, e.tableauSoftware = e.tableauSoftware || {}, t.initAssembly(n, "vqlapishared");var r = e.tab._ApiCommand = t.mkType(n, "tab._ApiCommand", function (e, t, i, n) {
          ...
          var n = r.parse(i.data.toString()),
            ...
            if (t.referenceEquals(n.get_commandId(), r.crossDomainEventNotificationId)) {
              if (s.handleEventNotification(n.get_name(), n.get_parameters()), "api.FirstVizSizeKnownEvent" === n.get_name()) {
                var o = new z("tableau.bootstrap", []);i.source.postMessage(o.serialize(), "*");
              }
            } else this.$handleCrossDomainResponse(n);
          } else if (!t.isNullOrUndefined(this.$legacyHandler)) {
            var l = z.parse(i.data.toString());this.$legacyHandler(l, s);
          }
        }
      ...
      this.$crossDomainMessager = null, this.$crossDomainMessager = new V(null);
        ...
        P = e.tab.MarkImpl = t.mkType(n, "tab.MarkImpl", function (e) {
      if (this.$clonedPairs = null, this.$collection = new i._Collection(), this.$tupleId = 0, m.isArray(e)) for (var n = e, r = 0; r < n.length; r++) {
        ...
        z = e.tab.NonApiCommand = t.mkType(n, "tab.NonApiCommand", function (e, t) {
      this.$parameters = null, this.$1$NameField = null, this.set_name(e), this.$parameters = t;
        ...
        var i = e.split(String.fromCharCode(44)),
            n = t.cast(i[0], String),
            r = i.slice(1);return new z(n, r);
      } }),
        x = e.tab.Point = t.mkType(n, "tab.Point", null, null, { $ctor: function $ctor(e, t) {
  ...
  function () {
    ...
    var n = {};e.tab = e.tab || {}, e.tableauSoftware = e.tableauSoftware || {}, t.initAssembly(n, "Tableau.JavaScript.Vql.Api");var r = e.tab._ApiBootstrap = t.mkType(n, "tab._ApiBootstrap", null, null, { initialize: function initialize() {
      ...
      this.$context = null, z.call(this, e, t), this.$context = new v(t._impl.get__workbookImpl(), i);
      ...
      this.$context = null, z.call(this, e, t), this.$context = new S(t._impl.get__workbookImpl(), i);
        ...
        P = e.tab.StoryPointSwitchEvent = t.mkType(n, "tab.StoryPointSwitchEvent", function (e, t, i, n) {
      this.$oldStoryPointInfo = null, this.$newStoryPoint = null, z.call(this, e, t), this.$oldStoryPointInfo = i, this.$newStoryPoint = n;
        ...
        z = e.tab.TableauEvent = t.mkType(n, "tab.TableauEvent", function (e, t) {
      this.$viz = null, this.$eventName = null, this.$viz = t, this.$eventName = e;
        ...
        x = e.tab.TabSwitchEvent = t.mkType(n, "tab.TabSwitchEvent", function (e, t, i, n) {
      this.$oldName = null, this.$newName = null, z.call(this, e, t), this.$oldName = i, this.$newName = n;
      ...
      this.$toolbarStateImpl = null, z.call(this, e, t), this.$toolbarStateImpl = i;
      ...
      this.$url = null, this.$target = null, z.call(this, e, t), this.$url = i, this.$target = n;
      ...
      if (this.$workbookTabSwitchHandler = null, this.$viz = null, this.$iframe = null, this.$staticImage = null, this.$parameters = null, this.$initialAvailableSize = null, this.$instanceId = null, this.$workbookImpl = null, this.$onFirstInteractiveCallback = null, this.$onFirstVizSizeKnownCallback = null, this.$onFirstInteractiveAlreadyCalled = !1, this.$areTabsHidden = !1, this.$isToolbarHidden = !1, this.$areAutomaticUpdatesPaused = !1, this.$messagingOptions = null, this.$vizSize = null, this.$windowResizeHandler = null, this.$initializingWorkbookImpl = !1, this.$1$CustomViewsListLoadField = null, this.$1$StateReadyForQueryField = null, this.$1$MarksSelectionField = null, this.$1$MarksHighlightField = null, this.$1$FilterChangeField = null, this.$1$ParameterValueChangeField = null, this.$1$CustomViewLoadField = null, this.$1$CustomViewSaveField = null, this.$1$CustomViewRemoveField = null, this.$1$CustomViewSetDefaultField = null, this.$1$TabSwitchField = null, this.$1$ToolbarStateChangeField = null, this.$1$StoryPointSwitchField = null, this.$1$VizResizeField = null, this.$1$UrlActionField = null, !i._Utility.hasWindowPostMessage() || !i._Utility.hasJsonParse()) throw i._TableauException.createBrowserNotCapable();this.$messagingOptions = new O(e, this), this.$viz = n, (t.isNullOrUndefined(r) || 1 !== r.nodeType) && (r = document.body), this.$parameters = new f(r, a, s), t.isValue(s) && (this.$onFirstInteractiveCallback = s.onFirstInteractive, this.$onFirstVizSizeKnownCallback = s.onFirstVizSizeKnown);
        ...
        t.staticEquals(this.$1$TabSwitchField, null) || this.$1$TabSwitchField(new x("tabswitch", this.$viz, e, i));
      }, raiseStoryPointSwitch: function raiseStoryPointSwitch(e, i) {
        t.staticEquals(this.$1$StoryPointSwitchField, null) || this.$1$StoryPointSwitchField(new P("storypointswitch", this.$viz, e, i));
        ...
        if (!this.$onFirstInteractiveAlreadyCalled) {
          var i = this.$onFirstInteractiveCallback;window.setTimeout(t.mkdel(this, function () {
            this.$onFirstInteractiveAlreadyCalled || (t.staticEquals(i, null) || i(new z("firstinteractive", this.$viz)), t.staticEquals(e, null) || e(), this.$onFirstInteractiveAlreadyCalled = !0);
          }), 0);
      ...
      this.$availableSize = null, z.call(this, e, t), this.$availableSize = i;
      ...
      this.$worksheetImpl = null, z.call(this, e, t), this.$worksheetImpl = i;
      ...
      } });t.initClass(r), t.initClass(a), t.initClass(l), t.initClass(s, l), t.initClass(o), t.initClass(u, Object), t.initClass(c, l), t.initClass(h), t.initClass(m, Object), t.initClass(d), t.initClass(p), t.initClass(f), t.initClass(g), t.initClass($, l), t.initClass(T), t.initClass(v, T), t.initClass(y), t.initClass(_, T), t.initClass(w, T), t.initClass(b, T), t.initClass(S, T), t.initClass(C), t.initClass(z), t.initClass(I, z), t.initClass(W, z), t.initClass(k, W), t.initClass(E, z), t.initClass(A, W), t.initInterface(V, { add_customViewsListLoad: null, remove_customViewsListLoad: null, handleVizLoad: null, handleVizListening: null, sendScaleFactor: null }), t.initClass(N), t.initClass(O), t.initClass(F, W), t.initClass(D, z), t.initClass(R), t.initClass(P, z), t.initClass(x, z), t.initClass(U, z), t.initClass(M, z), t.initClass(H, null, [V]), t.initClass(L, z), t.initClass(j, Object), t.initClass(Y), t.initClass(G, Y), t.initClass(B), t.initClass(ie), t.initClass(q, ie), t.initClass(Q), t.initClass(J), t.initClass(K), t.initClass(X, Y), t.initClass(Z), t.initClass(ee, Y), t.initClass(te, Y), t.initClass(ne), t.initClass(re, ie), t.initClass(ae), t.initClass(se), t.initClass(oe), t.initClass(le), t.initClass(ue), t.initClass(ce), t.initClass(he), t.initClass(me, ie), p.$vizs = [], l.noZoneId = 4294967295, $.$regexHierarchicalFieldName = new RegExp("\\[[^\\]]+\\]\\.", "g"), le.$currentVersion = new le(2, 5, 0, "null");
