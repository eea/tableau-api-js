...
!function () {
  ...
  !function (e) {
    ...
    var A = a.Exception = a.mkType(a, "ss.Exception", function (e, t) {
    ...
    a.initClass(A);
    var E = a.NotImplementedException = a.mkType(a, "ss.NotImplementedException", function (e, t) {
  ...
  function () {
    ...
    var r = e.tab._ApiBootstrap = t.mkType(n, "tab._ApiBootstrap", null, null, {
            ...
            for (; a.moveNext();) {
              for (var s = a.current(), o = 0; o < this.get_worksheets().get__length(); o++) {
                if (t.referenceEquals(this.get_worksheets().get_item(o)._impl.get_name(), s)) {
                  var l = new Object();
                  l.filters = Array.prototype.slice.call(i.filters[s]);
                  var u = l,
                      c = Y.processFiltersList(this.get_worksheets().get_item(o)._impl, u);
      ...
      $applyFilterAsync: function $applyFilterAsync(e, t, n, r) {
        ...
        var a = this.$filterCommandsBuilder.buildApplyFiltersCommandParams(e, t, n, r);
        a["api.dashboardName"] = this.get_name();
        var s = new i._Deferred(),
            o = this.$filterCommandsBuilder.createFilterCommandReturnHandler("api.ApplyDashboardCategoricalFilterCommand", e, s);
      ...
      $getAppliedWorksheetsAsync: function $getAppliedWorksheetsAsync(e, n) {
        var r = new i._Deferred();
        return this.$getSharedFilterWorksheets(Array).call(this, e, n, function (e) {
          var i = e,
              n = [];
          if (t.isValue(i.sharedFilterWorksheetInfoList)) for (var a = 0; a < i.sharedFilterWorksheetInfoList.length; a++) {
      ...
      $setAppliedWorksheetsAsync: function $setAppliedWorksheetsAsync(e, n, r, a) {
        if (t.isNullOrUndefined(e)) throw i._TableauException.createInvalidParameter("Worksheet");
        var s = new i._Deferred();
        ...
        var o = t.mkdel(this, function (n) {
          ...
          if (t.isValue(o.sharedFilterWorksheetInfoList)) {
            for (var h = 0; h < o.sharedFilterWorksheetInfoList.length; h++) {
              ...
              m.isActive && (l = m.worksheetName), m.isSelected ? u.push(m.worksheetName) : m.isEnabled && c.push(m.worksheetName);
            }
            ...
            if (t.contains(e, l)) {
              for (var d = 0; d < e.length; d++) {
                ...
                if (!t.contains(u, p) && !t.contains(c, p)) {
                  var f = "The field " + a + " isn't applicable to the worksheet " + p;
                  return void s.reject(i._TableauException.createInternalError(f));
                }
              }

              var g = {};
              g["api.fieldName"] = r, g["api.sharedFilterSheets"] = e, this.$addVisualIdToCommand(g);
              var $ = new (t.makeGenericType(i.CommandReturnHandler$1, [Object]))("api.SetAppliedWorksheetsCommand", 0, function (t) {
                s.resolve(e);
              }, function (e, t) {
      ...
      $getSharedFilterWorksheets: function $getSharedFilterWorksheets(e) {
        return function (e, n, r, a) {
          ...
          var o = new (t.makeGenericType(i.CommandReturnHandler$1, [Object]))("api.GetAppliedWorksheetsCommand", 0, r, a);
      ...
      $invokeCommand: function $invokeCommand(e, n) {
        if ("showDownloadDialog" !== e && "showExportImageDialog" !== e && "showExportDataDialog" !== e && "showExportCrosstabDialog" !== e && "showExportPDFDialog" !== e && "showShareDialog" !== e && "showExportPowerPointDialog" !== e && "exportCrosstabToExcel" !== e && "showDownloadWorkbookDialog" !== e) throw i._TableauException.createInternalError(null);
        var r = {};
      ...
      $getLocalizedTitle: function $getLocalizedTitle() {
        var e;
        if ("zh-CN" === (e = t.isValue(window.navigator.language) ? window.navigator.language : t.isValue(window.navigator.userLanguage) ? window.navigator.userLanguage : t.isValue(window.navigator.browserLanguage) ? window.navigator.browserLanguage : "en-US")) return "数据可视化";
      ...
      $handleInitialVizSize: function $handleInitialVizSize(e) {
        ...
        this.$vizSize = j.$ctor(n, e.chromeHeight), t.isValue(this.$onFirstVizSizeKnownCallback) && this.$onFirstVizSizeKnownCallback(new A("firstvizsizeknown", this.$viz, this.$vizSize)), this.$parameters.fixedSize || (this.$refreshSize(), this.$addWindowResizeHandler(), this.$show());
      },
    ...
    t.initClass(r), t.initClass(a), t.initClass(l), t.initClass(s, l), t.initClass(o), t.initClass(u, Object), t.initClass(c, l), t.initClass(h), t.initClass(m, Object), t.initClass(d), t.initClass(p), t.initClass(f), t.initClass(g), t.initClass($, l), t.initClass(T), t.initClass(v, T), t.initClass(y), t.initClass(_, T), t.initClass(w, T), t.initClass(b, T), t.initClass(S, T), t.initClass(C), t.initClass(P), t.initClass(I, P), t.initClass(W, P), t.initClass(k, W), t.initClass(A, P), t.initClass(E, W), t.initInterface(V, {
