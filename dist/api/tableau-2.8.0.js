...
!function () {
  ...
  var e = {};!function (e) {
    ...
    var t,
      ...
      if (a.isValue(e) && !t.isInstanceOfType(e)) throw new P();return e;
    }, a.trunc = function (e) {
      return a.isValue(e) ? e > 0 ? Math.floor(e) : Math.ceil(e) : null;
    }, a.idiv = function (e, t) {
      if (!a.isValue(e) || !a.isValue(t)) return null;if (!t) throw new z();return a.trunc(e / t);
    }, a.imod = function (e, t) {
      if (!a.isValue(e) || !a.isValue(t)) return null;if (!t) throw new z();return e % t;
      ...
      } });a.initClass(T);var k = a.EventArgs = a.mkType(a, "ss.EventArgs", function () {});a.initClass(k), k.Empty = new k();var A = a.Exception = a.mkType(a, "ss.Exception", function (e, t) {
      this._message = e || "An error occurred.", this._innerException = t || null, this._error = new Error();
        ...
        return a.isInstanceOfType(e, A) ? e : e instanceof TypeError ? new H(e.message, new N(e)) : e instanceof RangeError ? new D(null, e.message, new N(e)) : e instanceof Error ? new N(e) : new A(e.toString());
      } });a.initClass(A);var E = a.NotImplementedException = a.mkType(a, "ss.NotImplementedException", function (e, t) {
      A.call(this, e || "The method or operation is not implemented.", t);
    });a.initClass(E, A);var V = a.NotSupportedException = a.mkType(a, "ss.NotSupportedException", function (e, t) {
      A.call(this, e || "Specified method is not supported.", t);
    });a.initClass(V, A);var N = a.JsErrorException = a.mkType(a, "ss.JsErrorException", function (e, t, i) {
      A.call(this, t || e.message, i), this.error = e;
    }, { get_stack: function get_stack() {
        return this.error.stack;
      } });a.initClass(N, A);var O = a.ArgumentException = a.mkType(a, "ss.ArgumentException", function (e, t, i) {
      A.call(this, e || "Value does not fall within the expected range.", i), this.paramName = t || null;
    });a.initClass(O, A);var F = a.ArgumentNullException = a.mkType(a, "ss.ArgumentNullException", function (e, t, i) {
      t || (t = "Value cannot be null.", e && (t += "\nParameter name: " + e)), O.call(this, t, e, i);
    });a.initClass(F, O);var D = a.ArgumentOutOfRangeException = a.mkType(a, "ss.ArgumentOutOfRangeException", function (e, t, i, n) {
      t || (t = "Value is out of range.", e && (t += "\nParameter name: " + e)), O.call(this, t, e, i), this.actualValue = n || null;
    });a.initClass(D, O);var R = a.FormatException = a.mkType(a, "ss.FormatException", function (e, t) {
      A.call(this, e || "Invalid format.", t);
    });a.initClass(R, A);var x = a.ArithmeticException = a.mkType(a, "ss.ArithmeticException", function (e, t) {
      A.call(this, e || "Overflow or underflow in the arithmetic operation.", t);
    });a.initClass(x, A);var P = a.OverflowException = a.mkType(a, "ss.OverflowException", function (e, t) {
      x.call(this, e || "Arithmetic operation resulted in an overflow.", t);
    });a.initClass(P, x);var z = a.DivideByZeroException = a.mkType(a, "ss.DivideByZeroException", function (e, t) {
      x.call(this, e || "Division by 0.", t);
    });a.initClass(z, x);var U = a.InvalidCastException = a.mkType(a, "ss.InvalidCastException", function (e, t) {
      A.call(this, e || "The cast is not valid.", t);
    });a.initClass(U, A);var M = a.InvalidOperationException = a.mkType(a, "ss.InvalidOperationException", function (e, t) {
      A.call(this, e || "Operation is not valid due to the current state of the object.", t);
    });a.initClass(M, A);var H = a.NullReferenceException = a.mkType(a, "ss.NullReferenceException", function (e, t) {
      A.call(this, e || "Object is null.", t);
    });a.initClass(H, A);var L = a.KeyNotFoundException = a.mkType(a, "ss.KeyNotFoundException", function (e, t) {
      A.call(this, e || "Key not found.", t);
    });a.initClass(L, A);var j = a.AmbiguousMatchException = a.mkType(a, "ss.AmbiguousMatchException", function (e, t) {
  ...
  /*! BEGIN ApiShared */
  function () {
    var n = {};e.tab = e.tab || {}, e.tableauSoftware = e.tableauSoftware || {}, t.initAssembly(n, "vqlapishared");var r = e.tab._ApiCommand = t.mkType(n, "tab._ApiCommand", function (e, t, i, n) {
      this.$1$NameField = null, this.$1$HostIdField = null, this.$1$CommandIdField = null, this.$1$ParametersField = null, this.set_name(e), this.set_commandId(t), this.set_hostId(i), this.set_parameters(n);
        ...
        var e = [];e.push(this.get_name()), e.push(this.get_commandId()), e.push(this.get_hostId()), t.isValue(this.get_parameters()) && e.push(this.get_parameters());var i = e.join(",");return r.lastRequestMessage = i, i;
      } }, { generateNextCommandId: function generateNextCommandId() {
        var e = "cmd" + r.$nextCommandId;return r.$nextCommandId++, e;
      }, parse: function parse(e) {
        var i,
            n,
            a = e.indexOf(String.fromCharCode(44));if (a < 0) return i = t.cast(e, String), new r(i, null, null, null);i = t.cast(e.substr(0, a), String);var s,
            o = e.substr(a + 1);if ((a = o.indexOf(String.fromCharCode(44))) < 0) return new r(i, n = o, null, null);n = o.substr(0, a);var l = o.substr(a + 1);if ((a = l.indexOf(String.fromCharCode(44))) < 0) return new r(i, n, s = l, null);s = l.substr(0, a);var u = l.substr(a + 1);return r.lastResponseMessage = e, "api.GetClientInfoCommand" === i && (r.lastClientInfoResponseMessage = e), new r(i, n, s, u);
      } }),
        a = e.tab._ApiObjectRegistry = t.mkType(n, "tab._ApiObjectRegistry", null, null, { registerApiMessageRouter: function registerApiMessageRouter(e) {
        ...
        return function () {
          var i = t.getTypeFullName(e),
              n = window._ApiObjectRegistryGlobalState.creationRegistry[i];if (t.isNullOrUndefined(n)) throw g.createInternalError("No creation function has been registered for interface type '" + i + "'.");return n();
        };
        ...
        return function () {
          var i = window._ApiObjectRegistryGlobalState.singletonInstanceRegistry,
              ...
              r = t.cast(i[n], e);return t.isNullOrUndefined(r) && (r = a.$createType(e).call(null), i[n] = r), r;
        };
      ...
      this.$workbookName = null, this.$worksheetName = null, this.$data = null, this.$workbookName = e, this.$worksheetName = t, this.$data = i;
        ...
        var i = JSON.parse(e),
            ...
            a = i["api.commandData"];return new s(n, r, a);
      } }),
      ...
      this.$items = [], this.$itemMap = {};
        ...
        if ($.isNullOrEmpty(e)) throw new t.Exception("Null key");if (this._has(e)) throw new t.Exception("Duplicate key '" + e + "'");
      ...
      this.$promise = null, this.$thenFunc = null, this.$listeners = [], this.$resolveFunc = null, this.$promise = new p(t.mkdel(this, this.then)), this.$thenFunc = t.mkdel(this, this.$preResolutionThen), this.$resolveFunc = t.mkdel(this, this.$transitionToFulfilled);
        ...
        var n = new h();return this.$listeners.push(function (r) {
          r.then(e, i).then(t.mkdel(n, n.resolve), t.mkdel(n, n.reject));
        }), n.get_promise();
      }, $transitionToFulfilled: function $transitionToFulfilled(e) {
        var t = v.$coerceToTrustedPromise(e);this.$thenFunc = t.then, this.$resolveFunc = v.$coerceToTrustedPromise;for (var i = 0; i < this.$listeners.length; i++) {
          (0, this.$listeners[i])(t);
        }return this.$listeners = null, t;
      } }),
        m = e.tab._jQueryShim = t.mkType(n, "tab._jQueryShim", null, null, { isFunction: function isFunction(e) {
        ...
        if ("string" != typeof e || t.isNullOrUndefined(e)) return null;if (e = m.trim(e), t.isValue(JSON) && t.isValue(JSON.parse)) return JSON.parse(e);if (m.$rvalidchars.test(e.replace(m.$rvalidescape, "@").replace(m.$rvalidtokens, "]").replace(m.$rvalidbraces, ""))) return new Function("return " + e)();throw new t.Exception("Invalid JSON: " + e);
      } }),
        d = e.tab._Param = t.mkType(n, "tab._Param", null, null, { verifyString: function verifyString(e, i) {
      ...
      this.left = 0, this.top = 0, this.width = 0, this.height = 0, this.left = e, this.top = t, this.width = i, this.height = n;
        ...
        g = e.tab._TableauException = t.mkType(n, "tab._TableauException", null, null, { create: function create(e, i) {
        ...
        $ = e.tab._Utility = t.mkType(n, "tab._Utility", null, null, { isNullOrEmpty: function isNullOrEmpty(e) {
        ...
        if ($.isNumber(e)) return t.trunc(e);var i = parseInt(e.toString(), 10);return isNaN(i) ? 0 : i;
        ...
        var r = t.isValue(e) ? t.cast(e.parentNode, HTMLElement) : null;for (n = n || document.body; t.isValue(r);) {
          if ($.hasClass(r, i)) return r;r = t.referenceEquals(r, n) ? null : t.cast(r.parentNode, HTMLElement);
        }return r;
        ...
        var i = new t.StringBuilder();if (i.append(e.tagName.toLowerCase()), $.isNullOrEmpty(e.id) || i.append("#").append(e.id), !$.isNullOrEmpty(e.className)) {
        ...
        for (var i = $.contentRectInDocumentCoordinates(e), n = e.parentElement; t.isValue(n) && t.isValue(n.parentElement); n = n.parentElement) {
          var r = $.$getComputedStyle(n).overflow;"auto" !== r && "scroll" !== r && "hidden" !== r || (i = i.intersect($.contentRectInDocumentCoordinates(n)));
        }var a = $.$getViewportRect();return i.intersect(a);
      }, getVisualViewportRect: function getVisualViewportRect(e) {
        var i = e.visualViewport;return t.isValue(i) ? new f(t.trunc(i.pageLeft), t.trunc(i.pageTop), t.trunc(i.width), t.trunc(i.height)) : null;
      }, $getViewportRect: function $getViewportRect() {
        var e = $.getVisualViewportRect(window.self);if (t.isValue(e)) return e;var n = $.contentRectInDocumentCoordinates(document.documentElement),
        ...
        var i = e.getBoundingClientRect(),
            ...
            r = t.trunc(i.left),
            a = t.trunc(i.right),
            s = t.trunc(i.bottom);return new f(r, n, a - r, s - n);
        ...
        var i = "";t.isValue(e) && $.isDate(e) && (i = e.getUTCFullYear() + "-" + (e.getUTCMonth() + 1) + "-" + e.getUTCDate() + " " + e.getUTCHours() + ":" + e.getUTCMinutes() + ":" + e.getUTCSeconds());return i;
        ...
        v = t.mkType(n, "tab.$DeferredUtil", null, null, { $coerceToTrustedPromise: function $coerceToTrustedPromise(e) {
        var i;if (e instanceof tableauSoftware.Promise) i = t.cast(e, p);else if (t.isValue(e) && "function" == typeof e.valueOf && (e = e.valueOf()), v.$isPromise(e)) {
          var n = new h();t.cast(e, p).then(t.mkdel(n, n.resolve), t.mkdel(n, n.reject)), i = n.get_promise();
        } else i = v.$resolved(e);return i;
      }, $reject: function $reject(e) {
        ...
        return new p(function (i, n) {
          try {
            ...
            var r = t.Exception.wrap(e);return v.$rejected(r);
          }
        });
      ...
      this.$hostId = null, this.$1$StateReadyForQueryField = null;
        ...
        switch (e) {case "ATTR":
            ...
            return "AVG";case "COLLECT":
            return "COLLECT";case "COUNT":
      ...
      if (this.$nextHandlerId = 0, this.$handlers = {}, this.$commandCallbacks = {}, this.$commandReturnAfterStateReadyQueues = {}, this.$legacyHandler = null, this.$legacyHandler = e, $.hasWindowAddEventListener()) window.addEventListener("message", t.mkdel(this, this.$handleCrossDomainMessage), !1);else if ($.hasDocumentAttachEvent()) {
        ...
        var i = "host" + this.$nextHandlerId;if (t.isValue(e.get_hostId()) || t.isValue(this.$handlers[e.get_hostId()])) throw g.createInternalError("Host '" + e.get_hostId() + "' is already registered.");this.$nextHandlerId++, e.set_hostId(i), this.$handlers[i] = e, e.add_stateReadyForQuery(t.mkdel(this, this.$handleStateReadyForQuery));
        ...
        return function (e, i, n) {
          var a = e.get_iframe(),
              s = e.get_hostId();if ($.hasWindowPostMessage() && !t.isNullOrUndefined(a) && !t.isNullOrUndefined(a.contentWindow)) {
            var o = r.generateNextCommandId(),
                l = this.$commandCallbacks[s];t.isNullOrUndefined(l) && (l = {}, this.$commandCallbacks[s] = l), l[o] = n;var u = n.get_commandName(),
                c = null;t.isValue(i) && (c = JSON.stringify(i));var h = new r(u, o, s, c).serialize();$.isPostMessageSynchronous() ? window.setTimeout(function () {
              a.contentWindow.postMessage(h, "*");
            }, 0) : a.contentWindow.postMessage(h, "*");
          }
        };
      }, $handleStateReadyForQuery: function $handleStateReadyForQuery(e) {
        var i = this.$commandReturnAfterStateReadyQueues[e.get_hostId()];if (!$.isNullOrEmpty(i)) for (; i.length > 0;) {
        ...
        var i = t.cast(e, MessageEvent);if (!t.isNullOrUndefined(i.data)) {
          var n = r.parse(i.data.toString()),
              a = n.get_hostId(),
              s = this.$handlers[a];if (!t.isNullOrUndefined(s) && t.referenceEquals(s.get_hostId(), n.get_hostId()) || (s = this.$findHostIdByDomComparison(i)), n.get_isApiCommandName()) {
            if (t.referenceEquals(n.get_commandId(), r.crossDomainEventNotificationId)) {
              if (s.handleEventNotification(n.get_name(), n.get_parameters()), "api.FirstVizSizeKnownEvent" === n.get_name()) {
                var o = new P("tableau.bootstrap", []);i.source.postMessage(o.serialize(), "*");
              }
            } else this.$handleCrossDomainResponse(n);
          } else if (!t.isNullOrUndefined(this.$legacyHandler)) {
            var l = P.parse(i.data.toString());this.$legacyHandler(l, s);
          }
        }
        ...
        var i = this.$commandCallbacks[e.get_hostId()],
          ...
          var r = new o(e.get_parameters()),
              ...
              throw g.createInternalError("Unknown timing value: " + n.get_successCallbackTiming());} else if (t.isValue(n.get_errorCallback())) {
            var l = "api.remotefailed" === r.get_result(),
                u = t.isValue(a) ? a.toString() : "";n.get_errorCallback()(l, u);
          }
        }
        ...
        var n = new Object();return n.value = null, n.formattedValue = null, n.value = e, $.isNullOrEmpty(i) ? n.formattedValue = t : n.formattedValue = i, n;
        ...
        if ($.isNullOrEmpty(e)) throw g.createNullOrEmptyParameter("fieldName");n = U.normalizeEnum(b).call(null, n, "updateType");var a = [];if (m.isArray(i)) for (var s = 0; s < i.length; s++) {
          a.push(i[s].toString());
        ...
        if ($.isNullOrEmpty(e)) throw g.createNullOrEmptyParameter("fieldName");if (t.isNullOrUndefined(i)) throw g.createNullOrEmptyParameter("filterOptions");var n = {};if (n["api.fieldCaption"] = e, t.isValue(i.min)) if ($.isDate(i.min)) {
          var r = t.cast(i.min, t.JsDate);if (!$.isDateValid(r)) throw g.createInvalidDateParameter("filterOptions.min");n["api.filterRangeMin"] = $.serializeDateForServer(r);
        } else n["api.filterRangeMin"] = i.min;if (t.isValue(i.max)) if ($.isDate(i.max)) {
          var a = t.cast(i.max, t.JsDate);if (!$.isDateValid(a)) throw g.createInvalidDateParameter("filterOptions.max");n["api.filterRangeMax"] = $.serializeDateForServer(a);
        ...
        if ($.isNullOrEmpty(e)) throw g.createInvalidParameter("fieldName");if (t.isNullOrUndefined(i)) throw g.createInvalidParameter("filterOptions");var n = {};if (n["api.fieldCaption"] = e, t.isValue(i)) {
          if (n["api.filterPeriodType"] = i.periodType, n["api.filterDateRangeType"] = i.rangeType, "lastn" === i.rangeType || "nextn" === i.rangeType) {
            if (t.isNullOrUndefined(i.rangeN)) throw g.create("missingRangeNForRelativeDateFilters", "Missing rangeN field for a relative date filter of LASTN or NEXTN.");n["api.filterDateRange"] = i.rangeN;
        ...
        if ($.isNullOrEmpty(e)) throw g.createNullOrEmptyParameter("fieldName");n = U.normalizeEnum(b).call(null, n, "updateType");var a = null,
            s = null;if (m.isArray(i)) {
          a = [];for (var o = i, l = 0; l < o.length; l++) {
            a.push(o[l].toString());
          }
        } else if ($.isString(i)) (a = []).push(i.toString());else if (t.isValue(i) && t.isValue(i.levels)) {
          var u = i.levels;if (s = [], m.isArray(u)) for (var c = u, h = 0; h < c.length; h++) {
            s.push(c[h].toString());
          } else s.push(u.toString());
        } else if (t.isValue(i)) throw g.createInvalidParameter("values");var d = {};return d["api.fieldCaption"] = e, d["api.filterUpdateType"] = n, d["api.exclude"] = !(!t.isValue(r) || !r.isExcludeMode), t.isValue(a) && (d["api.filterHierarchicalValues"] = JSON.stringify(a)), t.isValue(s) && (d["api.filterHierarchicalLevels"] = JSON.stringify(s)), d;
      }, buildClearFilterCommandsParam: function buildClearFilterCommandsParam(e) {
        if ($.isNullOrEmpty(e)) throw g.createNullOrEmptyParameter("fieldName");var t = {};return t["api.fieldCaption"] = e, t;
        ...
        var i = e;if (t.isValue(i) && t.isValue(i.errorCode)) {
          var n = t.isValue(i.additionalInformation) ? i.additionalInformation.toString() : "";switch (i.errorCode) {case "invalidFilterFieldName":
              return g.create("invalidFilterFieldName", n);case "invalidFilterFieldValue":
              return g.create("invalidFilterFieldValue", n);case "invalidAggregationFieldName":
              return g.createInvalidAggregationFieldName(n);default:
              return g.createServerError(n);}
        }return null;
      }, normalizeRangeFilterOption: function normalizeRangeFilterOption(e) {
        if (t.isNullOrUndefined(e)) throw g.createNullOrEmptyParameter("filterOptions");if (t.isNullOrUndefined(e.min) && t.isNullOrUndefined(e.max) && t.isNullOrUndefined(e.nullOption)) throw g.create("invalidParameter", "At least one of filterOptions.min or filterOptions.max or filterOptions.nullOption must be specified.");var i = new Object();return t.isValue(e.min) && (i.min = e.min), t.isValue(e.max) && (i.max = e.max), t.isValue(e.nullOption) && (i.nullOption = U.normalizeEnum(I).call(null, e.nullOption, "filterOptions.nullOption")), i;
      }, normalizeRelativeDateFilterOptions: function normalizeRelativeDateFilterOptions(e) {
        if (t.isNullOrUndefined(e)) throw g.createNullOrEmptyParameter("filterOptions");var i = new Object();if (i.rangeType = U.normalizeEnum(_).call(null, e.rangeType, "filterOptions.rangeType"), i.periodType = U.normalizeEnum(T).call(null, e.periodType, "filterOptions.periodType"), "lastn" === i.rangeType || "nextn" === i.rangeType) {
          if (t.isNullOrUndefined(e.rangeN)) throw g.create("missingRangeNForRelativeDateFilters", "Missing rangeN field for a relative date filter of LASTN or NEXTN.");i.rangeN = $.toInt(e.rangeN);
        }if (t.isValue(e.anchorDate)) {
          if (!$.isDate(e.anchorDate) || !$.isDateValid(e.anchorDate)) throw g.createInvalidDateParameter("filterOptions.anchorDate");i.anchorDate = e.anchorDate;
        }return i;
        ...
        return new (t.makeGenericType(k, [Object]))(e, 0, t.mkdel(this, function (e) {
          ...
          if (e) n.reject(g.createInvalidFilterFieldNameOrValue(i));else {
            var r = g.create("filterCannotBePerformed", t);n.reject(r);
          }
        });
      } }),
        ...
        var n = {};return i = i || new Object(), n["api.ignoreAliases"] = t.coalesce(i.ignoreAliases, !1), n["api.ignoreSelection"] = t.coalesce(i.ignoreSelection, !1), n["api.includeAllColumns"] = t.coalesce(i.includeAllColumns, !1), n["api.maxRows"] = t.coalesce(i.maxRows, 0), n["api.tableId"] = t.coalesce(e, ""), n;
        ...
        for (var t = new i._Collection(), n = 0; n < e.logicalTables.length; n++) {
          var r = e.logicalTables[n];t._add(r.tableId, new B(r.tableId, r.caption));
        }return t;
      }, getUnderlyingTableDataResponseHandler: function getUnderlyingTableDataResponseHandler(e) {
        return new (t.makeGenericType(k, [Object]))("api.GetUnderlyingTableDataCommand", 0, t.mkdel(this, function (t) {
          var i = t,
              n = this.processGetDataPresModel(i);e.resolve(n);
        }), t.mkdel(this, function (t, i) {
          e.reject(g.createServerError(this.$appendErrorMessageIfNeededThenLog(t, i)));
      ...
      if (this.$clonedPairs = null, this.$collection = new i._Collection(), this.$tupleId = 0, m.isArray(e)) for (var n = e, r = 0; r < n.length; r++) {
        var a = n[r];if (!t.isValue(a.fieldName)) throw g.createInvalidParameter("pair.fieldName");if (!t.isValue(a.value)) throw g.createInvalidParameter("pair.value");var s = new Q(a.fieldName, a.value);this.$collection._add(s.fieldName, s);
      } else this.$tupleId = e;
        ...
        var n = new i._Collection();if (t.isNullOrUndefined(e) || $.isNullOrEmpty(e.marks)) return n;for (var r = 0; r < e.marks.length; r++) {
          var a = e.marks[r],
              s = a.tupleId,
              o = new q(s);n._add(s.toString(), o);for (var l = 0; l < a.pairs.length; l++) {
            var u = a.pairs[l],
                c = $.convertRawValue(u.value, u.valueDataType),
                h = new Q(u.fieldName, c);h.formattedValue = u.formattedValue, o.impl.get_pairs()._has(h.fieldName) || o.impl.$addPair(h);
          }
        }return n;
      } }),
      ...
      this.$parameters = null, this.$1$NameField = null, this.set_name(e), this.$parameters = t;
        ...
        var i = e.split(String.fromCharCode(44)),
            n = t.cast(i[0], String),
            r = i.slice(1);return new P(n, r);
      } }),
        z = e.tab.Point = t.mkType(n, "tab.Point", null, null, { $ctor: function $ctor(e, t) {
        ...
        return function (t, i) {
          var n = {};if (!U.tryNormalizeEnum(e).call(null, t, n)) throw g.createInvalidParameter(i);return n.$;
        };
    ...
    var n = {};e.tab = e.tab || {}, e.tableauSoftware = e.tableauSoftware || {}, t.initAssembly(n, "Tableau.JavaScript.Vql.Api");var r = e.tab._ApiBootstrap = t.mkType(n, "tab._ApiBootstrap", null, null, { initialize: function initialize() {
      ...
      this.$customView = null, this.$presModel = null, this.$workbookImpl = null, this.$messagingOptions = null, this.$name = null, this.$ownerName = null, this.$url = null, this.$isPublic = !1, this.$isDefault = !1, this.$isStale = !1, this.$workbookImpl = e, this.$name = t, this.$messagingOptions = i, this.$isPublic = !1, this.$isDefault = !1, this.$isStale = !1;
        ...
        if (this.$isStale || t.isNullOrUndefined(this.$presModel)) throw i._TableauException.create("staleDataReference", "Stale data");this.$presModel.isPublic = this.$isPublic, this.$presModel.name = this.$name;var e = new i._Deferred(),
            n = {};n["api.customViewParam"] = this.$presModel;var r = a.$createCustomViewCommandReturnHandler("api.UpdateCustomViewCommand", e, t.mkdel(this, function (t) {
        ...
        var e = new i._Deferred(),
            n = {};n["api.customViewParam"] = this.$presModel;var r = a.$createCustomViewCommandReturnHandler("api.RemoveCustomViewCommand", e, t.mkdel(this, function (t) {
        ...
        if (this.$isStale || t.isNullOrUndefined(this.$presModel)) throw i._TableauException.create("staleDataReference", "Stale data");return a._showCustomViewAsync(this.$workbookImpl, this.$messagingOptions, this.$presModel);
        ...
        var s = new a(e, n.name, i);return s.$isPublic = n.isPublic, s.$url = n.url, s.$ownerName = n.owner.friendlyName, s.$isDefault = t.isValue(r) && t.unbox(r) === n.id, s.$presModel = n, s;
      }, _saveNewAsync: function _saveNewAsync(e, n, r) {
        var s = new i._Deferred(),
            o = {};o["api.customViewName"] = r;var l = a.$createCustomViewCommandReturnHandler("api.SaveNewCustomViewCommand", s, function (i) {
          a._processCustomViewUpdate(e, n, i, !0);var r = null;t.isValue(e.get_$updatedCustomViews()) && (r = e.get_$updatedCustomViews().get_item(0)), s.resolve(r);
        });return n.sendCommand(Object).call(n, o, l), s.get_promise();
      }, _showCustomViewAsync: function _showCustomViewAsync(e, n, r) {
        var s = new i._Deferred(),
            o = {};t.isValue(r) && (o["api.customViewParam"] = r);var l = a.$createCustomViewCommandReturnHandler("api.ShowCustomViewCommand", s, function (t) {
          var i = e.get_activeCustomView();s.resolve(i);
        });return n.sendCommand(Object).call(n, o, l), s.get_promise();
        ...
        if (e.set_$currentCustomView(null), e.set_$removedCustomViews(e.get_$customViews()), e.set_$customViews(new i._Collection()), s && (e.set_$updatedCustomViews(new i._Collection()), t.isValue(r.newView) && a.$processOneCustomViewUpdate(e, n, r, r.newView, s)), t.isValue(r.customViews)) for (var o = 0; o < r.customViews.length; o++) {
          var l = r.customViews[o];a.$processOneCustomViewUpdate(e, n, r, l, s);
        }
      }, buildCustomViewKeyForDuplicate: function buildCustomViewKeyForDuplicate(e, t) {
        return e + "/" + t;
      }, $processOneCustomViewUpdate: function $processOneCustomViewUpdate(e, i, n, r, s) {
        var o = null,
            l = null;t.isValue(n.currentView) && (o = n.currentView.name, l = n.currentView.owner.friendlyName);var u = n.defaultCustomViewId,
            c = a._createNew(e, i, r, u),
            h = c.get_$name();e.get_$customViews()._has(h) && (h = a.buildCustomViewKeyForDuplicate(c.get_$name(), r.owner.username)), e.get_$customViews()._add(h, c.get_$customView()), e.get_$removedCustomViews()._has(h) ? e.get_$removedCustomViews()._remove(h) : s && !e.get_$updatedCustomViews()._has(h) && e.get_$updatedCustomViews()._add(h, c.get_$customView()), t.isValue(o) && t.referenceEquals(c.get_$name(), o) && t.referenceEquals(c.get_$ownerName(), l) && e.set_$currentCustomView(c.get_$customView());
      ...
      this.$dashboard = null, this.$worksheets = new i._Collection(), this.$dashboardObjects = new i._Collection(), this.$filterCommandsBuilder = new i.FilterCommandsBuilder(), this.$sharedUtils = new i.SharedUtils(), l.call(this, e, t, n);
        ...
        this.$dashboardObjects = new i._Collection(), this.$worksheets = new i._Collection();for (var r = 0; r < e.length; r++) {
          var a = e[r],
            ...
            var o = a.name;if (t.isNullOrUndefined(o)) continue;var l = this.$worksheets.get__length(),
                ...
                f = new $(p, this.get_workbookImpl(), this.get_messagingOptions(), this);s = f.get_worksheet(), this.$worksheets._add(o, f.get_worksheet());
          }var g = new Q(a, this.get_dashboard(), s);this.$dashboardObjects._add(r.toString(), g);
        }
      }, $getFiltersAsync: function $getFiltersAsync() {
        var e = new i._Deferred(),
            n = new (t.makeGenericType(i.CommandReturnHandler$1, [Object]))("api.GetDashboardFiltersListCommand", 0, t.mkdel(this, function (i) {
          var n = Object.keys(i.filters),
              r = new Array(),
              a = t.getEnumerator(n);try {
            for (; a.moveNext();) {
              for (var s = a.current(), o = 0; o < this.get_worksheets().get__length(); o++) {
                if (t.referenceEquals(this.get_worksheets().get_item(o)._impl.get_name(), s)) {
                  var l = new Object();l.filters = Array.prototype.slice.call(i.filters[s]);var u = l,
                      c = Y.processFiltersList(this.get_worksheets().get_item(o)._impl, u);r = r.concat(c._toApiCollection());
                }
              }
            }
          } finally {
      ...
      }, $applyFilterAsync: function $applyFilterAsync(e, t, n, r) {
        this.$verifyActiveDashboard();var a = this.$filterCommandsBuilder.buildApplyFiltersCommandParams(e, t, n, r);a["api.dashboardName"] = this.get_name();var s = new i._Deferred(),
            o = this.$filterCommandsBuilder.createFilterCommandReturnHandler("api.ApplyDashboardCategoricalFilterCommand", e, s);return this.sendCommand(Object).call(this, a, o), s.get_promise();
      }, $verifyActiveDashboard: function $verifyActiveDashboard() {
        var e = this.get_isActive(),
            n = t.isValue(this.get_parentStoryPointImpl()) && this.get_parentStoryPointImpl().get_parentStoryImpl().get_isActive();if (!e && !n) throw i._TableauException.createNotActiveSheet();
      } }),
      ...
      this.$name = null, this.$fields = new i._Collection(), this.$isPrimary = !1, this.$dataSource = null, i._Param.verifyString(e, "name"), this.$name = e, this.$isPrimary = t;
        ...
        for (var n = new o(e.name, e.isPrimary), r = t.coalesce(e.fields, []), a = 0; a < r.length; a++) {
          var s = r[a],
              ...
              c = new K(n.get_dataSource(), s.name, l, u);n.addField(c);
        }return n;
        ...
        for (var n = new i._Collection(), r = null, a = 0; a < e.dataSources.length; a++) {
          var s = e.dataSources[a],
              l = o.processDataSource(s);s.isPrimary ? r = l : n._add(s.name, l.get_dataSource());
      ...
      this.$name = null, this.$index = 0, this.$isActive = !1, this.$isHidden = !1, this.$sheetType = null, this.$size = null, this.$url = null, this.$workbookImpl = null, this.$messagingOptions = null, this.$parentStoryPointImpl = null, this.$zoneId = 0, i._Param.verifyValue(e, "sheetInfoImpl"), i._Param.verifyValue(t, "workbookImpl"), i._Param.verifyValue(n, "messagingOptions"), this.$name = e.name, this.$index = e.index, this.$isActive = e.isActive, this.$isHidden = e.isHidden, this.$sheetType = e.sheetType, this.$size = e.size, this.$url = e.url, this.$workbookImpl = t, this.$messagingOptions = n, this.$zoneId = e.zoneId;
        ...
        if (e = l.$normalizeSheetSize(e), "worksheet" === this.$sheetType && "automatic" !== e.behavior) throw i._TableauException.createInvalidSizeBehaviorOnWorksheet();var n = new i._Deferred();if (this.$size.behavior === e.behavior && "automatic" === e.behavior) return n.resolve(e), n.get_promise();var r = this.$processSheetSize(e),
        ...
        var n = i.PublicEnums.normalizeEnum(i.ApiSheetSizeBehavior).call(null, e.behavior, "size.behavior"),
            r = e.minSize;t.isValue(r) && (r = i.Size.$ctor(l.$convertValueToIntIfValid(e.minSize.width), l.$convertValueToIntIfValid(e.minSize.height)));var a = e.maxSize;return t.isValue(a) && (a = i.Size.$ctor(l.$convertValueToIntIfValid(e.maxSize.width), l.$convertValueToIntIfValid(e.maxSize.height))), i.SheetSize.$ctor(n, r, a);
      } }),
        u = e.tab._SheetInfoImpl = t.mkType(n, "tab._SheetInfoImpl", null, null, { $ctor: function $ctor(e, t, i, n, r, a, s, o, l) {
      ...
      this.$activeStoryPointImpl = null, this.$findSheetFunc = null, this.$story = null, this.$storyPointsInfo = null, this.$2$ActiveStoryPointChangeField = null, l.call(this, e, t, n), i._Param.verifyValue(r, "storyPm"), i._Param.verifyValue(a, "findSheetFunc"), this.$findSheetFunc = a, this.update(r);
        ...
        var i = null,
          ...
          var a = e.storyPoints[r],
              ...
              l = m.$ctor(s, r, a.storyPointId, o, a.isUpdated, this);if (t.isNullOrUndefined(this.$storyPointsInfo[r])) this.$storyPointsInfo[r] = new se(l);else if (this.$storyPointsInfo[r]._impl.storyPointId === l.storyPointId) {
        ...
        }var c = this.$storyPointsInfo.length - e.storyPoints.length;this.$storyPointsInfo.splice(e.storyPoints.length, c);var d = t.isNullOrUndefined(this.$activeStoryPointImpl) || this.$activeStoryPointImpl.get_storyPointId() !== n.storyPointId;t.isValue(this.$activeStoryPointImpl) && d && this.$activeStoryPointImpl.set_isActive(!1);var p = this.$activeStoryPointImpl;if (d) {
          var f = h.createContainedSheet(i, this.get_workbookImpl(), this.get_messagingOptions(), this.$findSheetFunc);this.$activeStoryPointImpl = new h(n, f);
        } else this.$activeStoryPointImpl.set_isActive(n.isActive), this.$activeStoryPointImpl.set_isUpdated(n.isUpdated);d && t.isValue(p) && this.$raiseActiveStoryPointChange(this.$storyPointsInfo[p.get_index()], this.$activeStoryPointImpl.get_storyPoint());
        ...
        var t = this.$activeStoryPointImpl,
          ...
          var n = this.$storyPointsInfo[t.get_index()],
              ...
              a = h.createContainedSheet(e.containedSheetInfo, this.get_workbookImpl(), this.get_messagingOptions(), this.$findSheetFunc);r.isActive = !0, this.$activeStoryPointImpl = new h(r, a), t.set_isActive(!1), n._impl.isActive = !1, this.$raiseActiveStoryPointChange(n, this.$activeStoryPointImpl.get_storyPoint());
        }
      ...
      if (this.$caption = null, this.$index = 0, this.$isActive = !1, this.$isUpdated = !1, this.$containedSheetImpl = null, this.$parentStoryImpl = null, this.$storyPoint = null, this.$storyPointId = 0, this.$isActive = e.isActive, this.$isUpdated = e.isUpdated, this.$caption = e.caption, this.$index = e.index, this.$parentStoryImpl = e.parentStoryImpl, this.$storyPointId = e.storyPointId, this.$containedSheetImpl = i, t.isValue(i) && (this.$containedSheetImpl.set_parentStoryPointImpl(this), "dashboard" === i.get_sheetType())) for (var n = t.cast(this.$containedSheetImpl, s), r = 0; r < n.get_worksheets().get__length(); r++) {
        ...
        if (t.isNullOrUndefined(e) || t.isNullOrUndefined(e.name)) return null;var o = i.ApiEnumConverter.convertSheetType(e.sheetType),
            l = i.SheetSizeFactory.createAutomatic(),
            c = a(e.name),
            h = t.isNullOrUndefined(c),
            m = h ? "" : c.getUrl(),
            d = u.$ctor(e.name, o, -1, l, n.get_workbook(), m, !1, h, e.zoneId);if ("worksheet" === e.sheetType) {
          return new $(d, n, r, null);
        }if ("dashboard" === e.sheetType) {
          var p = new s(d, n, r),
              f = g.$createDashboardZones(e.dashboardZones);return p.$addObjects(f, a), p;
        ...
        m = e.tab._StoryPointInfoImpl = t.mkType(n, "tab._StoryPointInfoImpl", null, null, { $ctor: function $ctor(e, t, i, n, r, a) {
      ...
      this.$toolbarState = null, this.$vizImpl = null, this.$toolbarStatePresModel = null, this.$vizImpl = e, this.$toolbarStatePresModel = t;
        ...
        p = t.mkType(n, "tab._VizManagerImpl", null, null, { get_$clonedVizs: function get_$clonedVizs() {
      ...
      if (this.name = "", this.host_url = null, this.tabs = !1, this.toolbar = !1, this.toolBarPosition = null, this.device = null, this.hostId = null, this.width = null, this.height = null, this.parentElement = null, this.userSuppliedParameters = null, this.staticImageUrl = null, this.fixedSize = !1, this.displayStaticImage = !1, this.$urlFromApi = null, this.$createOptions = null, this.$disableUrlActionsPopups = !1, t.isNullOrUndefined(e) || t.isNullOrUndefined(n)) throw i._TableauException.create("noUrlOrParentElementNotFound", "URL is empty or Parent element not found");t.isNullOrUndefined(r) && ((r = new Object()).hideTabs = !1, r.hideToolbar = !1, r.onFirstInteractive = null), t.isValue(r.height) || t.isValue(r.width) ? (this.fixedSize = !0, i._Utility.isNumber(r.height) && (r.height = r.height.toString() + "px"), i._Utility.isNumber(r.width) && (r.width = r.width.toString() + "px"), this.height = t.isValue(r.height) ? i._Utility.roundVizSizeInPixels(r.height.toString()) : null, this.width = t.isValue(r.width) ? i._Utility.roundVizSizeInPixels(r.width.toString()) : null) : this.fixedSize = !1, this.displayStaticImage = r.displayStaticImage || !1, this.staticImageUrl = r.staticImageUrl || "", this.tabs = !r.hideTabs, this.toolbar = !r.hideToolbar, this.device = r.device, this.parentElement = e, this.$createOptions = r, this.toolBarPosition = r.toolbarPosition, this.$disableUrlActionsPopups = !0 === r.disableUrlActionsPopups;var a = n.split("?");this.$urlFromApi = a[0], 2 === a.length ? this.userSuppliedParameters = a[1] : this.userSuppliedParameters = "";var s = new RegExp(".*?[^/:]/", "").exec(this.$urlFromApi);if (t.isNullOrUndefined(s) || -1 === s[0].toLowerCase().indexOf("http://") && -1 === s[0].toLowerCase().indexOf("https://")) throw i._TableauException.create("invalidUrl", "Invalid url");this.host_url = s[0].toLowerCase(), this.name = this.$urlFromApi.replace(s[0], ""), this.name = this.name.replace("views/", "");
        ...
        var e = [];e.push(this.get_baseUrl()), e.push("?"), this.userSuppliedParameters.length > 0 && (e.push(this.userSuppliedParameters), e.push("&")), !this.fixedSize && !(-1 !== this.userSuppliedParameters.indexOf(":size=")) && this.parentElement.clientWidth * this.parentElement.clientHeight > 0 && (e.push(":size="), e.push(this.parentElement.clientWidth + "," + this.parentElement.clientHeight), e.push("&")), -1 === this.userSuppliedParameters.indexOf(":embed=y") && e.push(":embed=y"), e.push("&:showVizHome=n"), e.push("&:jsdebug=y"), this.fixedSize || e.push("&:bootstrapWhenNotified=y"), this.tabs || e.push("&:tabs=n"), this.displayStaticImage && e.push("&:display_static_image=y"), this.$disableUrlActionsPopups && e.push("&:disableUrlActionsPopups=y"), this.toolbar ? t.isNullOrUndefined(this.toolBarPosition) || (e.push("&:toolbar="), e.push(this.toolBarPosition.toString())) : e.push("&:toolbar=n"), t.isValue(this.device) && (e.push("&:device="), e.push(this.device.toString()));var i = this.$createOptions,
      ...
      this.$workbook = null, this.$vizImpl = null, this.$name = null, this.$activeSheetImpl = null, this.$activatingHiddenSheetImpl = null, this.$publishedSheetsInfo = new i._Collection(), this.$isDownloadAllowed = !1, this.$messagingOptions = null, this.$currentCustomView = null, this.$customViews = new i._Collection(), this.$updatedCustomViews = new i._Collection(), this.$removedCustomViews = new i._Collection(), this.$parameters = null, this.$lastChangedParameterImpl = null, this.$vizImpl = e, this.$messagingOptions = t, this.$getClientInfo(n);
        ...
        if (t.isNullOrUndefined(this.$activeSheetImpl)) return null;var i = g.$extractSheetName(e);if (t.isNullOrUndefined(i)) return null;if (t.referenceEquals(i, this.$activeSheetImpl.get_name())) return this.$activeSheetImpl;if (this.$activeSheetImpl.get_isDashboard()) {
          var n = t.cast(this.$activeSheetImpl, s).get_worksheets()._get(i);if (t.isValue(n)) return n._impl;
        }return null;
        ...
        if (i._Utility.isNumber(e)) {
          ...
          var o = t.cast(this.$activeSheetImpl, s).get_worksheets()._get(r);if (t.isValue(o)) {
            this.$activatingHiddenSheetImpl = null;var l = "";return o.getIsHidden() ? this.$activatingHiddenSheetImpl = o._impl : l = o._impl.get_url(), this.$activateSheetInternalAsync(o._impl.get_name(), l);
          }
        ...
        var n = e.currentSheetName,
          ...
          if (t.isValue(this.$activeSheetImpl)) {
            this.$activeSheetImpl.set_isActive(!1);var a = this.$publishedSheetsInfo._get(this.$activeSheetImpl.get_name());if (t.isValue(a) && (a.$impl.isActive = !1), "story" === this.$activeSheetImpl.get_sheetType()) t.cast(this.$activeSheetImpl, c).remove_activeStoryPointChange(t.mkdel(this.$vizImpl, this.$vizImpl.raiseStoryPointSwitch));
          }if (t.isValue(this.$activatingHiddenSheetImpl)) {
            var o = u.$ctor(this.$activatingHiddenSheetImpl.get_name(), "worksheet", -1, this.$activatingHiddenSheetImpl.get_size(), this.get_workbook(), "", !0, !0, l.noZoneId);this.$activatingHiddenSheetImpl = null, this.$activeSheetImpl = new $(o, this, this.$messagingOptions, null);
          } else {
            for (var h = null, m = 0, d = e.publishedSheets.length; m < d; m++) {
              if (t.referenceEquals(e.publishedSheets[m].name, n)) {
                h = e.publishedSheets[m];break;
              }
            }if (t.isNullOrUndefined(h)) throw i._TableauException.createInternalError("No base sheet was found corresponding to the active sheet.");var p = t.mkdel(this, function (e) {
              return this.$publishedSheetsInfo._get(e);
            });if ("dashboard" === h.sheetType) {
              var f = new s(r.$impl, this, this.$messagingOptions);this.$activeSheetImpl = f;var v = g.$createDashboardZones(e.dashboardZones);f.$addObjects(v, p);
            } else if ("story" === h.sheetType) {
              var y = new c(r.$impl, this, this.$messagingOptions, e.story, p);this.$activeSheetImpl = y, y.add_activeStoryPointChange(t.mkdel(this.$vizImpl, this.$vizImpl.raiseStoryPointSwitch));
            } else this.$activeSheetImpl = new $(r.$impl, this, this.$messagingOptions, null);r.$impl.isActive = !0;
        ...
        var n = e.publishedSheets;if (!t.isNullOrUndefined(n)) for (var r = 0; r < n.length; r++) {
          var a = n[r],
              ...
              c = g.$createSheetSize(a);if (t.isNullOrUndefined(o)) {
            var h = t.referenceEquals(s, e.currentSheetName),
                m = i.ApiEnumConverter.convertSheetType(a.sheetType),
                d = u.$ctor(s, m, r, c, this.get_workbook(), a.repositoryUrl, h, !1, l.noZoneId);o = new ne(d), this.$publishedSheetsInfo._add(s, o);
          } else o.$impl.size = c;
        }
        ...
        if (t.isNullOrUndefined(e) || i._Utility.isNullOrEmpty(e)) return a._showCustomViewAsync(this, this.$messagingOptions, null);var n = this.$customViews._get(e);if (t.isNullOrUndefined(n)) {
        ...
        if (i._Utility.isNullOrEmpty(e)) throw i._TableauException.createInvalidParameter("customViewName");return a._saveNewAsync(this, this.$messagingOptions, e);
        ...
        var n = new i._Deferred();if (t.isValue(this.$lastChangedParameterImpl)) return n.resolve(this.$lastChangedParameterImpl.get_$parameter()), n.get_promise();var r = new (t.makeGenericType(i.CommandReturnHandler$1, [Object]))("api.FetchParametersCommand", 0, t.mkdel(this, function (t) {
          var i = g.$findAndCreateParameterImpl(e, t);this.$lastChangedParameterImpl = i, n.resolve(i.get_$parameter());
        }), function (e, t) {
          n.reject(i._TableauException.createServerError(t));
        });return this.$sendCommand(Object).call(this, {}, r), n.get_promise();
      ...
      this.$worksheet = null, this.$parentDashboardImpl = null, this.$getDataCommandsBuilder = new i.GetDataCommandsBuilder(), this.$filterCommandsBuilder = new i.FilterCommandsBuilder(), this.$sharedUtils = new i.SharedUtils(), this.$filters = new i._Collection(), this.$selectedMarks = new i._Collection(), this.highlightedMarks = null, l.call(this, e, t, n), this.$parentDashboardImpl = r;
        ...
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard();var e = new i._Deferred(),
          ...
          var i = o.processDataSourcesForWorksheet(t);e.resolve(i._toApiCollection());
        }, function (t, n) {
          e.reject(i._TableauException.createServerError(n));
        });return this.sendCommand(Object).call(this, n, r), e.get_promise();
        ...
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard();var n = new i._Deferred(),
          ...
          var a = o.processDataSource(r);t.isValue(a) ? n.resolve(a.get_dataSource()) : n.reject(i._TableauException.createServerError("Data source '" + e + "' not found"));
        }, function (e, t) {
          n.reject(i._TableauException.createServerError(t));
        });return this.sendCommand(Object).call(this, r, a), n.get_promise();
        ...
        if (!i._Utility.isNullOrEmpty(e) && !i._Utility.isNullOrEmpty(n)) throw i._TableauException.createInternalError("Only fieldName OR fieldCaption is allowed, not both.");r = r || new Object();var a = new i._Deferred(),
            s = {};this.$addVisualIdToCommand(s), !i._Utility.isNullOrEmpty(n) && i._Utility.isNullOrEmpty(e) && (s["api.fieldCaption"] = n), i._Utility.isNullOrEmpty(e) || (s["api.fieldName"] = e), s["api.filterHierarchicalLevels"] = 0, s["api.ignoreDomain"] = r.ignoreDomain || !1, s["api.filterRelevantValuesOnly"] = !!t.isNullOrUndefined(r.relevantValuesOnly) || r.relevantValuesOnly;var o = new (t.makeGenericType(i.CommandReturnHandler$1, [Object]))("api.GetOneFilterInfoCommand", 0, t.mkdel(this, function (e) {
          var i = $.$filterCommandError(e);if (t.isNullOrUndefined(i)) {
            var n = e,
        ...
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard(), e = e || new Object();var n = new i._Deferred(),
            r = {};this.$addVisualIdToCommand(r), r["api.ignoreDomain"] = e.ignoreDomain || !1, r["api.filterRelevantValuesOnly"] = !!t.isNullOrUndefined(e.relevantValuesOnly) || e.relevantValuesOnly;var a = new (t.makeGenericType(i.CommandReturnHandler$1, [Object]))("api.GetFiltersListCommand", 0, t.mkdel(this, function (e) {
      ...
      }, $getAppliedWorksheetsAsync: function $getAppliedWorksheetsAsync(e, n) {
        var r = new i._Deferred();return this.$getSharedFilterWorksheets(Array).call(this, e, n, function (e) {
          var i = e,
              n = [];if (t.isValue(i.sharedFilterWorksheetInfoList)) for (var a = 0; a < i.sharedFilterWorksheetInfoList.length; a++) {
            var s = i.sharedFilterWorksheetInfoList[a];s.isSelected && n.push(s.worksheetName);
          }r.resolve(n);
        }, function (e, t) {
          r.reject(i._TableauException.createServerError(t));
        }), r.get_promise();
      }, $setAppliedWorksheetsAsync: function $setAppliedWorksheetsAsync(e, n, r, a) {
        if (t.isNullOrUndefined(e)) throw i._TableauException.createInvalidParameter("Worksheet");var s = new i._Deferred();e = this.$getDistinctWorksheets(e);var o = t.mkdel(this, function (n) {
          var o = n,
              l = new String(),
              u = [],
              c = [];if (t.isValue(o.sharedFilterWorksheetInfoList)) {
            for (var h = 0; h < o.sharedFilterWorksheetInfoList.length; h++) {
              var m = o.sharedFilterWorksheetInfoList[h];m.isActive && (l = m.worksheetName), m.isSelected ? u.push(m.worksheetName) : m.isEnabled && c.push(m.worksheetName);
            }if (t.contains(e, l)) {
              for (var d = 0; d < e.length; d++) {
                var p = e[d];if (!t.contains(u, p) && !t.contains(c, p)) {
                  var f = "The field " + a + " isn't applicable to the worksheet " + p;return void s.reject(i._TableauException.createInternalError(f));
                }
              }var g = {};g["api.fieldName"] = r, g["api.sharedFilterSheets"] = e, this.$addVisualIdToCommand(g);var $ = new (t.makeGenericType(i.CommandReturnHandler$1, [Object]))("api.SetAppliedWorksheetsCommand", 0, function (t) {
                s.resolve(e);
              }, function (e, t) {
                s.reject(i._TableauException.createServerError(t));
              });this.sendCommand(Object).call(this, g, $);
            } else {
              var v = l + " must be included in the applied worksheets";s.reject(i._TableauException.createInternalError(v));
            }
          } else s.reject(i._TableauException.createServerError("The server returned empty pres model for getAppliedWorksheetsAsync()"));
        });return this.$getSharedFilterWorksheets(Array).call(this, n, r, o, function (e, t) {
          s.reject(i._TableauException.createServerError(t));
        }), s.get_promise();
      }, $getDistinctWorksheets: function $getDistinctWorksheets(e) {
        for (var t = new Set(), i = [], n = 0; n < e.length; n++) {
          var r = e[n];t.has(r) || (t.add(r), i.push(r));
        }return i;
      }, $getSharedFilterWorksheets: function $getSharedFilterWorksheets(e) {
        return function (e, n, r, a) {
          var s = {};s["api.fieldName"] = n, this.$addVisualIdToCommand(s);var o = new (t.makeGenericType(i.CommandReturnHandler$1, [Object]))("api.GetAppliedWorksheetsCommand", 0, r, a);this.sendCommand(Object).call(this, s, o);
        };
        ...
        var c = u;if ($.$regexHierarchicalFieldName.test(l)) this.$addToParamLists(r, a, l, u);else if (t.isValue(c.min) || t.isValue(c.max)) {
        ...
        var c = {};if (this.$addVisualIdToCommand(c), u = i.PublicEnums.normalizeEnum(i.ApiSelectionUpdateType).call(null, u, "updateType"), c["api.filterUpdateType"] = u, i._Utility.isNullOrEmpty(e) || (c["api.tupleIds"] = JSON.stringify(e)), !i._Utility.isNullOrEmpty(n) && !i._Utility.isNullOrEmpty(r)) {
          ...
          c["api.rangeFieldCaption"] = JSON.stringify(o);for (var v = [], y = 0; y < l.length; y++) {
            var _ = JSON.stringify(l[y]);v.push(_);
          }c["api.rangeMarkValues"] = JSON.stringify(v);
        }if (i._Utility.isNullOrEmpty(c["api.tupleIds"]) && i._Utility.isNullOrEmpty(c["api.categoricalFieldCaption"]) && i._Utility.isNullOrEmpty(c["api.hierarchicalFieldCaption"]) && i._Utility.isNullOrEmpty(c["api.rangeFieldCaption"])) throw i._TableauException.createInvalidParameter("fieldNameOrFieldValuesMap");var w = new i._Deferred(),
            b = new (t.makeGenericType(i.CommandReturnHandler$1, [Object]))("api.SelectMarksCommand", 0, function (e) {
          var i = $.$createSelectionCommandError(e);t.isNullOrUndefined(i) ? w.resolve() : w.reject(i);
        }, function (e, t) {
        ...
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard();var e = new i._Deferred(),
            t = this.$getDataCommandsBuilder.getUnderlyingTablesCommandParams();this.$addVisualIdToCommand(t);var n = this.$getDataCommandsBuilder.getUnderlyingTablesResponseHandler(e);return this.sendCommand(Object).call(this, t, n), e.get_promise();
      }, $getUnderlyingTableDataAsync: function $getUnderlyingTableDataAsync(e, t) {
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard();var n = new i._Deferred(),
            r = this.$getDataCommandsBuilder.getUnderlyingTableDataCommandParams(e, t);this.$addVisualIdToCommand(r);var a = this.$getDataCommandsBuilder.getUnderlyingTableDataResponseHandler(n);return this.sendCommand(Object).call(this, r, a), n.get_promise();
      ...
      this.$customViewImpl = null, T.call(this, e, null), this.$customViewImpl = t;
        ...
        y = t.mkType(n, "tab.$DashboardZoneInfo", null, null, { isInstanceOfType: function isInstanceOfType() {
        return !0;
      } }),
      ...
      this.$filterCaption = null, this.$context = null, W.call(this, e, t, i), this.$filterCaption = r, this.$context = new _(t._impl.get__workbookImpl(), i, n, r);
        ...
        A = e.tab.FirstVizSizeKnownEvent = t.mkType(n, "tab.FirstVizSizeKnownEvent", function (e, t, i) {
      this.$vizSize = null, P.call(this, e, t), this.$vizSize = i;
    }, { getVizSize: function getVizSize() {
        return this.$vizSize;
      } }),
        E = e.tab.HighlightEvent = t.mkType(n, "tab.HighlightEvent", function (e, t, i) {
      ...
      this.$context = null, P.call(this, e, t), this.$context = new S(t._impl.get__workbookImpl(), i);
        ...
        R = e.tab.StoryPointInfoImplUtil = t.mkType(n, "tab.StoryPointInfoImplUtil", null, null, { clone: function clone(e) {
      ...
      if (this.$workbookTabSwitchHandler = null, this.$viz = null, this.$iframe = null, this.$staticImage = null, this.$parameters = null, this.$initialAvailableSize = null, this.$instanceId = null, this.$workbookImpl = null, this.$onFirstInteractiveCallback = null, this.$onFirstVizSizeKnownCallback = null, this.$onFirstInteractiveAlreadyCalled = !1, this.$areTabsHidden = !1, this.$isToolbarHidden = !1, this.$areAutomaticUpdatesPaused = !1, this.$messagingOptions = null, this.$vizSize = null, this.$windowResizeHandler = null, this.$initializingWorkbookImpl = !1, this.$1$CustomViewsListLoadField = null, this.$1$StateReadyForQueryField = null, this.$1$MarksSelectionField = null, this.$1$MarksHighlightField = null, this.$1$FilterChangeField = null, this.$1$ParameterValueChangeField = null, this.$1$CustomViewLoadField = null, this.$1$CustomViewSaveField = null, this.$1$CustomViewRemoveField = null, this.$1$CustomViewSetDefaultField = null, this.$1$TabSwitchField = null, this.$1$ToolbarStateChangeField = null, this.$1$StoryPointSwitchField = null, this.$1$VizResizeField = null, this.$1$UrlActionField = null, !i._Utility.hasWindowPostMessage() || !i._Utility.hasJsonParse()) throw i._TableauException.createBrowserNotCapable();this.$messagingOptions = new O(e, this), this.$viz = n, (t.isNullOrUndefined(r) || 1 !== r.nodeType) && (r = document.body), this.$parameters = new f(r, a, s), t.isValue(s) && (this.$onFirstInteractiveCallback = s.onFirstInteractive, this.$onFirstVizSizeKnownCallback = s.onFirstVizSizeKnown);
        ...
        var t = this.$verifyOperationAllowedOnActiveSheetOrSheetWithinActiveDashboard(e);this.$invokeCommand("exportCrosstabToExcel", t);
        ...
        if (!t.staticEquals(this.$1$MarksSelectionField, null) && t.referenceEquals(this.$workbookImpl.get_name(), e.get_workbookName())) {
          var i = null,
              n = this.$workbookImpl.get_activeSheetImpl();if (n.get_isStory() && (n = t.cast(n, c).get_activeStoryPointImpl().get_containedSheetImpl()), t.referenceEquals(n.get_name(), e.get_worksheetName())) i = t.cast(n, $);else if (n.get_isDashboard()) {
        ...
        if (!t.staticEquals(this.$1$FilterChangeField, null) && t.referenceEquals(this.$workbookImpl.get_name(), e.get_workbookName())) {
          var i = null,
              n = this.$workbookImpl.get_activeSheetImpl();if (t.referenceEquals(n.get_name(), e.get_worksheetName())) i = t.cast(n, $);else if (n.get_isDashboard()) {
            i = t.cast(n, s).get_worksheets()._get(e.get_worksheetName())._impl;
          } else if (n.get_isStory()) {
            var r = t.cast(n, c).get_activeStoryPointImpl().get_containedSheetImpl();if (r.get_isDashboard()) i = t.cast(r, s).get_worksheets()._get(e.get_worksheetName())._impl;else t.referenceEquals(r.get_name(), e.get_worksheetName()) && (i = t.cast(r, $));
          }if (t.isValue(i)) {
            var a = t.cast(JSON.parse(t.cast(e.get_data(), String)), Array),
                o = a[0],
                l = a[1];this.$1$FilterChangeField(new k("filterchange", this.$viz, i, o, l));
          }
        }
        ...
        var i = JSON.parse(t.cast(e.get_data(), String));if (t.isNullOrUndefined(this.$workbookImpl) && (this.$workbookImpl = new g(this, this.$messagingOptions, null)), t.isValue(this.$workbookImpl) && a._processCustomViewUpdate(this.$workbookImpl, this.$messagingOptions, i, !0), !t.staticEquals(this.$1$CustomViewSaveField, null)) for (var n = this.$workbookImpl.get_$updatedCustomViews()._toApiCollection(), r = 0, s = n.length; r < s; r++) {
        ...
        var i = JSON.parse(t.cast(e.get_data(), String));if (t.isValue(this.$workbookImpl) && a._processCustomViews(this.$workbookImpl, this.$messagingOptions, i), !t.staticEquals(this.$1$CustomViewSetDefaultField, null) && t.isValue(i.defaultCustomViewId)) for (var n = this.$workbookImpl.get_$customViews(), r = 0; r < n.get__length(); r++) {
          var s = n.get_item(r);if (s.getDefault()) {
            this.$raiseCustomViewSetDefault(s);break;
          }
        }
        ...
        var i = JSON.parse(t.cast(e.get_data(), String)),
            n = new d(this, i);t.staticEquals(this.$1$ToolbarStateChangeField, null) || this.$1$ToolbarStateChangeField(new U("toolbarstatechange", this.$viz, n));
      }, $handleStorytellingStateChangedEvent: function $handleStorytellingStateChangedEvent(e) {
        var i = t.cast(this.$workbookImpl.get_activeSheetImpl(), c);"story" === i.get_sheetType() && i.update(JSON.parse(t.cast(e.get_data(), String)));
        ...
        var n = document.createElement("div"),
            r = t.cast(n, t.isValue(n) && t.isInstanceOfType(n, Element) && "DIV" === n.tagName);return r.style.background = "transparent url('" + this.$parameters.staticImageUrl + "') no-repeat scroll 0 0", r.style.left = "8px", r.style.top = this.$parameters.tabs ? "31px" : "9px", r.style.position = "absolute", r.style.width = e, r.style.height = i, this.$contentRootElement().appendChild(r), r;
        ...
        var n = i.SheetSizeFactory.fromSizeConstraints(e.sizeConstraints);this.$vizSize = j.$ctor(n, e.chromeHeight), t.isValue(this.$onFirstVizSizeKnownCallback) && this.$onFirstVizSizeKnownCallback(new A("firstvizsizeknown", this.$viz, this.$vizSize)), this.$parameters.fixedSize || (this.$refreshSize(), this.$addWindowResizeHandler(), this.$show());
      ...
      this.$worksheetImpl = null, this.$type = null, this.$fieldCaption = null, this.$fieldName = null, this.$field = null, this.$dataSourceName = null, this.$fieldRole = null, this.$fieldAggregation = null, this.$worksheetImpl = e, this.$initializeFromJson(t);
        ...
        var e = new i._Deferred();if (t.isNullOrUndefined(this.$field)) {
          var n = t.mkdel(this, function (t) {
            return this.$field = new K(t, this.$fieldCaption, this.$fieldRole, this.$fieldAggregation), e.resolve(this.$field), null;
        ...
        return this.$worksheetImpl.$setAppliedWorksheetsAsync(e, this.getWorksheet().getName(), this.$fieldName, this.$fieldCaption);
      }, _update: function _update(e) {
        ...
        this.$fieldName = e.fieldName, this.$fieldCaption = e.caption, this.$type = i.ApiEnumConverter.convertFilterType(e.filterType), this.$field = null, this.$dataSourceName = e.dataSourceName, this.$fieldRole = i.ApiEnumConverter.convertFieldRole(t.coalesce(e.fieldRole, "unknown")), this.$fieldAggregation = i.ApiEnumConverter.convertFieldAggregation(t.coalesce(e.fieldAggregation, "NONE"));
