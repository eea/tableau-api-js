...
!function () {
  ...
  !function (e) {
    ...
    r.initAssembly = function (e, t, i) {
      ...
      return e !== r && "function" == typeof e.equals ? e.equals(t) : r.isDate(e) && r.isDate(t) ? e.valueOf() === t.valueOf() : "function" == typeof e && "function" == typeof t ? r.delegateEquals(e, t) : !(!r.isNullOrUndefined(e) || !r.isNullOrUndefined(t)) || e === t;
    }, r.compare = function (e, t) {
      if (r.isValue(e)) return "number" == typeof e || "string" == typeof e || "boolean" == typeof e ? e < t ? -1 : e > t ? 1 : 0 : r.isDate(e) ? r.compare(e.valueOf(), t.valueOf()) : e.compareTo(t);
      throw new M("Object is null");
    }, r.equalsT = function (e, t) {
      if (r.isValue(e)) return "number" == typeof e || "string" == typeof e || "boolean" == typeof e ? e === t : r.isDate(e) ? e.valueOf() === t.valueOf() : e.equalsT(t);
      throw new M("Object is null");
      ...
      toString: null
    }.propertyIsEnumerable("toString"), a = (n = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"]).length, function (e) {
      ...
      r.__genericCache[o] = e, e.__typeName = o, e.__genericTypeDefinition = t, e.__typeArguments = i, r.initClass(e, t.__assembly, n, a(), s());
    }, r.registerGenericInterfaceInstance = function (e, t, i, n, a) {
      var s = r._makeGenericTypeName(t, i);

      r.__genericCache[s] = e, e.__typeName = s, e.__genericTypeDefinition = t, e.__typeArguments = i, r.initInterface(e, t.__assembly, n, a());
      ...
      var a,
          ...
          l = n.exec(t),
          u = [];
      if (l) switch (a = t.substring(o, l.index), l[0]) {
        case "[":
          ...
          if ((l = n.exec(t)) && "," === l[0] && (n.exec(t), !(i = r.__assemblies[(n.lastIndex > 0 ? t.substring(l.index + 1, n.lastIndex - 1) : t.substring(l.index + 1)).trim()]))) return null;
          break;
        ...
        case ",":
          if (n.exec(t), !(i = r.__assemblies[(n.lastIndex > 0 ? t.substring(l.index + 1, n.lastIndex - 1) : t.substring(l.index + 1)).trim()])) return null;
          break;
    ...
    s.__typeName = "ss.IFormattable", r.IFormattable = s, r.initInterface(s, r, {
      format: null
    });

    var o = function o() {};

    o.__typeName = "ss.IComparable", r.IComparable = o, r.initInterface(o, r, {
      compareTo: null
    });

    var l = function l() {};

    l.__typeName = "ss.IEquatable", r.IEquatable = l, r.initInterface(l, r, {
      equalsT: null
      ...
      for (var n = [], a = arguments.length >= 2 ? arguments[1] : void 0, r = 0; r < i; r++) {
        if (r in t) {
          var s = t[r];
    ...
    u.__typeName = "ss.Enum", r.Enum = u, r.initClass(u, r, {}), u.getValues = function (e) {
      var t = [],
          i = e.prototype;
    ...
    c.__typeName = "ss.IEnumerator", r.IEnumerator = c, r.initInterface(c, r, {
      current: null,
      moveNext: null,
      reset: null
    }, [C]);
    ...
    h.__typeName = "ss.IEnumerable", r.IEnumerable = h, r.initInterface(h, r, {
      getEnumerator: null
    ...
    m.__typeName = "ss.ICollection", r.ICollection = m, r.initInterface(m, r, {
      get_count: null,
      add: null,
      clear: null,
      contains: null,
    ...
    d.__typeName = "ss.IEqualityComparer", r.IEqualityComparer = d, r.initInterface(d, r, {
      areEqual: null,
    ...
    p.__typeName = "ss.IComparer", r.IComparer = p, r.initInterface(p, r, {
      compare: null
    }), r.unbox = function (e) {
    ...
    g.__typeName = "ss.IList", r.IList = g, r.initInterface(g, r, {
      get_item: null,
      set_item: null,
      indexOf: null,
      insert: null,
      removeAt: null
    }, [m, h]), r.getItem = function (e, t) {
    ...
    $.__typeName = "ss.IDictionary", r.IDictionary = $, r.initInterface($, r, {
      get_item: null,
      set_item: null,
      get_keys: null,
      get_values: null,
    ...
    _.__typeName = "ss.Int32", r.Int32 = _, r.initClass(_, r, {}, Object, [l, o, s]), _.__class = !1, _.isInstanceOfType = function (e) {
    ...
    v.__typeName = "ss.JsDate", r.JsDate = v, r.initClass(v, r, {}, Object, [l, o]), v.createInstance = function () {
      return new Date();
    ...
    y.__typeName = "ss.ArrayEnumerator", r.ArrayEnumerator = y, r.initClass(y, r, {
    ...
    w.__typeName = "ss.ObjectEnumerator", r.ObjectEnumerator = w, r.initClass(w, r, {
      moveNext: function moveNext() {
    ...
    b.__typeName = "ss.EqualityComparer", r.EqualityComparer = b, r.initClass(b, r, {
    ...
    S.__typeName = "ss.Comparer", r.Comparer = S, r.initClass(S, r, {
    ...
    C.__typeName = "ss.IDisposable", r.IDisposable = C, r.initInterface(C, r, {
      dispose: null
    });
    ...
    I.__typeName = "ss.StringBuilder", r.StringBuilder = I, r.initClass(I, r, {
    ...
    E.__typeName = "ss.EventArgs", r.EventArgs = E, r.initClass(E, r, {}), E.Empty = new E();

    var N = function N(e, t) {
      this._message = e || "An error occurred.", this._innerException = t || null, this._error = new Error();
    };

    N.__typeName = "ss.Exception", r.Exception = N, r.initClass(N, r, {
      ...
      toString: function toString() {
        var e = this._message,
            t = this;
        return r.isNullOrEmptyString(e) && (e = r.isValue(r.getInstanceType(t)) && r.isValue(r.getTypeFullName(r.getInstanceType(t))) ? r.getTypeFullName(r.getInstanceType(t)) : "[object Exception]"), e;
      }
    }), N.wrap = function (e) {
    ...
    A.__typeName = "ss.NotImplementedException", r.NotImplementedException = A, r.initClass(A, r, {}, N);

    var T = function T(e, t) {
      N.call(this, e || "Specified method is not supported.", t);
    };

    T.__typeName = "ss.NotSupportedException", r.NotSupportedException = T, r.initClass(T, r, {}, N);
    ...
    V.__typeName = "ss.AggregateException", r.AggregateException = V, r.initClass(V, r, {
      flatten: function flatten() {
        for (var e = [], t = 0; t < this.innerExceptions.length; t++) {
          var i = this.innerExceptions[t];
          r.isInstanceOfType(i, V) ? e.push.apply(e, i.flatten().innerExceptions) : e.push(i);
        }
    ...
    k.__typeName = "ss.PromiseException", r.PromiseException = k, r.initClass(k, r, {
    ...
    O.__typeName = "ss.JsErrorException", r.JsErrorException = O, r.initClass(O, r, {
      get_stack: function get_stack() {
    ...
    F.__typeName = "ss.ArgumentException", r.ArgumentException = F, r.initClass(F, r, {}, N);

    var R = function R(e, t, i) {
      t || (t = "Value cannot be null.", e && (t += "\nParameter name: " + e)), F.call(this, t, e, i);
    };

    R.__typeName = "ss.ArgumentNullException", r.ArgumentNullException = R, r.initClass(R, r, {}, F);

    var D = function D(e, t, i, n) {
      t || (t = "Value is out of range.", e && (t += "\nParameter name: " + e)), F.call(this, t, e, i), this.actualValue = n || null;
    };

    D.__typeName = "ss.ArgumentOutOfRangeException", r.ArgumentOutOfRangeException = D, r.initClass(D, r, {}, F);

    var z = function z(e, t) {
      N.call(this, e || "Invalid format.", t);
    };

    z.__typeName = "ss.FormatException", r.FormatException = z, r.initClass(z, r, {}, N);

    var x = function x(e, t) {
      N.call(this, e || "Division by 0.", t);
    };

    x.__typeName = "ss.DivideByZeroException", r.DivideByZeroException = x, r.initClass(x, r, {}, N);

    var P = function P(e, t) {
      N.call(this, e || "The cast is not valid.", t);
    };

    P.__typeName = "ss.InvalidCastException", r.InvalidCastException = P, r.initClass(P, r, {}, N);

    var U = function U(e, t) {
      N.call(this, e || "Operation is not valid due to the current state of the object.", t);
    };

    U.__typeName = "ss.InvalidOperationException", r.InvalidOperationException = U, r.initClass(U, r, {}, N);

    var M = function M(e, t) {
      N.call(this, e || "Object is null.", t);
    };

    M.__typeName = "ss.NullReferenceException", r.NullReferenceException = M, r.initClass(M, r, {}, N);

    var H = function H(e, t) {
      N.call(this, e || "Key not found.", t);
    };

    H.__typeName = "ss.KeyNotFoundException", r.KeyNotFoundException = H, r.initClass(H, r, {}, N);

    var L = function L(e, t) {
      N.call(this, e || "Ambiguous match.", t);
    };

    L.__typeName = "ss.AmbiguousMatchException", r.AmbiguousMatchException = L, r.initClass(L, r, {}, N);

    var j = function j(e, t) {
      this._getEnumerator = e, this._this = t;
    };

    j.__typeName = "ss.IteratorBlockEnumerable", r.IteratorBlockEnumerable = j, r.initClass(j, r, {
    ...
    W.__typeName = "ss.IteratorBlockEnumerator", r.IteratorBlockEnumerator = W, r.initClass(W, r, {
      moveNext: function moveNext() {
        try {
    ...
    B.__typeName = "ss.Lazy", r.Lazy = B, r.initClass(B, r, {
  ...
  !function () {
    ...
    r.__typeName = "tab.CookieHelper", r.getValueForCookie = function (e) {
      var i = s.getCookie().match(new RegExp("(?:^|;) ?" + e + "=([^;]*)(?:;|$)"));
      return t.isNullOrUndefined(i) || i.length < 2 ? null : i[1];
    }, r.setCookie = function (e, i, n, a) {
      var r = e + "=" + i + ";path=" + n + ";";
      t.staticEquals(a, null) || (r += "expires=" + a.toUTCString()), s.setCookie(r);
    ...
    s.__typeName = "tab.DocumentHelper", s.get_documentClientWidth = function () {
    ...
    o.__typeName = "tab.EscapingUtil", o.escapeHtml = function (e) {
      var i = t.coalesce(e, "");
    ...
    l.__typeName = "tab.LazyUtil", l.lazyInitStaticField = function (e, i, n) {
      var a = e[i];
    ...
    u.__typeName = "tab.Log", u.get = function (e) {
    ...
    p.__typeName = "tab.UriExtensions", p.getUriQueryParameters = function (e) {
      var i = {};
      ...
      var a = e.substr(n + 1),
          r = a.indexOf("#");
      if (r >= 0 && (a = a.substr(0, r)), t.isNullOrEmptyString(a)) return i;
    ...
    f.__typeName = "tab.WindowHelper", f.get_windowSelf = function () {
    ...
    }, e.tab.WindowHelper = f, t.initClass(n, i, {
      ...
      formatMessage: function formatMessage(e, i) {
        ...
        for (var n = new t.StringBuilder(), a = 0, r = !1, s = 0; s < e.length; s++) {
          var o = e.charCodeAt(s);
          if (37 === o) r ? (n.append("%"), r = !1) : r = !0;else {
            if (r) switch (o) {
              case 98:
              case 115:
              case 100:
    ...
    }, n), t.initClass(r, i, {}), t.initClass(s, i, {}), t.initClass(o, i, {}), t.initClass(l, i, {}), t.initClass(u, i, {}), t.initClass(c, i, {
      ...
      error: 4,
      off: 5
    }), t.initClass(d, i, {}), t.initClass(p, i, {}), t.initClass(f, i, {
      ...
      for (var s = 0; s < n.length && (t.isNullOrUndefined(a) || t.isNullOrUndefined(r)); ++s) {
        var o = n[s],
            l = o + "RequestAnimationFrame";
        t.isNullOrUndefined(a) && l in window && (a = l), t.isNullOrUndefined(r) && ((l = o + "CancelAnimationFrame") in window && (r = l), (l = o + "CancelRequestAnimationFrame") in window && (r = l));
      }
  ...
  function () {
    var r = {};
    e.tab = e.tab || {}, e.tableauSoftware = e.tableauSoftware || {}, t.initAssembly(r, "vqlapishared");

    var s = function s() {};

    s.__typeName = "tab.$DeferredUtil", s.$coerceToTrustedPromise = function (e) {
      var i;
      if (e instanceof tableauSoftware.Promise) i = t.cast(e, _);else if (t.isValue(e) && "function" == typeof e.valueOf && (e = e.valueOf()), s.$isPromise(e)) {
        var n = new f();
        t.cast(e, _).then(t.mkdel(n, n.resolve), t.mkdel(n, n.reject)), i = n.get_promise();
      } else i = s.$resolved(e);
      return i;
    }, s.$reject = function (e) {
    ...
    l.__typeName = "tab._ApiCommand", l.generateNextCommandId = function () {
      ...
      var r,
          s = e.substr(a + 1);
      if ((a = s.indexOf(String.fromCharCode(44))) < 0) return new l(i, n = s, null, null);
      n = s.substr(0, a);
      var o = s.substr(a + 1);
      if ((a = o.indexOf(String.fromCharCode(44))) < 0) return new l(i, n, r = o, null);
      r = o.substr(0, a);
      var u = o.substr(a + 1);
      return l.lastResponseMessage = e, "api.GetClientInfoCommand" === i && (l.lastClientInfoResponseMessage = e), new l(i, n, r, u);
    }, e.tab._ApiCommand = l;

    var u = function u() {};

    u.__typeName = "tab._ApiObjectRegistry", u.registerApiMessageRouter = function (e) {
      ...
      return function () {
        ...
        if (t.isNullOrUndefined(n)) throw y.createInternalError("No creation function has been registered for interface type '" + i + "'.");
        return n();
      };
      ...
      return function () {
        var i = window._ApiObjectRegistryGlobalState.singletonInstanceRegistry,
            ...
            a = t.cast(i[n], e);
        return t.isNullOrUndefined(a) && (a = u.$createType(e).call(null), i[n] = a), a;
      };
    ...
    h.__typeName = "tab._ApiServerResultParser", e.tab._ApiServerResultParser = h;
    ...
    g.__typeName = "tab._jQueryShim", g.isFunction = function (e) {
      ...
      if (e = g.trim(e), t.isValue(JSON) && t.isValue(JSON.parse)) return JSON.parse(e);
      if (g.$rvalidchars.test(e.replace(g.$rvalidescape, "@").replace(g.$rvalidtokens, "]").replace(g.$rvalidbraces, ""))) return new Function("return " + e)();
      throw new t.Exception("Invalid JSON: " + e);
    }, e.tab._jQueryShim = g;

    var $ = function $() {};

    $.__typeName = "tab._Param", $.verifyString = function (e, i) {
    ...
    y.__typeName = "tab._TableauException", y.create = function (e, i) {
    ...
    w.__typeName = "tab._Utility", w.isNullOrEmpty = function (e) {
      ...
      if (i.append(e.tagName.toLowerCase()), w.isNullOrEmpty(e.id) || i.append("#").append(e.id), !w.isNullOrEmpty(e.className)) {
      ...
      for (var i = w.contentRectInDocumentCoordinates(e), n = e.parentElement; t.isValue(n) && t.isValue(n.parentElement); n = n.parentElement) {
        ...
        "auto" !== a && "scroll" !== a && "hidden" !== a || (i = i.intersect(w.contentRectInDocumentCoordinates(n)));
      }
      ...
      return t.isValue(i) ? new v(t.Int32.trunc(i.pageLeft), t.Int32.trunc(i.pageTop), t.Int32.trunc(i.width), t.Int32.trunc(i.height)) : null;
      ...
      return n.isQuirksMode() && (i.height = document.body.clientHeight - i.left, i.width = document.body.clientWidth - i.top), i.left += n.get_pageXOffset(), i.top += n.get_pageYOffset(), i;
      ...
      var i = "";
      t.isValue(e) && w.isDate(e) && (i = e.getUTCFullYear() + "-" + (e.getUTCMonth() + 1) + "-" + e.getUTCDate() + " " + e.getUTCHours() + ":" + e.getUTCMinutes() + ":" + e.getUTCSeconds());
      return i;
    ...
    b.__typeName = "tab.ApiDashboardObjectType", e.tab.ApiDashboardObjectType = b;
    ...
    I.__typeName = "tab.ApiEnumConverter", I.convertDashboardObjectType = function (e) {
      switch (e) {
        case "blank":
          return "blank";
    ...
    N.__typeName = "tab.ApiFieldAggregationType", e.tab.ApiFieldAggregationType = N;
    ...
    V.__typeName = "tab.ApiFilterUpdateType", e.tab.ApiFilterUpdateType = V;
    ...
    O.__typeName = "tab.ApiMessagingOptions", e.tab.ApiMessagingOptions = O;
    ...
    R.__typeName = "tab.ApiParameterAllowableValuesType", e.tab.ApiParameterAllowableValuesType = R;

    var D = function D() {};

    D.__typeName = "tab.ApiParameterDataType", e.tab.ApiParameterDataType = D;
    ...
    x.__typeName = "tab.ApiSelectionUpdateType", e.tab.ApiSelectionUpdateType = x;

    var P = function P() {};

    P.__typeName = "tab.ApiSheetSizeBehavior", e.tab.ApiSheetSizeBehavior = P;
    ...
    M.__typeName = "tab.ApiTableauEventName", e.tab.ApiTableauEventName = M;

    var H = function H() {};

    H.__typeName = "tab.ApiToolbarButtonName", e.tab.ApiToolbarButtonName = H;
    ...
    var j = function j(e) {
      ...
      return t.registerGenericClassInstance(i, j, [e], {
    ...
    j.__typeName = "tab.CommandReturnHandler$1", t.initGenericClass(j, r, 1), e.tab.CommandReturnHandler$1 = j;
    ...
    W.__typeName = "tab.CrossDomainMessager", e.tab.CrossDomainMessager = W;
    ...
    q.__typeName = "tab.DataValue", q.$ctor = function (e, t, i) {
      var n = new Object();
      return n.value = null, n.formattedValue = null, n.value = e, w.isNullOrEmpty(i) ? n.formattedValue = t : n.formattedValue = i, n;
    ...
    G.__typeName = "tab.FilterCommandsBuilder", e.tab.FilterCommandsBuilder = G;

    var Q = function Q() {};

    Q.__typeName = "tab.GetDataCommandsBuilder", e.tab.GetDataCommandsBuilder = Q;

    var J = function J() {
      this.$2$StateReadyForQueryField = null, k.call(this);
    };

    J.__typeName = "tab.HostedApiMessageHandler", e.tab.HostedApiMessageHandler = J;

    var K = function K() {
      this.$crossDomainMessager = null, this.$crossDomainMessager = new W(null);
    };

    K.__typeName = "tab.HostedApiMessageRouter", e.tab.HostedApiMessageRouter = K;

    var Y = function Y(e) {
      if (this.$clonedPairs = null, this.$collection = new a._Collection(), this.$tupleId = 0, g.isArray(e)) for (var i = e, n = 0; n < i.length; n++) {
        var r = i[n];
        if (!t.isValue(r.fieldName)) throw y.createInvalidParameter("pair.fieldName");
        if (!t.isValue(r.value)) throw y.createInvalidParameter("pair.value");
    ...
    Z.__typeName = "tab.Point", Z.$ctor = function (e, t) {
      var i = new Object();
    ...
    ee.__typeName = "tab.PublicEnums", ee.tryNormalizeEnum = function (e) {
      return function (i, n) {
      ...
      return function (t, i) {
        var n = {};
        if (!ee.tryNormalizeEnum(e).call(null, t, n)) throw y.createInvalidParameter(i);
        return n.$;
      };
    ...
    ie.__typeName = "tab.SheetSize", ie.$ctor = function (e, i, n) {
      var a = new Object();
      return a.behavior = null, a.minSize = null, a.maxSize = null, a.behavior = t.coalesce(e, "automatic"), t.isValue(i) ? a.minSize = i : delete a.minSize, t.isValue(n) ? a.maxSize = n : delete a.maxSize, a;
    ...
    ne.__typeName = "tab.SheetSizeFactory", ne.createAutomatic = function () {
      ...
      var t = e.minHeight,
          ...
          s = null,
          o = null;
      return 0 === t && 0 === i ? 0 === n && 0 === a || (r = "atmost", o = ae.$ctor(a, n)) : 0 === n && 0 === a ? (r = "atleast", s = ae.$ctor(i, t)) : n === t && a === i && i > 0 ? (r = "exactly", s = ae.$ctor(i, t), o = ae.$ctor(i, t)) : (r = "range", 0 === i && 0 === a && (a = 2147483647), s = ae.$ctor(i, t), o = ae.$ctor(a, n)), ie.$ctor(r, s, o);
    }, e.tab.SheetSizeFactory = ne;

    var ae = function ae() {};

    ae.__typeName = "tab.Size", ae.$ctor = function (e, t) {
      var i = new Object();
    ...
    se.__typeName = "tableauSoftware.DataTable", e.tableauSoftware.DataTable = se;
    ...
    ce.__typeName = "tableauSoftware.Pair", e.tableauSoftware.Pair = ce, t.initClass(s, r, {}), t.initClass(o, r, {
    ...
    }), t.initClass(u, r, {}), t.initClass(c, r, {
      ...
      $preResolutionThen: function $preResolutionThen(e, i) {
        var n = new f();
        return this.$listeners.push(function (a) {
      ...
      $transitionToFulfilled: function $transitionToFulfilled(e) {
        ...
        this.$thenFunc = t.then, this.$resolveFunc = s.$coerceToTrustedPromise;
    ...
    }), t.initClass(g, r, {}), t.initClass($, r, {}), t.initClass(_, r, {
      ...
      intersect: function intersect(e) {
        ...
        return n <= t || a <= i ? new v(0, 0, 0, 0) : new v(t, i, n - t, a - i);
      }
    }), t.initClass(y, r, {}), t.initClass(w, r, {}), t.initEnum(b, r, {
      blank: "blank",
      worksheet: "worksheet",
      ...
      tablet: "tablet",
      phone: "phone"
    }, !0), t.initClass(I, r, {}), t.initEnum(E, r, {
      ...
      registerHandler: function registerHandler(e) {
        ...
        if (t.isValue(e.get_hostId()) || t.isValue(this.$handlers[e.get_hostId()])) throw y.createInternalError("Host '" + e.get_hostId() + "' is already registered.");
      ...
      sendCommand: function sendCommand(e) {
        return function (e, i, n) {
          ...
          if (w.hasWindowPostMessage() && !t.isNullOrUndefined(a) && !t.isNullOrUndefined(a.contentWindow)) {
            var s = l.generateNextCommandId(),
                o = this.$commandCallbacks[r];
            t.isNullOrUndefined(o) && (o = {}, this.$commandCallbacks[r] = o), o[s] = n;
            var u = n.get_commandName(),
                c = null;
            t.isValue(i) && (c = JSON.stringify(i));
            var h = new l(u, s, r, c).serialize();
            w.isPostMessageSynchronous() ? window.setTimeout(function () {
      ...
      $handleStateReadyForQuery: function $handleStateReadyForQuery(e) {
        ...
        if (!w.isNullOrEmpty(i)) for (; i.length > 0;) {
          var n = i.pop();
          t.isValue(n) && n();
        }
      },
      $handleCrossDomainMessage: function $handleCrossDomainMessage(e) {
        ...
        if (!t.isNullOrUndefined(i.data)) {
          var a = l.parse(i.data.toString()),
              r = a.get_hostId(),
              s = this.$handlers[r];
          if (!t.isNullOrUndefined(s) && t.referenceEquals(s.get_hostId(), a.get_hostId()) || (s = this.$findHostIdByDomComparison(i)), a.get_isApiCommandName()) {
      ...
      $handleCrossDomainResponse: function $handleCrossDomainResponse(e) {
        ...
        if (!t.isNullOrUndefined(n) && (delete i[e.get_commandId()], e.get_name() === n.get_commandName())) {
          var a = new h(e.get_parameters()),
              r = a.get_data();
          if ("api.success" === a.get_result()) switch (n.get_successCallbackTiming()) {
            case 0:
            ...
            default:
              throw y.createInternalError("Unknown timing value: " + n.get_successCallbackTiming());
      ...
      date: "date",
      datetime: "datetime"
    }, !0), t.initClass(q, r, {}, Object), t.initClass(G, r, {
      buildApplyFiltersCommandParams: function buildApplyFiltersCommandParams(e, i, n, a) {
        if (w.isNullOrEmpty(e)) throw y.createNullOrEmptyParameter("fieldName");
        n = ee.normalizeEnum(V).call(null, n, "updateType");
        var r = [];
        if (g.isArray(i)) for (var s = 0; s < i.length; s++) {
          r.push(i[s].toString());
        } else t.isValue(i) && r.push(i.toString());
        var o = {};
        return o["api.fieldCaption"] = e, o["api.filterUpdateType"] = n, o["api.exclude"] = !(!t.isValue(a) || !a.isExcludeMode), "all" !== n && (o["api.filterCategoricalValues"] = r), o;
      },
      buildRangeFilterCommandParams: function buildRangeFilterCommandParams(e, i) {
        if (w.isNullOrEmpty(e)) throw y.createNullOrEmptyParameter("fieldName");
        if (t.isNullOrUndefined(i)) throw y.createNullOrEmptyParameter("filterOptions");
        var n = {};
        if (n["api.fieldCaption"] = e, t.isValue(i.min)) if (w.isDate(i.min)) {
          var a = t.cast(i.min, t.JsDate);
          if (!w.isDateValid(a)) throw y.createInvalidDateParameter("filterOptions.min");
          n["api.filterRangeMin"] = w.serializeDateForServer(a);
        } else n["api.filterRangeMin"] = i.min;
        if (t.isValue(i.max)) if (w.isDate(i.max)) {
          var r = t.cast(i.max, t.JsDate);
          if (!w.isDateValid(r)) throw y.createInvalidDateParameter("filterOptions.max");
      ...
      buildRelativeDateFilterCommandParams: function buildRelativeDateFilterCommandParams(e, i) {
        ...
        if (t.isNullOrUndefined(i)) throw y.createInvalidParameter("filterOptions");
        var n = {};
        ...
        if (n["api.fieldCaption"] = e, t.isValue(i)) {
          if (n["api.filterPeriodType"] = i.periodType, n["api.filterDateRangeType"] = i.rangeType, "lastn" === i.rangeType || "nextn" === i.rangeType) {
            if (t.isNullOrUndefined(i.rangeN)) throw y.create("missingRangeNForRelativeDateFilters", "Missing rangeN field for a relative date filter of LASTN or NEXTN.");
      ...
      buildHierarchicalFilterCommandParams: function buildHierarchicalFilterCommandParams(e, i, n, a) {
        ...
        if (g.isArray(i)) {
          ...
          var u = i.levels;
          if (s = [], g.isArray(u)) for (var c = u, h = 0; h < c.length; h++) {
            s.push(c[h].toString());
          } else s.push(u.toString());
        } else if (t.isValue(i)) throw y.createInvalidParameter("values");

        var m = {};
        return m["api.fieldCaption"] = e, m["api.filterUpdateType"] = n, m["api.exclude"] = !(!t.isValue(a) || !a.isExcludeMode), t.isValue(r) && (m["api.filterHierarchicalValues"] = JSON.stringify(r)), t.isValue(s) && (m["api.filterHierarchicalLevels"] = JSON.stringify(s)), m;
      },
      ...
      normalizeRangeFilterOption: function normalizeRangeFilterOption(e) {
        if (t.isNullOrUndefined(e)) throw y.createNullOrEmptyParameter("filterOptions");
        if (t.isNullOrUndefined(e.min) && t.isNullOrUndefined(e.max)) throw y.create("invalidParameter", "At least one of filterOptions.min or filterOptions.max must be specified.");
        var i = new Object();
        return t.isValue(e.min) && (i.min = e.min), t.isValue(e.max) && (i.max = e.max), t.isValue(e.nullOption) && (i.nullOption = ee.normalizeEnum(F).call(null, e.nullOption, "filterOptions.nullOption")), i;
      },
      normalizeRelativeDateFilterOptions: function normalizeRelativeDateFilterOptions(e) {
        if (t.isNullOrUndefined(e)) throw y.createNullOrEmptyParameter("filterOptions");
        var i = new Object();

        if (i.rangeType = ee.normalizeEnum(S).call(null, e.rangeType, "filterOptions.rangeType"), i.periodType = ee.normalizeEnum(z).call(null, e.periodType, "filterOptions.periodType"), "lastn" === i.rangeType || "nextn" === i.rangeType) {
          if (t.isNullOrUndefined(e.rangeN)) throw y.create("missingRangeNForRelativeDateFilters", "Missing rangeN field for a relative date filter of LASTN or NEXTN.");
          i.rangeN = w.toInt(e.rangeN);
        }

        if (t.isValue(e.anchorDate)) {
          if (!w.isDate(e.anchorDate) || !w.isDateValid(e.anchorDate)) throw y.createInvalidDateParameter("filterOptions.anchorDate");
      ...
      $processUnderlyingColumns: function $processUnderlyingColumns(e) {
        for (var t = [], i = 0; i < e.length; i++) {
          var n = e[i],
              a = new d(n.fieldName, I.convertDataType(n.dataType), n.isReferenced, n.index);
          t.push(new re(a));
        }
    ...
    }), t.initClass(Z, r, {}, Object), t.initClass(ee, r, {}), t.initClass(te, r, {
      addVisualIdForWorksheet: function addVisualIdForWorksheet(e, i, n) {
        e["api.worksheetName"] = i, t.isValue(n) && (e["api.dashboardName"] = n);
      }
    }), t.initClass(ie, r, {}, Object), t.initClass(ne, r, {}), t.initClass(ae, r, {}, Object), t.initClass(re, r, {
  ...
  function () {
    var i = {};
    e.tab = e.tab || {}, e.tableauSoftware = e.tableauSoftware || {}, t.initAssembly(i, "Tableau.JavaScript.Vql.Api");
    ...
    r.__typeName = "tab.$DashboardZoneInfo", r.isInstanceOfType = function () {
      return !0;
    };
    ...
    h.__typeName = "tab._ApiBootstrap", h.initialize = function () {
    ...
    m.__typeName = "tab._CustomViewImpl", m._getAsync = function (e) {
      ...
      return r.$isPublic = n.isPublic, r.$url = n.url, r.$ownerName = n.owner.friendlyName, r.$isDefault = t.isValue(a) && t.unbox(a) === n.id, r.$presModel = n, r;
    }, m._saveNewAsync = function (e, i, n) {
      var r = new a._Deferred(),
          s = {};
      s["api.customViewName"] = n;
      var o = m.$createCustomViewCommandReturnHandler("api.SaveNewCustomViewCommand", r, function (n) {
        m._processCustomViewUpdate(e, i, n, !0);

        var a = null;
        t.isValue(e.get_$updatedCustomViews()) && (a = e.get_$updatedCustomViews().get_item(0)), r.resolve(a);
      });
      ...
      var o = m.$createCustomViewCommandReturnHandler("api.ShowCustomViewCommand", r, function (t) {
      ...
      var s = null,
          o = null;
      t.isValue(n.currentView) && (s = n.currentView.name, o = n.currentView.owner.friendlyName);
    ...
    f.__typeName = "tab._SheetImpl", f.$convertValueToIntIfValid = function (e) {
      ...
      var i = a.PublicEnums.normalizeEnum(a.ApiSheetSizeBehavior).call(null, e.behavior, "size.behavior"),
          n = e.minSize;
      t.isValue(n) && (n = a.Size.$ctor(f.$convertValueToIntIfValid(e.minSize.width), f.$convertValueToIntIfValid(e.minSize.height)));
      var r = e.maxSize;
      return t.isValue(r) && (r = a.Size.$ctor(f.$convertValueToIntIfValid(e.maxSize.width), f.$convertValueToIntIfValid(e.maxSize.height))), a.SheetSize.$ctor(i, n, r);
    }, e.tab._SheetImpl = f;

    var g = function g() {};

    g.__typeName = "tab._SheetInfoImpl", g.$ctor = function (e, t, i, n, a, r, s, o, l) {
      var u = new Object();
      return u.name = null, u.index = 0, u.workbook = null, u.url = null, u.isHidden = !1, u.sheetType = null, u.zoneId = 0, u.size = null, u.isActive = !1, u.name = e, u.sheetType = t, u.index = i, u.size = n, u.workbook = a, u.url = r, u.isActive = s, u.isHidden = o, u.zoneId = l, u;
    ...
    v.__typeName = "tab._StoryPointInfoImpl", v.$ctor = function (e, t, i, n, a, r) {
      var s = new Object();
      return s.storyPointId = 0, s.parentStoryImpl = null, s.caption = null, s.index = 0, s.isActive = !1, s.isUpdated = !1, s.caption = e, s.index = t, s.storyPointId = i, s.isActive = n, s.isUpdated = a, s.parentStoryImpl = r, s;
    ...
    w.__typeName = "tab._VizManagerImpl", w.get_$clonedVizs = function () {
      ...
      for (var i = e.getParentElement(), n = 0, r = w.$vizs.length; n < r; n++) {
        if (t.referenceEquals(w.$vizs[n].getParentElement(), i)) {
          var s = "Another viz is already present in element '" + a._Utility.elementToString(i) + "'.";
    ...
    var b = function b(e, i, n) {
      ...
      if (t.isNullOrUndefined(s) || -1 === s[0].toLowerCase().indexOf("http://") && -1 === s[0].toLowerCase().indexOf("https://")) throw a._TableauException.create("invalidUrl", "Invalid url");
      ...
      if (t.isValue(i) && t.isValue(i.errorCode)) {
        ...
        switch (i.errorCode) {
          case "invalidSelectionFieldName":
            return a._TableauException.create("invalidSelectionFieldName", n);
    ...
    A.__typeName = "tab.FirstVizSizeKnownEvent", e.tab.FirstVizSizeKnownEvent = A;
    ...
    V.__typeName = "tab.IJsApiMessageHandler", e.tab.IJsApiMessageHandler = V;
    ...
    O.__typeName = "tab.JsApiMessagingOptions", e.tab.JsApiMessagingOptions = O;
    ...
    L.__typeName = "tab.VizSize", L.$ctor = function (e, t) {
      var i = new Object();
    ...
    W.__typeName = "tableauSoftware.CategoricalFilter", e.tableauSoftware.CategoricalFilter = W;

    var B = function B(e) {
      this._impl = null, this._impl = e;
    };

    B.__typeName = "tableauSoftware.CustomView", e.tableauSoftware.CustomView = B;

    var q = function q(e) {
      this._impl = null, te.call(this, e);
    };

    q.__typeName = "tableauSoftware.Dashboard", e.tableauSoftware.Dashboard = q;

    var G = function G(e, i, n) {
      if (this.$zoneInfo = null, this.$dashboard = null, this.$worksheet = null, "worksheet" === e.objectType && t.isNullOrUndefined(n)) throw a._TableauException.createInternalError("worksheet parameter is required for WORKSHEET objects");
      if ("worksheet" !== e.objectType && t.isValue(n)) throw a._TableauException.createInternalError("worksheet parameter should be undefined for non-WORKSHEET objects");
      this.$zoneInfo = e, this.$dashboard = i, this.$worksheet = n;
    };

    G.__typeName = "tableauSoftware.DashboardObject", e.tableauSoftware.DashboardObject = G;

    var Q = function Q(e) {
      this.$impl = null, this.$impl = e;
    };

    Q.__typeName = "tableauSoftware.DataSource", e.tableauSoftware.DataSource = Q;
    ...
    Y.__typeName = "tableauSoftware.HierarchicalFilter", e.tableauSoftware.HierarchicalFilter = Y;

    var X = function X(e) {
      this._impl = null, this._impl = e;
    };

    X.__typeName = "tableauSoftware.Parameter", e.tableauSoftware.Parameter = X;
    ...
    Z.__typeName = "tableauSoftware.QuantitativeFilter", e.tableauSoftware.QuantitativeFilter = Z;

    var ee = function ee(e, t) {
      this.$periodType = null, this.$rangeType = null, this.$rangeN = 0, K.call(this, e, t), this.$initializeFromJson$1(t);
    };

    ee.__typeName = "tableauSoftware.RelativeDateFilter", e.tableauSoftware.RelativeDateFilter = ee;
    ...
    ie.__typeName = "tableauSoftware.SheetInfo", e.tableauSoftware.SheetInfo = ie;
    ...
    ae.__typeName = "tableauSoftware.StoryPoint", e.tableauSoftware.StoryPoint = ae;

    var re = function re(e) {
      this._impl = null, this._impl = e;
    };

    re.__typeName = "tableauSoftware.StoryPointInfo", e.tableauSoftware.StoryPointInfo = re;

    var se = function se(e) {
      this._impl = null, this._impl = e;
    };

    se.__typeName = "tableauSoftware.ToolbarState", e.tableauSoftware.ToolbarState = se;

    var oe = function oe(e, i, n, a) {
    ...
    ue.__typeName = "tableauSoftware.VizManager", ue.getVizs = function () {
    ...
    ce.__typeName = "tableauSoftware.Workbook", e.tableauSoftware.Workbook = ce;

    var he = function he(e) {
      this._impl = null, te.call(this, e);
    };

    he.__typeName = "tableauSoftware.Worksheet", e.tableauSoftware.Worksheet = he, t.initClass(E, i, {
    ...
    }, E), t.initClass(r, i, {}), t.initClass(s, i, {
    ...
    }, E), t.initClass(o, i, {}, E), t.initClass(l, i, {}, E), t.initClass(u, i, {
    ...
    }), t.initClass(h, i, {}), t.initClass(m, i, {
      ...
      set_$name: function set_$name(e) {
        if (this.$isStale) throw a._TableauException.create("staleDataReference", "Stale data");
        this.$name = e;
      },
      ...
      $saveAsync: function $saveAsync() {
        if (this.$isStale || t.isNullOrUndefined(this.$presModel)) throw a._TableauException.create("staleDataReference", "Stale data");
        ...
        var n = m.$createCustomViewCommandReturnHandler("api.UpdateCustomViewCommand", e, t.mkdel(this, function (t) {
      ...
      $removeAsync: function $removeAsync() {
        var e = new a._Deferred(),
            i = {};
        i["api.customViewParam"] = this.$presModel;
        var n = m.$createCustomViewCommandReturnHandler("api.RemoveCustomViewCommand", e, t.mkdel(this, function (t) {
      ...
      _showAsync: function _showAsync() {
        if (this.$isStale || t.isNullOrUndefined(this.$presModel)) throw a._TableauException.create("staleDataReference", "Stale data");
        return m._showCustomViewAsync(this.$workbookImpl, this.$messagingOptions, this.$presModel);
      }
    }), t.initClass(f, i, {
      get_sheet: null,
      get_name: function get_name() {
      ...
      get_url: function get_url() {
        if (this.$isHidden) throw a._TableauException.createNoUrlForHiddenWorksheet();
        return this.$url;
      },
      ...
      set_parentStoryPointImpl: function set_parentStoryPointImpl(e) {
        if ("story" === this.$sheetType) throw a._TableauException.createInternalError("A story cannot be a child of another story.");
      ...
      changeSizeAsync: function changeSizeAsync(e) {
        if (e = f.$normalizeSheetSize(e), "worksheet" === this.$sheetType && "automatic" !== e.behavior) throw a._TableauException.createInvalidSizeBehaviorOnWorksheet();
        var i = new a._Deferred();
        if (this.$size.behavior === e.behavior && "automatic" === e.behavior) return i.resolve(e), i.get_promise();
        var n = this.$processSheetSize(e),
            r = {};
        r["api.setSheetSizeName"] = this.$name, r["api.minWidth"] = n["api.minWidth"], r["api.minHeight"] = n["api.minHeight"], r["api.maxWidth"] = n["api.maxWidth"], r["api.maxHeight"] = n["api.maxHeight"];
        var s = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.SetSheetSizeCommand", 0, t.mkdel(this, function (e) {
      ...
      $processSheetSize: function $processSheetSize(e) {
        var i = null;
        if (t.isNullOrUndefined(e) || t.isNullOrUndefined(e.behavior) || "automatic" !== e.behavior && t.isNullOrUndefined(e.minSize) && t.isNullOrUndefined(e.maxSize)) throw a._TableauException.createInvalidSheetSizeParam();
        var n = 0,
            r = 0,
            s = 0,
            o = 0,
        ...
        if ("automatic" === e.behavior) i = a.SheetSize.$ctor("automatic", void 0, void 0);else if ("atmost" === e.behavior) {
          if (t.isNullOrUndefined(e.maxSize) || t.isNullOrUndefined(e.maxSize.width) || t.isNullOrUndefined(e.maxSize.height)) throw a._TableauException.createMissingMaxSize();
          if (e.maxSize.width < 0 || e.maxSize.height < 0) throw a._TableauException.createInvalidSizeValue();
          l["api.maxWidth"] = e.maxSize.width, l["api.maxHeight"] = e.maxSize.height, i = a.SheetSize.$ctor("atmost", void 0, e.maxSize);
        } else if ("atleast" === e.behavior) {
          if (t.isNullOrUndefined(e.minSize) || t.isNullOrUndefined(e.minSize.width) || t.isNullOrUndefined(e.minSize.height)) throw a._TableauException.createMissingMinSize();
          if (e.minSize.width < 0 || e.minSize.height < 0) throw a._TableauException.createInvalidSizeValue();
          l["api.minWidth"] = e.minSize.width, l["api.minHeight"] = e.minSize.height, i = a.SheetSize.$ctor("atleast", e.minSize, void 0);
        } else if ("range" === e.behavior) {
          if (t.isNullOrUndefined(e.minSize) || t.isNullOrUndefined(e.maxSize) || t.isNullOrUndefined(e.minSize.width) || t.isNullOrUndefined(e.maxSize.width) || t.isNullOrUndefined(e.minSize.height) || t.isNullOrUndefined(e.maxSize.height)) throw a._TableauException.createMissingMinMaxSize();
          if (e.minSize.width < 0 || e.minSize.height < 0 || e.maxSize.width < 0 || e.maxSize.height < 0 || e.minSize.width > e.maxSize.width || e.minSize.height > e.maxSize.height) throw a._TableauException.createInvalidRangeSize();
          l["api.minWidth"] = e.minSize.width, l["api.minHeight"] = e.minSize.height, l["api.maxWidth"] = e.maxSize.width, l["api.maxHeight"] = e.maxSize.height, i = a.SheetSize.$ctor("range", e.minSize, e.maxSize);
          ...
          } else t.isValue(e.minSize) && t.isValue(e.minSize.width) && t.isValue(e.minSize.height) ? (s = n = e.minSize.width, o = r = e.minSize.height) : t.isValue(e.maxSize) && t.isValue(e.maxSize.width) && t.isValue(e.maxSize.height) && (n = s = e.maxSize.width, r = o = e.maxSize.height);

          l["api.minWidth"] = n, l["api.minHeight"] = r, l["api.maxWidth"] = s, l["api.maxHeight"] = o, i = a.SheetSize.$ctor("exactly", a.Size.$ctor(n, r), a.Size.$ctor(s, o));
        }
      ...
      $addObjects: function $addObjects(e, i) {
        this.$dashboardObjects = new a._Collection(), this.$worksheets = new a._Collection();
        ...
        for (var n = 0; n < e.length; n++) {
          ...
          if ("worksheet" === e[n].objectType) {
            ...
            var l = this.$worksheets.get__length(),
                ...
                p = new C(d, this.get_workbookImpl(), this.get_messagingOptions(), this);
    ...
    }), t.initClass(g, i, {}, Object), t.initClass($, i, {
      ...
      update: function update(e) {
        ...
        for (var a = 0; a < e.storyPoints.length; a++) {
          ...
          if (t.isNullOrUndefined(this.$storyPointsInfo[a])) this.$storyPointsInfo[a] = new re(l);else if (this.$storyPointsInfo[a]._impl.storyPointId === l.storyPointId) {
        ...
        if (h) {
          var d = _.createContainedSheet(i, this.get_workbookImpl(), this.get_messagingOptions(), this.$findSheetFunc);
      ...
      activateStoryPointAsync: function activateStoryPointAsync(e) {
        var i = new a._Deferred();
        if (e < 0 || e >= this.$storyPointsInfo.length) throw a._TableauException.createIndexOutOfRange(e);
        var n = {};
        n["api.storyPointIndex"] = e;
        var r = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.ActivateStoryPoint", 0, t.mkdel(this, function (e) {
      ...
      revertStoryPointAsync: function revertStoryPointAsync(e) {
        if ((e = e || this.$activeStoryPointImpl.get_index()) < 0 || e >= this.$storyPointsInfo.length) throw a._TableauException.createIndexOutOfRange(e);
        var i = new a._Deferred(),
            n = {};
        n["api.storyPointIndex"] = e;
        var r = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.RevertStoryPoint", 0, t.mkdel(this, function (t) {
      ...
      $activatePreviousNextStoryPointAsync: function $activatePreviousNextStoryPointAsync(e) {
        if ("api.ActivatePreviousStoryPoint" !== e && "api.ActivateNextStoryPoint" !== e) throw a._TableauException.createInternalError("commandName '" + e + "' is invalid.");
        var i = new a._Deferred(),
      ...
      $updateStoryPointInfo: function $updateStoryPointInfo(e, t) {
        ...
        if (i.storyPointId !== t.storyPointId) throw a._TableauException.createInternalError("We should not be updating a story point where the IDs don't match. Existing storyPointID=" + i.storyPointId + ", newStoryPointID=" + t.storyPointId);
      ...
      $updateActiveState: function $updateActiveState(e) {
        ...
        if (t.get_index() !== i) {
          var n = this.$storyPointsInfo[t.get_index()],
              ...
              r = _.createContainedSheet(e.containedSheetInfo, this.get_workbookImpl(), this.get_messagingOptions(), this.$findSheetFunc);

          a.isActive = !0, this.$activeStoryPointImpl = new _(a, r), t.set_isActive(!1), n._impl.isActive = !1, this.$raiseActiveStoryPointChange(n, this.$activeStoryPointImpl.get_storyPoint());
        }
      },
    ...
    }), t.initClass(v, i, {}, Object), t.initClass(y, i, {
    ...
    }), t.initClass(w, i, {}), t.initClass(b, i, {
      get_url: function get_url() {
      ...
      $constructUrl: function $constructUrl() {
        ...
        try {
          for (; n.moveNext();) {
            var a = n.current();
            "embed" !== a.key && "height" !== a.key && "width" !== a.key && "device" !== a.key && "autoSize" !== a.key && "hideTabs" !== a.key && "hideToolbar" !== a.key && "onFirstInteractive" !== a.key && "onFirstVizSizeKnown" !== a.key && "toolbarPosition" !== a.key && "instanceIdToClone" !== a.key && "navType" !== a.key && "display_static_image" !== a.key && (e.push("&"), e.push(encodeURIComponent(a.key)), e.push("="), e.push(encodeURIComponent(a.value.toString())));
          }
        } finally {
          n.dispose();
        }
      ...
      _setActiveSheetAsync: function _setActiveSheetAsync(e) {
        ...
        if (this.$activeSheetImpl.get_isDashboard()) {
          ...
          if (t.isValue(s)) {
            ...
            var o = "";
            return s.getIsHidden() ? this.$activatingHiddenSheetImpl = s._impl : o = s._impl.get_url(), this.$activateSheetInternalAsync(s._impl.get_name(), o);
          }
        }
      ...
      $activateSheetInternalAsync: function $activateSheetInternalAsync(e, i) {
        ...
        var r = {};
        r["api.switchToSheetName"] = e, r["api.switchToRepositoryUrl"] = i, r["api.oldRepositoryUrl"] = this.$activeSheetImpl.get_url();
        var s = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.SwitchActiveSheetCommand", 0, t.mkdel(this, function (e) {
      ...
      _updateActiveSheetAsync: function _updateActiveSheetAsync() {
        ...
        var n = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.UpdateActiveSheetCommand", 0, t.mkdel(this, function (t) {
      ...
      $initializeActiveSheet: function $initializeActiveSheet(e) {
        ...
        if (t.isNullOrUndefined(n) && t.isNullOrUndefined(this.$activatingHiddenSheetImpl)) throw a._TableauException.createInternalError("The active sheet was not specified in baseSheets");
        ...
        if (!t.isValue(this.$activeSheetImpl) || !t.referenceEquals(this.$activeSheetImpl.get_name(), i)) {
          if (t.isValue(this.$activeSheetImpl)) {
            ...
            if (t.isValue(r) && (r.$impl.isActive = !1), "story" === this.$activeSheetImpl.get_sheetType()) t.cast(this.$activeSheetImpl, $).remove_activeStoryPointChange(t.mkdel(this.$vizImpl, this.$vizImpl.raiseStoryPointSwitch));
          }

          if (t.isValue(this.$activatingHiddenSheetImpl)) {
            var s = g.$ctor(this.$activatingHiddenSheetImpl.get_name(), "worksheet", -1, this.$activatingHiddenSheetImpl.get_size(), this.get_workbook(), "", !0, !0, f.noZoneId);
            this.$activatingHiddenSheetImpl = null, this.$activeSheetImpl = new C(s, this, this.$messagingOptions, null);
          } else {
            ...
            if (t.isNullOrUndefined(o)) throw a._TableauException.createInternalError("No base sheet was found corresponding to the active sheet.");
            ...
            if ("dashboard" === o.sheetType) {
              ...
              var p = new $(n.$impl, this, this.$messagingOptions, e.story, c);
              this.$activeSheetImpl = p, p.add_activeStoryPointChange(t.mkdel(this.$vizImpl, this.$vizImpl.raiseStoryPointSwitch));
            } else this.$activeSheetImpl = new C(n.$impl, this, this.$messagingOptions, null);
        ...
        if (!t.isNullOrUndefined(i)) for (var n = 0; n < i.length; n++) {
          ...
          if (t.isNullOrUndefined(o)) {
            var u = t.referenceEquals(s, e.currentSheetName),
                ...
                h = g.$ctor(s, c, n, l, this.get_workbook(), r.repositoryUrl, u, !1, f.noZoneId);
      ...
      $showCustomViewAsync: function $showCustomViewAsync(e) {
        if (t.isNullOrUndefined(e) || a._Utility.isNullOrEmpty(e)) return m._showCustomViewAsync(this, this.$messagingOptions, null);

        var i = this.$customViews._get(e);

        if (t.isNullOrUndefined(i)) {
          var n = new a._Deferred();
          return n.reject(a._TableauException.createInvalidCustomViewName(e)), n.get_promise();
        }

        return i._impl._showAsync();
      },
      $removeCustomViewAsync: function $removeCustomViewAsync(e) {
        if (a._Utility.isNullOrEmpty(e)) throw a._TableauException.createNullOrEmptyParameter("customViewName");
      ...
      $rememberCustomViewAsync: function $rememberCustomViewAsync(e) {
        if (a._Utility.isNullOrEmpty(e)) throw a._TableauException.createInvalidParameter("customViewName");
      ...
      $getSingleParameterAsync: function $getSingleParameterAsync(e) {
        ...
        var n = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.FetchParametersCommand", 0, t.mkdel(this, function (t) {
      ...
      $changeParameterValueAsync: function $changeParameterValueAsync(e, i) {
        ...
        if (t.isValue(this.$parameters)) {
          if (t.isNullOrUndefined(this.$parameters._get(e))) return n.reject(a._TableauException.createInvalidParameter(e)), n.get_promise();
          if (r = this.$parameters._get(e)._impl, t.isNullOrUndefined(r)) return n.reject(a._TableauException.createInvalidParameter(e)), n.get_promise();
        }

        var s = {};

        if (s["api.setParameterName"] = t.isValue(this.$parameters) ? r.get_$name() : e, t.isValue(i) && a._Utility.isDate(i)) {
        ...
        var u = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.SetParameterValueCommand", 0, t.mkdel(this, function (i) {
      ...
      $getDataSourcesAsync: function $getDataSourcesAsync() {
        ...
        var n = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.GetDataSourcesCommand", 0, function (t) {
      ...
      $getDataSourceAsync: function $getDataSourceAsync(e) {
        ...
        var r = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.GetDataSourceCommand", 0, function (n) {
          var r = p.processDataSource(n);
          t.isValue(r) ? i.resolve(r.get_dataSource()) : i.reject(a._TableauException.createServerError("Data source '" + e + "' not found"));
        }, function (e, t) {
          i.reject(a._TableauException.createServerError(t));
        });
        return this.sendCommand(Object).call(this, n, r), i.get_promise();
      ...
      $verifyActiveSheetOrEmbeddedInActiveDashboard: function $verifyActiveSheetOrEmbeddedInActiveDashboard() {
        ...
        if (!e && !i && !n) throw a._TableauException.createNotActiveSheet();
      },
      ...
      $getFilterAsync: function $getFilterAsync(e, i, n) {
        if (!a._Utility.isNullOrEmpty(e) && !a._Utility.isNullOrEmpty(i)) throw a._TableauException.createInternalError("Only fieldName OR fieldCaption is allowed, not both.");
        n = n || new Object();
        var r = new a._Deferred(),
            s = {};
        this.$addVisualIdToCommand(s), !a._Utility.isNullOrEmpty(i) && a._Utility.isNullOrEmpty(e) && (s["api.fieldCaption"] = i), a._Utility.isNullOrEmpty(e) || (s["api.fieldName"] = e), s["api.filterHierarchicalLevels"] = 0, s["api.ignoreDomain"] = n.ignoreDomain || !1;
        var o = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.GetOneFilterInfoCommand", 0, t.mkdel(this, function (e) {
      ...
      $getFiltersAsync: function $getFiltersAsync(e) {
        ...
        var r = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.GetFiltersListCommand", 0, t.mkdel(this, function (e) {
      ...
      $applyHierarchicalFilterAsync: function $applyHierarchicalFilterAsync(e, i, n, r) {
        if (t.isNullOrUndefined(i) && "all" !== n) throw a._TableauException.createInvalidParameter("values");
        return this.$applyHierarchicalFilterInternalAsync(e, i, n, r);
      },
      $clearFilterInternalAsync: function $clearFilterInternalAsync(e) {
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
        var t = new a._Deferred(),
            i = this.$filterCommandsBuilder.buildClearFilterCommandsParam(e);
        this.$addVisualIdToCommand(i);
        var n = this.$filterCommandsBuilder.createFilterCommandReturnHandler("api.ClearFilterCommand", e, t);
      ...
      $applyFilterWithValuesInternalAsync: function $applyFilterWithValuesInternalAsync(e, t, i, n) {
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
        var r = new a._Deferred(),
            s = this.$filterCommandsBuilder.buildApplyFiltersCommandParams(e, t, i, n);
        this.$addVisualIdToCommand(s);
        var o = this.$filterCommandsBuilder.createFilterCommandReturnHandler("api.ApplyCategoricalFilterCommand", e, r);
        return this.sendCommand(Object).call(this, s, o), r.get_promise();
      },
      $applyRangeFilterInternalAsync: function $applyRangeFilterInternalAsync(e, t) {
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
        var i = this.$filterCommandsBuilder.buildRangeFilterCommandParams(e, t);
        this.$addVisualIdToCommand(i);
        var n = new a._Deferred(),
            r = this.$filterCommandsBuilder.createFilterCommandReturnHandler("api.ApplyRangeFilterCommand", e, n);
      ...
      $applyRelativeDateFilterInternalAsync: function $applyRelativeDateFilterInternalAsync(e, t) {
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
        var i = this.$filterCommandsBuilder.buildRelativeDateFilterCommandParams(e, t);
        this.$addVisualIdToCommand(i);
        var n = new a._Deferred(),
            r = this.$filterCommandsBuilder.createFilterCommandReturnHandler("api.ApplyRelativeDateFilterCommand", e, n);
        return this.sendCommand(Object).call(this, i, r), n.get_promise();
      },
      $applyHierarchicalFilterInternalAsync: function $applyHierarchicalFilterInternalAsync(e, t, i, n) {
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
        var r = this.$filterCommandsBuilder.buildHierarchicalFilterCommandParams(e, t, i, n);
      ...
      $clearSelectedMarksAsync: function $clearSelectedMarksAsync() {
        ...
        var e = new a._Deferred(),
            i = {};
        this.$addVisualIdToCommand(i);
        var n = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.ClearSelectedMarksCommand", 0, function (t) {
          e.resolve();
        }, function (t, i) {
          e.reject(a._TableauException.createServerError(i));
        });
      ...
      $getSelectedMarksAsync: function $getSelectedMarksAsync() {
        ...
        var e = new a._Deferred(),
            i = {};
        this.$addVisualIdToCommand(i);
        var n = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.FetchSelectedMarksCommand", 0, t.mkdel(this, function (t) {
      ...
      $selectMarksWithFieldNameAndValueAsync: function $selectMarksWithFieldNameAndValueAsync(e, t, i) {
        var n = [],
            ...
            o = [],
            l = [];
        return this.$parseMarksParam(n, a, r, s, o, l, e, t), this.$selectMarksWithValuesAsync(null, n, a, r, s, o, l, i);
      },
      $selectMarksWithMultiDimOptionAsync: function $selectMarksWithMultiDimOptionAsync(e, i) {
        ...
        try {
          for (; h.moveNext();) {
            var m = h.current();
            e.hasOwnProperty(m.key) && (a._jQueryShim.isFunction(n[m.key]) || this.$parseMarksParam(r, s, o, l, u, c, m.key, m.value));
          }
        } finally {
          h.dispose();
        }
      ...
      $selectMarksWithMarksArrayAsync: function $selectMarksWithMarksArrayAsync(e, i) {
        for (var n = [], r = [], s = [], o = [], l = [], u = [], c = [], h = 0; h < e.length; h++) {
          ...
          if (t.isValue(m.impl.get_tupleId()) && m.impl.get_tupleId() > 0) c.push(m.impl.get_tupleId());else for (var d = m.impl.get_pairs(), p = 0; p < d.get__length(); p++) {
            var f = d.get_item(p);
            f.hasOwnProperty("fieldName") && f.hasOwnProperty("value") && !a._jQueryShim.isFunction(f.fieldName) && !a._jQueryShim.isFunction(f.value) && this.$parseMarksParam(n, r, s, o, l, u, f.fieldName, f.value);
          }
        }
      ...
      $parseMarksParam: function $parseMarksParam(e, i, n, r, s, o, l, u) {
        var c = u;
        if (C.$regexHierarchicalFieldName.test(l)) this.$addToParamLists(n, r, l, u);else if (t.isValue(c.min) || t.isValue(c.max)) {
          var h = new Object();
          if (t.isValue(c.min)) if (a._Utility.isDate(c.min)) {
            var m = t.cast(c.min, t.JsDate);
            if (!a._Utility.isDateValid(m)) throw a._TableauException.createInvalidDateParameter("options.min");
            h.min = a._Utility.serializeDateForServer(m);
          } else h.min = c.min;
          if (t.isValue(c.max)) if (a._Utility.isDate(c.max)) {
            var d = t.cast(c.max, t.JsDate);
            if (!a._Utility.isDateValid(d)) throw a._TableauException.createInvalidDateParameter("options.max");
            h.max = a._Utility.serializeDateForServer(d);
          } else h.max = c.max;

          if (t.isValue(c.nullOption)) {
            var p = a.PublicEnums.normalizeEnum(a.ApiNullOption).call(null, c.nullOption, "options.nullOption");
            h.nullOption = p;
      ...
      $addToParamLists: function $addToParamLists(e, i, n, r) {
        var s = [];
        if (a._jQueryShim.isArray(r)) for (var o = t.cast(r, Array), l = 0; l < o.length; l++) {
          s.push(o[l].toString());
      ...
      $selectMarksWithValuesAsync: function $selectMarksWithValuesAsync(e, i, n, r, s, o, l, u) {
        ...
        if (this.$addVisualIdToCommand(c), u = a.PublicEnums.normalizeEnum(a.ApiSelectionUpdateType).call(null, u, "updateType"), c["api.filterUpdateType"] = u, a._Utility.isNullOrEmpty(e) || (c["api.tupleIds"] = JSON.stringify(e)), !a._Utility.isNullOrEmpty(i) && !a._Utility.isNullOrEmpty(n)) {
        ...
        if (a._Utility.isNullOrEmpty(c["api.tupleIds"]) && a._Utility.isNullOrEmpty(c["api.categoricalFieldCaption"]) && a._Utility.isNullOrEmpty(c["api.hierarchicalFieldCaption"]) && a._Utility.isNullOrEmpty(c["api.rangeFieldCaption"])) throw a._TableauException.createInvalidParameter("fieldNameOrFieldValuesMap");
      ...
      $getSummaryDataAsync: function $getSummaryDataAsync(e) {
        ...
        this.$addVisualIdToCommand(i);
        var n = this.$getDataCommandsBuilder.getSummaryDataResponseHandler(t);
        return this.sendCommand(Object).call(this, i, n), t.get_promise();
      },
      $getUnderlyingDataAsync: function $getUnderlyingDataAsync(e) {
        this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
        var t = new a._Deferred(),
            i = this.$getDataCommandsBuilder.getUnderlyingDataCommandParams(e);
        this.$addVisualIdToCommand(i);
        var n = this.$getDataCommandsBuilder.getUnderlyingDataResponseHandler(t);
        return this.sendCommand(Object).call(this, i, n), t.get_promise();
      },
      $clearHighlightedMarksAsync: function $clearHighlightedMarksAsync() {
        ...
        var e = new a._Deferred(),
            i = {};
        this.$addVisualIdToCommand(i);
        var n = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.ClearHighlightedMarksCommand", 0, function (t) {
          e.resolve();
        }, function (t, i) {
          e.reject(a._TableauException.createServerError(i));
        });
      ...
      $highlightMarksAsync: function $highlightMarksAsync(e, i) {
        a._Param.verifyString(e, "fieldName"), this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
        var n = new a._Deferred(),
            r = {};
        r["api.fieldCaption"] = e, r["api.ObjectTextIDs"] = i, this.$addVisualIdToCommand(r);
        var s = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.HighlightMarksCommand", 0, function (e) {
          n.resolve();
        }, function (e, t) {
          n.reject(a._TableauException.createServerError(t));
        });
      ...
      $highlightMarksByPatternMatchAsync: function $highlightMarksByPatternMatchAsync(e, i) {
        a._Param.verifyString(e, "fieldName"), a._Param.verifyString(i, "patternMatch"), this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
        var n = new a._Deferred(),
            r = {
          "api.filterUpdateType": "replace"
        };
        r["api.fieldCaption"] = e, r["api.Pattern"] = i, this.$addVisualIdToCommand(r);
        var s = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.HighlightMarksByPatternMatch", 0, function (e) {
          n.resolve();
        }, function (e, t) {
          n.reject(a._TableauException.createServerError(t));
        });
      ...
      $getHighlightedMarksAsync: function $getHighlightedMarksAsync() {
        ...
        var e = new a._Deferred(),
            i = {};
        this.$addVisualIdToCommand(i);
        var n = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.FetchHighlightedMarksCommand", 0, t.mkdel(this, function (t) {
      ...
      sendCommand: function sendCommand(e) {
        return function (i, n, a) {
          if (this.$crossDomainMessager.sendCommand(e).call(this.$crossDomainMessager, i, n, a), "api.ShowCustomViewCommand" === a.get_commandName()) {
            ...
            t.isNullOrUndefined(r) && (r = [], this.$customViewLoadCallbacks[i.get_hostId()] = r), r.push(a);
          }
        };
      },
      $handleCustomViewsListLoad: function $handleCustomViewsListLoad(e) {
        ...
        if (!t.isNullOrUndefined(n)) {
          for (var a = 0; a < n.length; a++) {
            var r = n[a];
            t.staticEquals(r.get_successCallback(), null) || r.get_successCallback()(null);
          }
      ...
      getMarksAsync: function getMarksAsync() {
        ...
        return t.isValue(e.get_selectedMarks()) ? new a._Deferred().resolve(e.get_selectedMarks()._toApiCollection()) : e.$getSelectedMarksAsync();
      }
    }, j), t.initClass(R, i, {
    ...
    }, x), t.initClass(D, i, {}), t.initClass(z, i, {
      ...
      $calculateFrameSize: function $calculateFrameSize(e) {
        ...
        if ("exactly" === o.behavior) l = o.maxSize.width, u = o.maxSize.height + s;else switch (o.behavior) {
          case "range":
            t = o.minSize.width, i = o.maxSize.width, n = o.minSize.height + s, r = o.maxSize.height + s, l = Math.max(t, Math.min(i, e.width)), u = Math.max(n, Math.min(r, e.height));
            break;

          case "atleast":
            t = o.minSize.width, n = o.minSize.height + s, l = Math.max(t, e.width), u = Math.max(n, e.height);
            break;

          case "atmost":
            i = o.maxSize.width, r = o.maxSize.height + s, l = Math.min(i, e.width), u = Math.min(r, e.height);
            break;
          ...
          default:
            throw a._TableauException.createInternalError("Unknown SheetSizeBehavior for viz: " + o.behavior.toString());
        }
        return a.Size.$ctor(l, u);
      },
      $getNewFrameSize: function $getNewFrameSize() {
        var e;
        return t.isValue(this.$initialAvailableSize) ? (e = this.$initialAvailableSize, this.$initialAvailableSize = null) : e = a._Utility.computeContentSize(this.get_$parentElement()), this.$raiseVizResizeEvent(e), this.$calculateFrameSize(e);
      },
      ...
      addEventListener: function addEventListener(e, i) {
        var n = {};
        if (!a.PublicEnums.tryNormalizeEnum(a.ApiTableauEventName).call(null, e, n)) throw a._TableauException.createUnsupportedEventName(e.toString());
      ...
      $showDownloadWorkbookDialog: function $showDownloadWorkbookDialog() {
        if (!this.get__workbookImpl().get_isDownloadAllowed()) throw a._TableauException.create("downloadWorkbookNotAllowed", "Download workbook is not allowed");
      ...
      $sendVisibleRect: function $sendVisibleRect() {
        ...
        var e = a._Utility.visibleContentRectInDocumentCoordinates(this.get_iframe()),
            ...
            n = new a.NonApiCommand("layoutInfoResp", [(e.left - i.left).toString(), (e.top - i.top).toString(), e.width.toString(), e.height.toString()]);
      ...
      $enableVisibleRectCommunication: function $enableVisibleRectCommunication() {
        if (a._Utility.hasWindowPostMessage() && !t.isNullOrUndefined(this.$iframe) && t.isValue(this.$iframe.contentWindow)) {
          var e = new a.NonApiCommand("tableau.enableVisibleRectCommunication", []);
      ...
      sendScaleFactor: function sendScaleFactor(e) {
        var i = document.documentElement.clientWidth / window.innerWidth,
            n = new a.NonApiCommand("sf", [e, i.toString(), 0 .toString(), 0 .toString()]);
        t.isValue(this.$iframe) && t.isValue(this.$iframe.contentWindow) && this.$iframe.contentWindow.postMessage(n.serialize(), "*");
      },
      ...
      $verifyOperationAllowedOnActiveSheetOrSheetWithinActiveDashboard: function $verifyOperationAllowedOnActiveSheetOrSheetWithinActiveDashboard(e) {
        ...
        if (t.isNullOrUndefined(i)) throw a._TableauException.createNotActiveSheet();
        return i.get_name();
      },
      $invokeAutomaticUpdatesCommandAsync: function $invokeAutomaticUpdatesCommandAsync(e) {
        if ("pauseAutomaticUpdates" !== e && "resumeAutomaticUpdates" !== e && "toggleAutomaticUpdates" !== e) throw a._TableauException.createInternalError(null);
        var i = {};
      ...
      $invokeCommand: function $invokeCommand(e, i) {
        if ("showExportImageDialog" !== e && "showExportDataDialog" !== e && "showExportCrosstabDialog" !== e && "showExportPDFDialog" !== e && "showShareDialog" !== e && "showDownloadWorkbookDialog" !== e) throw a._TableauException.createInternalError(null);
        var n = {};
        n["api.invokeCommandName"] = e, t.isValue(i) && (n["api.invokeCommandParam"] = i);
        var r = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.InvokeCommandCommand", 0, null, null);
      ...
      $handleMarksSelectionChangedEvent: function $handleMarksSelectionChangedEvent(e) {
        if (!t.staticEquals(this.$1$MarksSelectionField, null) && t.referenceEquals(this.$workbookImpl.get_name(), e.get_workbookName())) {
          ...
          if (n.get_isStory() && (n = t.cast(n, $).get_activeStoryPointImpl().get_containedSheetImpl()), t.referenceEquals(n.get_name(), e.get_worksheetName())) i = t.cast(n, C);else if (n.get_isDashboard()) {
      ...
      $handleFilterChangedEvent: function $handleFilterChangedEvent(e) {
        if (!t.staticEquals(this.$1$FilterChangeField, null) && t.referenceEquals(this.$workbookImpl.get_name(), e.get_workbookName())) {
          var i = null,
              n = this.$workbookImpl.get_activeSheetImpl();
          if (t.referenceEquals(n.get_name(), e.get_worksheetName())) i = t.cast(n, C);else if (n.get_isDashboard()) {
            i = t.cast(n, d).get_worksheets()._get(e.get_worksheetName())._impl;
          } else if (n.get_isStory()) {
            var a = t.cast(n, $).get_activeStoryPointImpl().get_containedSheetImpl();
            if (a.get_isDashboard()) i = t.cast(a, d).get_worksheets()._get(e.get_worksheetName())._impl;else t.referenceEquals(a.get_name(), e.get_worksheetName()) && (i = t.cast(a, C));
          }
          ...
          if (t.isValue(i)) {
            var r = t.cast(JSON.parse(t.cast(e.get_data(), String)), Array),
                s = r[0],
                o = r[1];
            this.$1$FilterChangeField(new N("filterchange", this.$viz, i, s, o));
          }
        }
      },
      ...
      $handleCustomViewUpdatedEvent: function $handleCustomViewUpdatedEvent(e) {
        var i = JSON.parse(t.cast(e.get_data(), String));
        if (t.isNullOrUndefined(this.$workbookImpl) && (this.$workbookImpl = new S(this, this.$messagingOptions, null)), t.isValue(this.$workbookImpl) && m._processCustomViewUpdate(this.$workbookImpl, this.$messagingOptions, i, !0), !t.staticEquals(this.$1$CustomViewSaveField, null)) for (var n = this.$workbookImpl.get_$updatedCustomViews()._toApiCollection(), a = 0, r = n.length; a < r; a++) {
      ...
      $handleCustomViewSetDefaultEvent: function $handleCustomViewSetDefaultEvent(e) {
        var i = JSON.parse(t.cast(e.get_data(), String));
        if (t.isValue(this.$workbookImpl) && m._processCustomViews(this.$workbookImpl, this.$messagingOptions, i), !t.staticEquals(this.$1$CustomViewSetDefaultField, null) && t.isValue(i.defaultCustomViewId)) for (var n = this.$workbookImpl.get_$customViews(), a = 0; a < n.get__length(); a++) {
          var r = n.get_item(a);
      ...
      $ensureCalledAfterFirstInteractive: function $ensureCalledAfterFirstInteractive(e) {
        ...
        (n = t.mkdel(this, function () {
          ...
          if (this.$onFirstInteractiveAlreadyCalled) e();else {
            if (t - i > 3e5) throw a._TableauException.createInternalError("Timed out while waiting for the viz to become interactive");
      ...
      $handleInitialVizSize: function $handleInitialVizSize(e) {
        ...
        this.$vizSize = L.$ctor(i, e.chromeHeight), t.isValue(this.$onFirstVizSizeKnownCallback) && this.$onFirstVizSizeKnownCallback(new A("firstvizsizeknown", this.$viz, this.$vizSize)), this.$parameters.fixedSize || (this.$refreshSize(), this.$addWindowResizeHandler(), this.$show());
      },
      ...
      switchToViz: function switchToViz(e) {
        ...
        var r = new (t.makeGenericType(a.CommandReturnHandler$1, [Object]))("api.SwitchViz", 1, function (e) {
          i.resolve();
        }, function (e, t) {
          i.reject(a._TableauException.createServerError(t));
        });
    ...
    }, null, [V]), t.initClass(H, i, {
      getAvailableSize: function getAvailableSize() {
        return this.$availableSize;
      }
    }, x), t.initClass(L, i, {}, Object), t.initClass(K, i, {
      ...
      setFrameSize: function setFrameSize(e, t) {
        var i = e,
            n = t;
        a._Utility.isNumber(e) && (i = e.toString() + "px"), a._Utility.isNumber(t) && (n = t.toString() + "px"), this._impl.$setFrameSizeAndUpdate(i, n);
      },
      redoAsync: function redoAsync() {
    ...
    }), t.initClass(ue, i, {}), t.initClass(ce, i, {
      getViz: function getViz() {
