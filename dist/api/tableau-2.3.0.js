...
!function () {
  ...
  function () {
    ...
    var E,
      ...
      normalizeRangeFilterOption: function normalizeRangeFilterOption(e) {
        ...
        if (t.isNullOrUndefined(e.min) && t.isNullOrUndefined(e.max)) throw g.create("invalidParameter", "At least one of filterOptions.min or filterOptions.max must be specified.");
        var i = new Object();
  ...
  function () {
    ...
    var r = e.tab._ApiBootstrap = t.mkType(n, "tab._ApiBootstrap", null, null, {
      ...
      update: function update(e) {
        ...
        for (var r = 0; r < e.storyPoints.length; r++) {
          ...
          if (t.isNullOrUndefined(this.$storyPointsInfo[r])) this.$storyPointsInfo[r] = new ae(l);else if (this.$storyPointsInfo[r]._impl.storyPointId === l.storyPointId) {
      ...
      if (this.name = "", this.host_url = null, this.tabs = !1, this.toolbar = !1, this.toolBarPosition = null, this.device = null, this.hostId = null, this.width = null, this.height = null, this.parentElement = null, this.userSuppliedParameters = null, this.staticImageUrl = null, this.fixedSize = !1, this.displayStaticImage = !1, this.iframeSizedToWindow = !1, this.$urlFromApi = null, this.$createOptions = null, t.isNullOrUndefined(e) || t.isNullOrUndefined(n)) throw i._TableauException.create("noUrlOrParentElementNotFound", "URL is empty or Parent element not found");
      t.isNullOrUndefined(r) && ((r = new Object()).hideTabs = !1, r.hideToolbar = !1, r.onFirstInteractive = null), t.isValue(r.height) || t.isValue(r.width) ? (this.fixedSize = !0, i._Utility.isNumber(r.height) && (r.height = r.height.toString() + "px"), i._Utility.isNumber(r.width) && (r.width = r.width.toString() + "px"), this.height = t.isValue(r.height) ? i._Utility.roundVizSizeInPixels(r.height.toString()) : null, this.width = t.isValue(r.width) ? i._Utility.roundVizSizeInPixels(r.width.toString()) : null) : this.fixedSize = !1, this.displayStaticImage = r.displayStaticImage || !1, this.staticImageUrl = r.staticImageUrl || "", this.tabs = !r.hideTabs, this.toolbar = !r.hideToolbar, this.device = r.device, this.iframeSizedToWindow = r.iframeSizedToWindow, this.parentElement = e, this.$createOptions = r, this.toolBarPosition = r.toolbarPosition;
      var a = n.split("?");
      ...
      $constructUrl: function $constructUrl() {
        ...
        try {
          for (; n.moveNext();) {
            var r = n.current();
            "embed" !== r.key && "height" !== r.key && "width" !== r.key && "device" !== r.key && "autoSize" !== r.key && "hideTabs" !== r.key && "hideToolbar" !== r.key && "onFirstInteractive" !== r.key && "onFirstVizSizeKnown" !== r.key && "toolbarPosition" !== r.key && "instanceIdToClone" !== r.key && "navType" !== r.key && "display_static_image" !== r.key && (e.push("&"), e.push(encodeURIComponent(r.key)), e.push("="), e.push(encodeURIComponent(r.value.toString())));
          }
        } finally {
          n.dispose();
        }
        ...
        if (!t.staticEquals(this.$1$FilterChangeField, null) && t.referenceEquals(this.$workbookImpl.get_name(), e.get_workbookName())) {
          ...
          if (t.isValue(i)) {
            var a = t.cast(JSON.parse(t.cast(e.get_data(), String)), Array),
                o = a[0],
                l = a[1];
            this.$1$FilterChangeField(new k("filterchange", this.$viz, i, o, l));
          }
        }
      },
      ...
      $handleInitialVizSize: function $handleInitialVizSize(e) {
        ...
        this.$vizSize = L.$ctor(n, e.chromeHeight), t.isValue(this.$onFirstVizSizeKnownCallback) && this.$onFirstVizSizeKnownCallback(new E("firstvizsizeknown", this.$viz, this.$vizSize)), this.$parameters.fixedSize || (this.$refreshSize(), this.$addWindowResizeHandler(), this.$show());
      },
      ...
      getLastClientInfoResponseMessage: function getLastClientInfoResponseMessage() {
        ...
        ue = e.tableauSoftware.VizManager = t.mkType(n, "tableauSoftware.VizManager", null, null, {
    ...
    t.initClass(r), t.initClass(a), t.initClass(l), t.initClass(s, l), t.initClass(o), t.initClass(u, Object), t.initClass(c, l), t.initClass(h), t.initClass(m, Object), t.initClass(d), t.initClass(p), t.initClass(f), t.initClass(g), t.initClass($, l), t.initClass(T), t.initClass(v, T), t.initClass(y), t.initClass(_, T), t.initClass(w, T), t.initClass(b, T), t.initClass(S, T), t.initClass(C), t.initClass(x), t.initClass(I, x), t.initClass(j, x), t.initClass(k, j), t.initClass(E, x), t.initClass(A, j), t.initInterface(V, {
