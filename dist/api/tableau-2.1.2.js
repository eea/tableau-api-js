...
!function () {
  ...
  !function (e) {
    ...
    a.initAssembly = function (e, t, i) {
      ...
      if (a.isValue(e)) {
        ...
        if ("number" == typeof e) {
          ...
          return t = t.substr(0, t.indexOf("e")), 4294967295 & parseInt(t.replace(".", ""), 10);
        }
      ...
      if (a.isValue(e)) return "number" == typeof e || "string" == typeof e || "boolean" == typeof e ? e < t ? -1 : e > t ? 1 : 0 : a.isDate(e) ? a.compare(e.valueOf(), t.valueOf()) : e.compareTo(t);
      ...
      a.__genericCache[o] = e, e.__typeName = o, e.__genericTypeDefinition = t, e.__typeArguments = i, a.initClass(e, t.__assembly, n, r(), s());
    }, a.registerGenericInterfaceInstance = function (e, t, i, n, r) {
      var s = a._makeGenericTypeName(t, i);

      a.__genericCache[s] = e, e.__typeName = s, e.__genericTypeDefinition = t, e.__typeArguments = i, a.initInterface(e, t.__assembly, n, r());
      ...
      var t = e.prototype;
      if (Object.prototype.hasOwnProperty.call(t, "constructor")) try {
        var i = t.constructor;
      ...
      var r,
          ...
          l = n.exec(t),
          u = [];
      if (l) switch (r = t.substring(o, l.index), l[0]) {
        case "[":
          ...
          if ((l = n.exec(t)) && "," === l[0] && (n.exec(t), !(i = a.__assemblies[(n.lastIndex > 0 ? t.substring(l.index + 1, n.lastIndex - 1) : t.substring(l.index + 1)).trim()]))) return null;
          break;
        ...
        case ",":
          if (n.exec(t), !(i = a.__assemblies[(n.lastIndex > 0 ? t.substring(l.index + 1, n.lastIndex - 1) : t.substring(l.index + 1)).trim()])) return null;
          break;
    ...
    s.__typeName = "ss.IFormattable", a.IFormattable = s, a.initInterface(s, a, {
      format: null
    });

    var o = function o() {};

    o.__typeName = "ss.IComparable", a.IComparable = o, a.initInterface(o, a, {
      compareTo: null
    });

    var l = function l() {};

    l.__typeName = "ss.IEquatable", a.IEquatable = l, a.initInterface(l, a, {
      equalsT: null
    ...
    u.__typeName = "ss.Enum", a.Enum = u, a.initClass(u, a, {}), u.getValues = function (e) {
      var t = [],
          i = e.prototype;
    ...
    c.__typeName = "ss.IEnumerator", a.IEnumerator = c, a.initInterface(c, a, {
      current: null,
      moveNext: null,
      reset: null
    }, [I]);
    ...
    h.__typeName = "ss.IEnumerable", a.IEnumerable = h, a.initInterface(h, a, {
      getEnumerator: null
    ...
    m.__typeName = "ss.ICollection", a.ICollection = m, a.initInterface(m, a, {
      get_count: null,
      add: null,
      clear: null,
      contains: null,
    ...
    d.__typeName = "ss.IEqualityComparer", a.IEqualityComparer = d, a.initInterface(d, a, {
      areEqual: null,
    ...
    p.__typeName = "ss.IComparer", a.IComparer = p, a.initInterface(p, a, {
      compare: null
    }), a.unbox = function (e) {
    ...
    var f = function f(e) {
      ...
      return t.isInstanceOfType = function (t) {
    ...
    g.__typeName = "ss.IList", a.IList = g, a.initInterface(g, a, {
      get_item: null,
      set_item: null,
      indexOf: null,
      insert: null,
    ...
    $.__typeName = "ss.IDictionary", a.IDictionary = $, a.initInterface($, a, {
      get_item: null,
      set_item: null,
      get_keys: null,
      get_values: null,
    ...
    _.__typeName = "ss.Int32", a.Int32 = _, a.initClass(_, a, {}, Object, [l, o, s]), _.__class = !1, _.isInstanceOfType = function (e) {
    ...
    v.__typeName = "ss.JsDate", a.JsDate = v, a.initClass(v, a, {}, Object, [l, o]), v.createInstance = function () {
      return new Date();
    ...
    y.__typeName = "ss.ArrayEnumerator", a.ArrayEnumerator = y, a.initClass(y, a, {
    ...
    w.__typeName = "ss.ObjectEnumerator", a.ObjectEnumerator = w, a.initClass(w, a, {
      moveNext: function moveNext() {
      ...
      current: function current() {
        if (this._index < 0 || this._index >= this._keys.length) throw new U("Invalid operation");
    ...
    S.__typeName = "ss.EqualityComparer", a.EqualityComparer = S, a.initClass(S, a, {
    ...
    b.__typeName = "ss.Comparer", a.Comparer = b, a.initClass(b, a, {
    ...
    I.__typeName = "ss.IDisposable", a.IDisposable = I, a.initInterface(I, a, {
      dispose: null
    });
    ...
    C.__typeName = "ss.StringBuilder", a.StringBuilder = C, a.initClass(C, a, {
    ...
    N.__typeName = "ss.EventArgs", a.EventArgs = N, a.initClass(N, a, {}), N.Empty = new N();

    var E = function E(e, t) {
      this._message = e || "An error occurred.", this._innerException = t || null, this._error = new Error();
    };

    E.__typeName = "ss.Exception", a.Exception = E, a.initClass(E, a, {
    ...
    A.__typeName = "ss.NotImplementedException", a.NotImplementedException = A, a.initClass(A, a, {}, E);

    var V = function V(e, t) {
      E.call(this, e || "Specified method is not supported.", t);
    };

    V.__typeName = "ss.NotSupportedException", a.NotSupportedException = V, a.initClass(V, a, {}, E);
    ...
    k.__typeName = "ss.AggregateException", a.AggregateException = k, a.initClass(k, a, {
      flatten: function flatten() {
        for (var e = [], t = 0; t < this.innerExceptions.length; t++) {
          var i = this.innerExceptions[t];
          a.isInstanceOfType(i, k) ? e.push.apply(e, i.flatten().innerExceptions) : e.push(i);
        }
    ...
    T.__typeName = "ss.PromiseException", a.PromiseException = T, a.initClass(T, a, {
    ...
    O.__typeName = "ss.JsErrorException", a.JsErrorException = O, a.initClass(O, a, {
      get_stack: function get_stack() {
    ...
    F.__typeName = "ss.ArgumentException", a.ArgumentException = F, a.initClass(F, a, {}, E);

    var D = function D(e, t, i) {
      t || (t = "Value cannot be null.", e && (t += "\nParameter name: " + e)), F.call(this, t, e, i);
    };

    D.__typeName = "ss.ArgumentNullException", a.ArgumentNullException = D, a.initClass(D, a, {}, F);

    var R = function R(e, t, i, n) {
      t || (t = "Value is out of range.", e && (t += "\nParameter name: " + e)), F.call(this, t, e, i), this.actualValue = n || null;
    };

    R.__typeName = "ss.ArgumentOutOfRangeException", a.ArgumentOutOfRangeException = R, a.initClass(R, a, {}, F);

    var z = function z(e, t) {
      E.call(this, e || "Invalid format.", t);
    };

    z.__typeName = "ss.FormatException", a.FormatException = z, a.initClass(z, a, {}, E);

    var P = function P(e, t) {
      E.call(this, e || "Division by 0.", t);
    };

    P.__typeName = "ss.DivideByZeroException", a.DivideByZeroException = P, a.initClass(P, a, {}, E);

    var x = function x(e, t) {
      E.call(this, e || "The cast is not valid.", t);
    };

    x.__typeName = "ss.InvalidCastException", a.InvalidCastException = x, a.initClass(x, a, {}, E);

    var U = function U(e, t) {
      E.call(this, e || "Operation is not valid due to the current state of the object.", t);
    };

    U.__typeName = "ss.InvalidOperationException", a.InvalidOperationException = U, a.initClass(U, a, {}, E);

    var M = function M(e, t) {
      E.call(this, e || "Object is null.", t);
    };

    M.__typeName = "ss.NullReferenceException", a.NullReferenceException = M, a.initClass(M, a, {}, E);

    var L = function L(e, t) {
      E.call(this, e || "Key not found.", t);
    };

    L.__typeName = "ss.KeyNotFoundException", a.KeyNotFoundException = L, a.initClass(L, a, {}, E);

    var H = function H(e, t) {
      E.call(this, e || "Ambiguous match.", t);
    };

    H.__typeName = "ss.AmbiguousMatchException", a.AmbiguousMatchException = H, a.initClass(H, a, {}, E);

    var j = function j(e, t) {
      this._getEnumerator = e, this._this = t;
    };

    j.__typeName = "ss.IteratorBlockEnumerable", a.IteratorBlockEnumerable = j, a.initClass(j, a, {
      getEnumerator: function getEnumerator() {
        return this._getEnumerator.call(this._this);
      }
    }, null, [h]);

    var W = function W(e, t, i, n) {
      this._moveNext = e, this._getCurrent = t, this._dispose = i, this._this = n;
    };

    W.__typeName = "ss.IteratorBlockEnumerator", a.IteratorBlockEnumerator = W, a.initClass(W, a, {
      moveNext: function moveNext() {
        try {
    ...
    q.__typeName = "ss.Lazy", a.Lazy = q, a.initClass(q, a, {
  ...
  !function () {
    ...
    n.__typeName = "tab.EscapingUtil", n.escapeHtml = function (e) {
      var i = t.coalesce(e, "");
      return i = (i = (i = (i = (i = (i = i.replace(new RegExp("&", "g"), "&amp;")).replace(new RegExp("<", "g"), "&lt;")).replace(new RegExp(">", "g"), "&gt;")).replace(new RegExp('"', "g"), "&quot;")).replace(new RegExp("'", "g"), "&#39;")).replace(new RegExp("/", "g"), "&#47;");
    ...
    a.__typeName = "tab.WindowHelper", a.get_windowSelf = function () {
    ...
    }, e.tab.WindowHelper = a, t.initClass(n, i, {}), t.initClass(r, i, {}), t.initClass(a, i, {
      ...
      for (var o = 0; o < n.length && (t.isNullOrUndefined(r) || t.isNullOrUndefined(s)); ++o) {
        var l = n[o],
            u = l + "RequestAnimationFrame";
        t.isNullOrUndefined(r) && u in window && (r = u), t.isNullOrUndefined(s) && ((u = l + "CancelAnimationFrame") in window && (s = u), (u = l + "CancelRequestAnimationFrame") in window && (s = u));
      }
  ...
  !function () {
    var a = {};
    e.tab = e.tab || {}, e.tableauSoftware = e.tableauSoftware || {}, t.initAssembly(a, "Tableau.JavaScript.Vql.Api");
    ...
    var s = function s() {
      if (this.$nextHandlerId = 0, this.$handlers = {}, this.$commandCallbacks = {}, this.$customViewLoadCallbacks = {}, this.$commandReturnAfterStateReadyQueues = {}, M.hasWindowAddEventListener()) window.addEventListener("message", t.mkdel(this, this.$handleCrossDomainMessage), !1);else if (M.hasDocumentAttachEvent()) {
        ...
        document.attachEvent("onmessage", e), window.attachEvent("onmessage", e);
    ...
    u.__typeName = "tab.$DeferredUtil", u.$coerceToTrustedPromise = function (e) {
      var i;
      if (e instanceof tableauSoftware.Promise) i = t.cast(e, O);else if (t.isValue(e) && "function" == typeof e.valueOf && (e = e.valueOf()), u.$isPromise(e)) {
        var n = new V();
        t.cast(e, O).then(t.mkdel(n, n.resolve), t.mkdel(n, n.reject)), i = n.get_promise();
      } else i = u.$resolved(e);
      return i;
    }, u.$reject = function (e) {
    ...
    var d = function d(e) {
      if (this.$clonedPairs = null, this.$collection = new r._Collection(), this.$tupleId = 0, k.isArray(e)) for (var i = e, n = 0; n < i.length; n++) {
        var a = i[n];
        if (!t.isValue(a.fieldName)) throw U.createInvalidParameter("pair.fieldName");
    ...
    d.__typeName = "tab.$MarkImpl", d.$processActiveMarks = function (e) {
      ...
      for (var n = 0; n < e.marks.length; n++) {
        ...
        for (var l = 0; l < a.pairs.length; l++) {
          ...
          h.formattedValue = u.formattedValue, o.$impl.get_$pairs()._has(h.fieldName) || o.$impl.$addPair(h);
        }
      }
    ...
    $.__typeName = "tab.$PublicEnums", $.$tryNormalizeEnum = function (e) {
      return function (i, n) {
      ...
      return function (t, i) {
        var n = {};
        if (!$.$tryNormalizeEnum(e).call(null, t, n)) throw U.createInvalidParameter(i);
        return n.$;
      };
    ...
    _.__typeName = "tab._ApiBootstrap", _.initialize = function () {
      y.registerCrossDomainMessageRouter(function () {
        return new s();
      });
    }, e.tab._ApiBootstrap = _;

    var v = function v(e, t, i, n) {
    ...
    v.__typeName = "tab._ApiCommand", v.generateNextCommandId = function () {
      ...
      var a,
          s = e.substr(r + 1);
      if ((r = s.indexOf(String.fromCharCode(44))) < 0) return new v(i, n = s, null, null);
      n = s.substr(0, r);
      var o = s.substr(r + 1);
      if ((r = o.indexOf(String.fromCharCode(44))) < 0) return new v(i, n, a = o, null);
      a = o.substr(0, r);
      var l = o.substr(r + 1);
      return v.lastResponseMessage = e, "api.GetClientInfoCommand" === i && (v.lastClientInfoResponseMessage = e), new v(i, n, a, l);
    }, e.tab._ApiCommand = v;

    var y = function y() {};

    y.__typeName = "tab._ApiObjectRegistry", y.registerCrossDomainMessageRouter = function (e) {
      ...
      return function (i) {
        t.isNullOrUndefined(y.$creationRegistry) && (y.$creationRegistry = {});
      ...
      return function () {
        if (t.isNullOrUndefined(y.$creationRegistry)) throw U.createInternalError("No types registered");
        var i = t.getTypeFullName(e),
            n = y.$creationRegistry[i];
        if (t.isNullOrUndefined(n)) throw U.createInternalError("No creation function has been registered for interface type '" + i + "'.");
        return n();
      };
    }, y.$getSingleton = function (e) {
      return function () {
        t.isNullOrUndefined(y.$singletonInstanceRegistry) && (y.$singletonInstanceRegistry = {});
        var i = t.getTypeFullName(e),
            n = t.cast(y.$singletonInstanceRegistry[i], e);
        return t.isNullOrUndefined(n) && (n = y.$createType(e).call(null), y.$singletonInstanceRegistry[i] = n), n;
      };
    ...
    S.__typeName = "tab._ApiServerResultParser", e.tab._ApiServerResultParser = S;
    ...
    C.__typeName = "tab._CustomViewImpl", C._getAsync = function (e) {
      ...
      return a.$isPublic = n.isPublic, a.$url = n.url, a.$ownerName = n.owner.friendlyName, a.$isDefault = t.isValue(r) && t.unbox(r) === n.id, a.$presModel = n, a;
    }, C._saveNewAsync = function (e, i, n) {
      var a = new r._Deferred(),
          s = {};
      s["api.customViewName"] = n;
      var o = C.$createCustomViewCommandReturnHandler("api.SaveNewCustomViewCommand", a, function (n) {
        C._processCustomViewUpdate(e, i, n, !0);

        var r = null;
        t.isValue(e.get_$updatedCustomViews()) && (r = e.get_$updatedCustomViews().get_item(0)), a.resolve(r);
      });
      ...
      var o = C.$createCustomViewCommandReturnHandler("api.ShowCustomViewCommand", a, function (t) {
      ...
      a && e.set_$updatedCustomViews(new r._Collection()), e.set_$currentCustomView(null);
      var s = null;
      ...
      if (e.set_$removedCustomViews(e.get_$customViews()), e.set_$customViews(new r._Collection()), t.isValue(n.customViews)) {
        ...
        if (u.length > 0) for (var c = 0; c < u.length; c++) {
          ...
          e.get_$customViews()._add(h.get_$name(), h.get_$customView()), e.get_$removedCustomViews()._has(h.get_$name()) ? e.get_$removedCustomViews()._remove(h.get_$name()) : a && (e.get_$updatedCustomViews()._has(h.get_$name()) || e.get_$updatedCustomViews()._add(h.get_$name(), h.get_$customView())), t.isValue(s) && t.referenceEquals(h.get_$name(), s) && e.set_$currentCustomView(h.get_$customView());
        }
      }
    ...
    A.__typeName = "tab._DataTableImpl", A.processGetDataPresModel = function (e) {
      ...
      for (var t = [], i = 0; i < e.length; i++) {
        var n = e[i],
            r = new I(n.fieldName, B.convertDataType(n.dataType), n.isReferenced, n.index);
        t.push(new Re(r));
      }
    ...
    k.__typeName = "tab._jQueryShim", k.isFunction = function (e) {
      ...
      if (e = k.trim(e), t.isValue(JSON) && t.isValue(JSON.parse)) return JSON.parse(e);
      if (k.$rvalidchars.test(e.replace(k.$rvalidescape, "@").replace(k.$rvalidtokens, "]").replace(k.$rvalidbraces, ""))) return new Function("return " + e)();
      throw new t.Exception("Invalid JSON: " + e);
    }, e.tab._jQueryShim = k;

    var T = function T() {};

    T.__typeName = "tab._Param", T.verifyString = function (e, i) {
    ...
    D.__typeName = "tab._SheetImpl", D.$convertValueToIntIfValid = function (e) {
      ...
      var i = $.$normalizeEnum(ae).call(null, e.behavior, "size.behavior"),
          n = e.minSize;
      t.isValue(n) && (n = Ce.$ctor(D.$convertValueToIntIfValid(e.minSize.width), D.$convertValueToIntIfValid(e.minSize.height)));
      var r = e.maxSize;
      return t.isValue(r) && (r = Ce.$ctor(D.$convertValueToIntIfValid(e.maxSize.width), D.$convertValueToIntIfValid(e.maxSize.height))), be.$ctor(i, n, r);
    }, e.tab._SheetImpl = D;

    var R = function R() {};

    R.__typeName = "tab._SheetInfoImpl", R.$ctor = function (e, t, i, n, r, a, s, o, l) {
      var u = new Object();
    ...
    x.__typeName = "tab._StoryPointInfoImpl", x.$ctor = function (e, t, i, n, r, a) {
      var s = new Object();
    ...
    U.__typeName = "tab._TableauException", U.create = function (e, i) {
    ...
    M.__typeName = "tab._Utility", M.isNullOrEmpty = function (e) {
      ...
      if (i.append(e.tagName.toLowerCase()), M.isNullOrEmpty(e.id) || i.append("#").append(e.id), !M.isNullOrEmpty(e.className)) {
      ...
      for (var i = M.contentRectInDocumentCoordinates(e), n = e.parentElement; t.isValue(n) && t.isValue(n.parentElement); n = n.parentElement) {
        ...
        "auto" !== a && "scroll" !== a && "hidden" !== a || (i = i.intersect(M.contentRectInDocumentCoordinates(n)));
      }

      var s = M.contentRectInDocumentCoordinates(document.documentElement),
          o = new r.WindowHelper(window.self);
      return o.isQuirksMode() && (s.height = document.body.clientHeight - s.left, s.width = document.body.clientWidth - s.top), s.left += o.get_pageXOffset(), s.top += o.get_pageYOffset(), i.intersect(s);
      ...
      var i = "";
      t.isValue(e) && M.isDate(e) && (i = e.getUTCFullYear() + "-" + (e.getUTCMonth() + 1) + "-" + e.getUTCDate() + " " + e.getUTCHours() + ":" + e.getUTCMinutes() + ":" + e.getUTCSeconds());
      return i;
    ...
    L.__typeName = "tab._VizManagerImpl", L.get_$clonedVizs = function () {
      ...
      for (var i = e.getParentElement(), n = 0, r = L.$vizs.length; n < r; n++) {
        if (t.referenceEquals(L.$vizs[n].getParentElement(), i)) {
          var a = "Another viz is already present in element '" + M.elementToString(i) + "'.";
    ...
    var H = function H(e, i, n) {
      if (this.name = "", this.host_url = null, this.tabs = !1, this.toolbar = !1, this.toolBarPosition = null, this.device = null, this.hostId = null, this.width = null, this.height = null, this.parentElement = null, this.userSuppliedParameters = null, this.staticImageUrl = null, this.fixedSize = !1, this.displayStaticImage = !1, this.$urlFromApi = null, this.$createOptions = null, t.isNullOrUndefined(e) || t.isNullOrUndefined(i)) throw U.create("noUrlOrParentElementNotFound", "URL is empty or Parent element not found");
      t.isNullOrUndefined(n) && ((n = new Object()).hideTabs = !1, n.hideToolbar = !1, n.onFirstInteractive = null), t.isValue(n.height) || t.isValue(n.width) ? (this.fixedSize = !0, M.isNumber(n.height) && (n.height = n.height.toString() + "px"), M.isNumber(n.width) && (n.width = n.width.toString() + "px"), this.height = t.isValue(n.height) ? M.roundVizSizeInPixels(n.height.toString()) : null, this.width = t.isValue(n.width) ? M.roundVizSizeInPixels(n.width.toString()) : null) : this.fixedSize = !1, this.displayStaticImage = n.displayStaticImage || !1, this.staticImageUrl = n.staticImageUrl || "", this.tabs = !n.hideTabs, this.toolbar = !n.hideToolbar, this.device = n.device, this.parentElement = e, this.$createOptions = n, this.toolBarPosition = n.toolbarPosition;
      var r = i.split("?");
      this.$urlFromApi = r[0], 2 === r.length ? this.userSuppliedParameters = r[1] : this.userSuppliedParameters = "";
      var a = new RegExp(".*?[^/:]/", "").exec(this.$urlFromApi);
      if (t.isNullOrUndefined(a) || -1 === a[0].toLowerCase().indexOf("http://") && -1 === a[0].toLowerCase().indexOf("https://")) throw U.create("invalidUrl", "Invalid url");
      this.host_url = a[0].toLowerCase(), this.name = this.$urlFromApi.replace(a[0], ""), this.name = this.name.replace("views/", "");
    };
    ...
    W.__typeName = "tab._WorksheetImpl", W.$filterCommandError = function (e) {
      ...
      if (t.isNullOrUndefined(e)) throw U.createNullOrEmptyParameter("filterOptions");
      if (t.isNullOrUndefined(e.min) && t.isNullOrUndefined(e.max)) throw U.create("invalidParameter", "At least one of filterOptions.min or filterOptions.max must be specified.");
      var i = new Object();
      return t.isValue(e.min) && (i.min = e.min), t.isValue(e.max) && (i.max = e.max), t.isValue(e.nullOption) && (i.nullOption = $.$normalizeEnum(ee).call(null, e.nullOption, "filterOptions.nullOption")), i;
    }, W.$normalizeRelativeDateFilterOptions = function (e) {
      if (t.isNullOrUndefined(e)) throw U.createNullOrEmptyParameter("filterOptions");
      var i = new Object();

      if (i.rangeType = $.$normalizeEnum(G).call(null, e.rangeType, "filterOptions.rangeType"), i.periodType = $.$normalizeEnum(ne).call(null, e.periodType, "filterOptions.periodType"), "lastn" === i.rangeType || "nextn" === i.rangeType) {
        if (t.isNullOrUndefined(e.rangeN)) throw U.create("missingRangeNForRelativeDateFilters", "Missing rangeN field for a relative date filter of LASTN or NEXTN.");
        i.rangeN = M.toInt(e.rangeN);
      }

      if (t.isValue(e.anchorDate)) {
        if (!M.isDate(e.anchorDate) || !M.isDateValid(e.anchorDate)) throw U.createInvalidDateParameter("filterOptions.anchorDate");
    ...
    q.__typeName = "tab.ApiDashboardObjectType", e.tab.ApiDashboardObjectType = q;
    ...
    B.__typeName = "tab.ApiEnumConverter", B.convertDashboardObjectType = function (e) {
      switch (e) {
        case "blank":
          return "blank";
    ...
    J.__typeName = "tab.ApiFieldAggregationType", e.tab.ApiFieldAggregationType = J;
    ...
    te.__typeName = "tab.ApiParameterAllowableValuesType", e.tab.ApiParameterAllowableValuesType = te;

    var ie = function ie() {};

    ie.__typeName = "tab.ApiParameterDataType", e.tab.ApiParameterDataType = ie;
    ...
    re.__typeName = "tab.ApiSelectionUpdateType", e.tab.ApiSelectionUpdateType = re;

    var ae = function ae() {};

    ae.__typeName = "tab.ApiSheetSizeBehavior", e.tab.ApiSheetSizeBehavior = ae;
    ...
    oe.__typeName = "tab.ApiTableauEventName", e.tab.ApiTableauEventName = oe;
    ...
    var ue = function ue(e) {
      ...
      return t.registerGenericClassInstance(i, ue, [e], {
    ...
    ue.__typeName = "tab.CommandReturnHandler$1", t.initGenericClass(ue, a, 1), e.tab.CommandReturnHandler$1 = ue;
    ...
    ce.__typeName = "tab.CrossDomainMessagingOptions", e.tab.CrossDomainMessagingOptions = ce;

    var he = function he(e, t, i) {
    ...
    de.__typeName = "tab.DataValue", de.$ctor = function (e, t, i) {
      var n = new Object();
      return n.value = null, n.formattedValue = null, n.value = e, M.isNullOrEmpty(i) ? n.formattedValue = t : n.formattedValue = i, n;
    }, e.tab.DataValue = de;
    ...
    var ge = function ge(e, t, i) {
      this.$vizSize = null, Ae.call(this, e, t), this.$vizSize = i;
    };

    ge.__typeName = "tab.FirstVizSizeKnownEvent", e.tab.FirstVizSizeKnownEvent = ge;
    ...
    _e.__typeName = "tab.ICrossDomainMessageHandler", e.tab.ICrossDomainMessageHandler = _e;

    var ve = function ve() {};

    ve.__typeName = "tab.ICrossDomainMessageRouter", e.tab.ICrossDomainMessageRouter = ve;
    ...
    Se.__typeName = "tab.Point", Se.$ctor = function (e, t) {
      var i = new Object();
    ...
    be.__typeName = "tab.SheetSize", be.$ctor = function (e, i, n) {
      var r = new Object();
    ...
    Ie.__typeName = "tab.SheetSizeFactory", Ie.createAutomatic = function () {
      ...
      var t = e.minHeight,
          ...
          s = null,
          o = null;
      return 0 === t && 0 === i ? 0 === n && 0 === r || (a = "atmost", o = Ce.$ctor(r, n)) : 0 === n && 0 === r ? (a = "atleast", s = Ce.$ctor(i, t)) : n === t && r === i && i > 0 ? (a = "exactly", s = Ce.$ctor(i, t), o = Ce.$ctor(i, t)) : (a = "range", 0 === i && 0 === r && (r = 2147483647), s = Ce.$ctor(i, t), o = Ce.$ctor(r, n)), be.$ctor(a, s, o);
    }, e.tab.SheetSizeFactory = Ie;

    var Ce = function Ce() {};

    Ce.__typeName = "tab.Size", Ce.$ctor = function (e, t) {
      var i = new Object();
    ...
    Oe.__typeName = "tab.VizSize", Oe.$ctor = function (e, t) {
      var i = new Object();
    ...
    De.__typeName = "tableauSoftware.CategoricalFilter", e.tableauSoftware.CategoricalFilter = De;
    ...
    ze.__typeName = "tableauSoftware.CustomView", e.tableauSoftware.CustomView = ze;

    var Pe = function Pe(e) {
      this._impl = null, Qe.call(this, e);
    };

    Pe.__typeName = "tableauSoftware.Dashboard", e.tableauSoftware.Dashboard = Pe;

    var xe = function xe(e, i, n) {
      if (this.$zoneInfo = null, this.$dashboard = null, this.$worksheet = null, "worksheet" === e.objectType && t.isNullOrUndefined(n)) throw U.createInternalError("worksheet parameter is required for WORKSHEET objects");
      if ("worksheet" !== e.objectType && t.isValue(n)) throw U.createInternalError("worksheet parameter should be undefined for non-WORKSHEET objects");
      this.$zoneInfo = e, this.$dashboard = i, this.$worksheet = n;
    };

    xe.__typeName = "tableauSoftware.DashboardObject", e.tableauSoftware.DashboardObject = xe;

    var Ue = function Ue(e) {
      this.$impl = null, this.$impl = e;
    };

    Ue.__typeName = "tableauSoftware.DataSource", e.tableauSoftware.DataSource = Ue;

    var Me = function Me(e) {
      this.$impl = null, this.$impl = e;
    };

    Me.__typeName = "tableauSoftware.DataTable", e.tableauSoftware.DataTable = Me;

    var Le = function Le(e, t, i, n) {
    ...
    je.__typeName = "tableauSoftware.HierarchicalFilter", e.tableauSoftware.HierarchicalFilter = je;
    ...
    Ge.__typeName = "tableauSoftware.Parameter", e.tableauSoftware.Parameter = Ge;
    ...
    Ke.__typeName = "tableauSoftware.QuantitativeFilter", e.tableauSoftware.QuantitativeFilter = Ke;
    ...
    Be.__typeName = "tableauSoftware.RelativeDateFilter", e.tableauSoftware.RelativeDateFilter = Be;
    ...
    Je.__typeName = "tableauSoftware.SheetInfo", e.tableauSoftware.SheetInfo = Je;
    ...
    Xe.__typeName = "tableauSoftware.StoryPoint", e.tableauSoftware.StoryPoint = Xe;

    var Ze = function Ze(e) {
      this._impl = null, this._impl = e;
    };

    Ze.__typeName = "tableauSoftware.StoryPointInfo", e.tableauSoftware.StoryPointInfo = Ze;

    var et = function et(e, i, n, r) {
    ...
    it.__typeName = "tableauSoftware.VizManager", it.getVizs = function () {
    ...
    nt.__typeName = "tableauSoftware.Workbook", e.tableauSoftware.Workbook = nt;
    ...
    at.__typeName = "tableauSoftware.Worksheet", e.tableauSoftware.Worksheet = at, t.initInterface(ve, a, {
      ...
      registerHandler: function registerHandler(e) {
        ...
        if (t.isValue(e.get_hostId()) || t.isValue(this.$handlers[e.get_hostId()])) throw U.createInternalError("Host '" + e.get_hostId() + "' is already registered.");
        this.$nextHandlerId++, e.set_hostId(i), this.$handlers[i] = e, e.add_customViewsListLoad(t.mkdel(this, this.$handleCustomViewsListLoad)), e.add_stateReadyForQuery(t.mkdel(this, this.$handleStateReadyForQuery));
      },
      ...
      sendCommand: function sendCommand(e) {
        return function (e, i, n) {
          ...
          if (M.hasWindowPostMessage() && !t.isNullOrUndefined(r) && !t.isNullOrUndefined(r.contentWindow)) {
            var s = v.generateNextCommandId(),
                o = this.$commandCallbacks[a];
            t.isNullOrUndefined(o) && (o = {}, this.$commandCallbacks[a] = o), o[s] = n;
            var l = n.get_commandName();

            if ("api.ShowCustomViewCommand" === l) {
              var u = this.$customViewLoadCallbacks[a];
              t.isNullOrUndefined(u) && (u = [], this.$customViewLoadCallbacks[a] = u), u.push(n);
            }

            var c = null;
            t.isValue(i) && (c = JSON.stringify(i));
            var h = new v(l, s, a, c).serialize();
            M.isPostMessageSynchronous() ? window.setTimeout(function () {
      ...
      $handleStateReadyForQuery: function $handleStateReadyForQuery(e) {
        ...
        if (!M.isNullOrEmpty(i)) for (; i.length > 0;) {
          var n = i.pop();
          t.isValue(n) && n();
        }
      },
      ...
      $handleCrossDomainResponse: function $handleCrossDomainResponse(e) {
        ...
        if (!t.isNullOrUndefined(n) && (delete i[e.get_commandId()], e.get_name() === n.get_commandName())) {
          ...
          if ("api.success" === r.get_result()) switch (n.get_successCallbackTiming()) {
            ...
            default:
              throw U.createInternalError("Unknown timing value: " + n.get_successCallbackTiming());
    ...
    }, pe), t.initClass(l, a, {}), t.initClass(u, a, {}), t.initInterface(_e, a, {
    ...
    }, pe), t.initClass(m, a, {}, pe), t.initClass(d, a, {
      get_$pairs: function get_$pairs() {
    ...
    }), t.initClass(p, a, {}, pe), t.initClass(f, a, {
    ...
    }), t.initClass($, a, {}), t.initClass(_, a, {}), t.initClass(v, a, {
    ...
    }), t.initClass(y, a, {}), t.initClass(w, a, {
      ...
      $saveAsync: function $saveAsync() {
        if (this.$isStale || t.isNullOrUndefined(this.$presModel)) throw U.create("staleDataReference", "Stale data");
        ...
        var n = C.$createCustomViewCommandReturnHandler("api.UpdateCustomViewCommand", e, t.mkdel(this, function (t) {
      ...
      $removeAsync: function $removeAsync() {
        var e = new r._Deferred(),
            i = {};
        i["api.customViewParam"] = this.$presModel;
        var n = C.$createCustomViewCommandReturnHandler("api.RemoveCustomViewCommand", e, t.mkdel(this, function (t) {
      ...
      _showAsync: function _showAsync() {
        if (this.$isStale || t.isNullOrUndefined(this.$presModel)) throw U.create("staleDataReference", "Stale data");
        return C._showCustomViewAsync(this.$workbookImpl, this.$messagingOptions, this.$presModel);
      },
      ...
      set_parentStoryPointImpl: function set_parentStoryPointImpl(e) {
        if ("story" === this.$sheetType) throw U.createInternalError("A story cannot be a child of another story.");
      ...
      changeSizeAsync: function changeSizeAsync(e) {
        if (e = D.$normalizeSheetSize(e), "worksheet" === this.$sheetType && "automatic" !== e.behavior) throw U.createInvalidSizeBehaviorOnWorksheet();
        var i = new r._Deferred();
        if (this.$size.behavior === e.behavior && "automatic" === e.behavior) return i.resolve(e), i.get_promise();
        var n = this.$processSheetSize(e),
            a = {};
        a["api.setSheetSizeName"] = this.$name, a["api.minWidth"] = n["api.minWidth"], a["api.minHeight"] = n["api.minHeight"], a["api.maxWidth"] = n["api.maxWidth"], a["api.maxHeight"] = n["api.maxHeight"];
        var s = new (t.makeGenericType(ue, [Object]))("api.SetSheetSizeCommand", 1, t.mkdel(this, function (e) {
      ...
      $processSheetSize: function $processSheetSize(e) {
        var i = null;
        if (t.isNullOrUndefined(e) || t.isNullOrUndefined(e.behavior) || "automatic" !== e.behavior && t.isNullOrUndefined(e.minSize) && t.isNullOrUndefined(e.maxSize)) throw U.createInvalidSheetSizeParam();
        var n = 0,
            r = 0,
            a = 0,
            s = 0,
        ...
        if ("automatic" === e.behavior) i = be.$ctor("automatic", void 0, void 0);else if ("atmost" === e.behavior) {
          if (t.isNullOrUndefined(e.maxSize) || t.isNullOrUndefined(e.maxSize.width) || t.isNullOrUndefined(e.maxSize.height)) throw U.createMissingMaxSize();
          if (e.maxSize.width < 0 || e.maxSize.height < 0) throw U.createInvalidSizeValue();
          o["api.maxWidth"] = e.maxSize.width, o["api.maxHeight"] = e.maxSize.height, i = be.$ctor("atmost", void 0, e.maxSize);
        } else if ("atleast" === e.behavior) {
          if (t.isNullOrUndefined(e.minSize) || t.isNullOrUndefined(e.minSize.width) || t.isNullOrUndefined(e.minSize.height)) throw U.createMissingMinSize();
          if (e.minSize.width < 0 || e.minSize.height < 0) throw U.createInvalidSizeValue();
          o["api.minWidth"] = e.minSize.width, o["api.minHeight"] = e.minSize.height, i = be.$ctor("atleast", e.minSize, void 0);
        } else if ("range" === e.behavior) {
          if (t.isNullOrUndefined(e.minSize) || t.isNullOrUndefined(e.maxSize) || t.isNullOrUndefined(e.minSize.width) || t.isNullOrUndefined(e.maxSize.width) || t.isNullOrUndefined(e.minSize.height) || t.isNullOrUndefined(e.maxSize.height)) throw U.createMissingMinMaxSize();
          if (e.minSize.width < 0 || e.minSize.height < 0 || e.maxSize.width < 0 || e.maxSize.height < 0 || e.minSize.width > e.maxSize.width || e.minSize.height > e.maxSize.height) throw U.createInvalidRangeSize();
          o["api.minWidth"] = e.minSize.width, o["api.minHeight"] = e.minSize.height, o["api.maxWidth"] = e.maxSize.width, o["api.maxHeight"] = e.maxSize.height, i = be.$ctor("range", e.minSize, e.maxSize);
          ...
          } else t.isValue(e.minSize) && t.isValue(e.minSize.width) && t.isValue(e.minSize.height) ? (a = n = e.minSize.width, s = r = e.minSize.height) : t.isValue(e.maxSize) && t.isValue(e.maxSize.width) && t.isValue(e.maxSize.height) && (n = a = e.maxSize.width, r = s = e.maxSize.height);

          o["api.minWidth"] = n, o["api.minHeight"] = r, o["api.maxWidth"] = a, o["api.maxHeight"] = s, i = be.$ctor("exactly", Ce.$ctor(n, r), Ce.$ctor(a, s));
        }
      ...
      $addObjects: function $addObjects(e, i) {
        this.$dashboardObjects = new r._Collection(), this.$worksheets = new r._Collection();
        ...
        for (var n = 0; n < e.length; n++) {
          ...
          if ("worksheet" === e[n].objectType) {
            ...
            var l = this.$worksheets.get__length(),
                ...
                p = new W(d, this.get_workbookImpl(), this.get_messagingOptions(), this);
            s = p.get_worksheet(), this.$worksheets._add(o, p.get_worksheet());
          }
      ...
      $transitionToFulfilled: function $transitionToFulfilled(e) {
        ...
        this.$thenFunc = t.then, this.$resolveFunc = u.$coerceToTrustedPromise;
    ...
    }), t.initClass(k, a, {}), t.initClass(T, a, {}), t.initClass(O, a, {
    ...
    }), t.initClass(R, a, {}, Object), t.initClass(z, a, {
      ...
      update: function update(e) {
        ...
        for (var r = 0; r < e.storyPoints.length; r++) {
          ...
          if (t.isNullOrUndefined(this.$storyPointsInfo[r])) this.$storyPointsInfo[r] = new Ze(l);else if (this.$storyPointsInfo[r]._impl.storyPointId === l.storyPointId) {
        ...
        var h = t.isNullOrUndefined(this.$activeStoryPointImpl) || this.$activeStoryPointImpl.get_storyPointId() !== n.storyPointId;
        t.isValue(this.$activeStoryPointImpl) && h && this.$activeStoryPointImpl.set_isActive(!1);
        var m = this.$activeStoryPointImpl;

        if (h) {
          var d = P.createContainedSheet(i, this.get_workbookImpl(), this.get_messagingOptions(), this.$findSheetFunc);
        ...
        h && t.isValue(m) && this.$raiseActiveStoryPointChange(this.$storyPointsInfo[m.get_index()], this.$activeStoryPointImpl.get_storyPoint());
      },
      ...
      activateStoryPointAsync: function activateStoryPointAsync(e) {
        var i = new r._Deferred();
        if (e < 0 || e >= this.$storyPointsInfo.length) throw U.createIndexOutOfRange(e);
        var n = this.get_activeStoryPointImpl(),
            a = {};
        a["api.storyPointIndex"] = e;
        var s = new (t.makeGenericType(ue, [Object]))("api.ActivateStoryPoint", 0, t.mkdel(this, function (e) {
      ...
      revertStoryPointAsync: function revertStoryPointAsync(e) {
        if ((e = e || this.$activeStoryPointImpl.get_index()) < 0 || e >= this.$storyPointsInfo.length) throw U.createIndexOutOfRange(e);
        var i = new r._Deferred(),
            n = {};
        n["api.storyPointIndex"] = e;
        var a = new (t.makeGenericType(ue, [Object]))("api.RevertStoryPoint", 0, t.mkdel(this, function (t) {
      ...
      $activatePreviousNextStoryPointAsync: function $activatePreviousNextStoryPointAsync(e) {
        if ("api.ActivatePreviousStoryPoint" !== e && "api.ActivateNextStoryPoint" !== e) throw U.createInternalError("commandName '" + e + "' is invalid.");
        var i = new r._Deferred(),
      ...
      $updateStoryPointInfo: function $updateStoryPointInfo(e, t) {
        ...
        if (i.storyPointId !== t.storyPointId) throw U.createInternalError("We should not be updating a story point where the IDs don't match. Existing storyPointID=" + i.storyPointId + ", newStoryPointID=" + t.storyPointId);
        i.caption = t.caption, i.isUpdated = t.isUpdated, t.storyPointId === this.$activeStoryPointImpl.get_storyPointId() && this.$activeStoryPointImpl.set_isUpdated(t.isUpdated);
      },
      $updateActiveState: function $updateActiveState(e, t) {
        ...
        if (e.get_index() !== i) {
          var n = this.$storyPointsInfo[e.get_index()],
              ...
              a = P.createContainedSheet(t.containedSheetInfo, this.get_workbookImpl(), this.get_messagingOptions(), this.$findSheetFunc);
          r.isActive = !0, this.$activeStoryPointImpl = new P(r, a), e.set_isActive(!1), n._impl.isActive = !1, this.$raiseActiveStoryPointChange(n, this.$activeStoryPointImpl.get_storyPoint());
        }
      },
    ...
    }), t.initClass(x, a, {}, Object), t.initClass(U, a, {}), t.initClass(M, a, {}), t.initClass(L, a, {}), t.initClass(H, a, {
      get_url: function get_url() {
      ...
      $constructUrl: function $constructUrl() {
        var e = [];
        e.push(this.get_baseUrl()), e.push("?"), this.userSuppliedParameters.length > 0 && (e.push(this.userSuppliedParameters), e.push("&")), !this.fixedSize && !(-1 !== this.userSuppliedParameters.indexOf(":size=")) && this.parentElement.clientWidth * this.parentElement.clientHeight > 0 && (e.push(":size="), e.push(this.parentElement.clientWidth + "," + this.parentElement.clientHeight), e.push("&")), e.push(":embed=y"), e.push("&:showVizHome=n"), e.push("&:jsdebug=y"), this.fixedSize || e.push("&:bootstrapWhenNotified=y"), this.tabs || e.push("&:tabs=n"), this.displayStaticImage && e.push("&:display_static_image=y"), this.toolbar ? t.isNullOrUndefined(this.toolBarPosition) || (e.push("&:toolbar="), e.push(this.toolBarPosition.toString())) : e.push("&:toolbar=n"), t.isValue(this.device) && (e.push("&:device="), e.push(this.device.toString()));
        ...
        try {
          for (; n.moveNext();) {
            var r = n.current();
            "embed" !== r.key && "height" !== r.key && "width" !== r.key && "device" !== r.key && "autoSize" !== r.key && "hideTabs" !== r.key && "hideToolbar" !== r.key && "onFirstInteractive" !== r.key && "onFirstVizSizeKnown" !== r.key && "toolbarPosition" !== r.key && "instanceIdToClone" !== r.key && "display_static_image" !== r.key && (e.push("&"), e.push(encodeURIComponent(r.key)), e.push("="), e.push(encodeURIComponent(r.value.toString())));
          }
        } finally {
          n.dispose();
        }
      ...
      _setActiveSheetAsync: function _setActiveSheetAsync(e) {
        if (M.isNumber(e)) {
          var i = e;
          if (i < this.$publishedSheetsInfo.get__length() && i >= 0) return this.$activateSheetWithInfoAsync(this.$publishedSheetsInfo.get_item(i).$impl);
        ...
        if (this.$activeSheetImpl.get_isDashboard()) {
          ...
          if (t.isValue(a)) {
            ...
            var s = "";
            return a.getIsHidden() ? this.$activatingHiddenSheetImpl = a._impl : s = a._impl.get_url(), this.$activateSheetInternalAsync(a._impl.get_name(), s);
          }
        }
      ...
      $activateSheetInternalAsync: function $activateSheetInternalAsync(e, i) {
        var n = new r._Deferred();
        if (t.isValue(this.$activeSheetImpl) && t.referenceEquals(e, this.$activeSheetImpl.get_name())) return n.resolve(this.$activeSheetImpl.get_sheet()), n.get_promise();
        var a = {};
        a["api.switchToSheetName"] = e, a["api.switchToRepositoryUrl"] = i, a["api.oldRepositoryUrl"] = this.$activeSheetImpl.get_url();
        var s = new (t.makeGenericType(ue, [Object]))("api.SwitchActiveSheetCommand", 0, t.mkdel(this, function (e) {
      ...
      _updateActiveSheetAsync: function _updateActiveSheetAsync() {
        var e = new r._Deferred(),
            i = {};
        i["api.switchToSheetName"] = this.$activeSheetImpl.get_name(), i["api.switchToRepositoryUrl"] = this.$activeSheetImpl.get_url(), i["api.oldRepositoryUrl"] = this.$activeSheetImpl.get_url();
        var n = new (t.makeGenericType(ue, [Object]))("api.UpdateActiveSheetCommand", 0, t.mkdel(this, function (t) {
      ...
      $initializeActiveSheet: function $initializeActiveSheet(e) {
        ...
        if (t.isNullOrUndefined(n) && t.isNullOrUndefined(this.$activatingHiddenSheetImpl)) throw U.createInternalError("The active sheet was not specified in baseSheets");

        if (!t.isValue(this.$activeSheetImpl) || !t.referenceEquals(this.$activeSheetImpl.get_name(), i)) {
          if (t.isValue(this.$activeSheetImpl)) {
            this.$activeSheetImpl.set_isActive(!1);

            var r = this.$publishedSheetsInfo._get(this.$activeSheetImpl.get_name());

            if (t.isValue(r) && (r.$impl.isActive = !1), "story" === this.$activeSheetImpl.get_sheetType()) t.cast(this.$activeSheetImpl, z).remove_activeStoryPointChange(t.mkdel(this.$vizImpl, this.$vizImpl.raiseStoryPointSwitch));
          }

          if (t.isValue(this.$activatingHiddenSheetImpl)) {
            var a = R.$ctor(this.$activatingHiddenSheetImpl.get_name(), "worksheet", -1, this.$activatingHiddenSheetImpl.get_size(), this.get_workbook(), "", !0, !0, D.noZoneId);
            this.$activatingHiddenSheetImpl = null, this.$activeSheetImpl = new W(a, this, this.$messagingOptions, null);
          } else {
            ...
            if (t.isNullOrUndefined(s)) throw U.createInternalError("No base sheet was found corresponding to the active sheet.");
            ...
            if ("dashboard" === s.sheetType) {
              ...
              var m = new z(n.$impl, this, this.$messagingOptions, e.story, u);
              this.$activeSheetImpl = m, m.add_activeStoryPointChange(t.mkdel(this.$vizImpl, this.$vizImpl.raiseStoryPointSwitch));
            } else this.$activeSheetImpl = new W(n.$impl, this, this.$messagingOptions, null);
      ...
      $createSheetsInfo: function $createSheetsInfo(e) {
        ...
        if (!t.isNullOrUndefined(i)) for (var n = 0; n < i.length; n++) {
          var r = i[n],
              a = r.name,
          ...
          if (t.isNullOrUndefined(s)) {
            var l = t.referenceEquals(a, e.currentSheetName),
                ...
                c = R.$ctor(a, u, n, o, this.get_workbook(), r.repositoryUrl, l, !1, D.noZoneId);
      ...
      $showCustomViewAsync: function $showCustomViewAsync(e) {
        if (t.isNullOrUndefined(e) || M.isNullOrEmpty(e)) return C._showCustomViewAsync(this, this.$messagingOptions, null);
      ...
      $removeCustomViewAsync: function $removeCustomViewAsync(e) {
        if (M.isNullOrEmpty(e)) throw U.createNullOrEmptyParameter("customViewName");
      ...
      $rememberCustomViewAsync: function $rememberCustomViewAsync(e) {
        if (M.isNullOrEmpty(e)) throw U.createInvalidParameter("customViewName");
      ...
      $getSingleParameterAsync: function $getSingleParameterAsync(e) {
        var i = new r._Deferred();
        if (t.isValue(this.$lastChangedParameterImpl)) return i.resolve(this.$lastChangedParameterImpl.get_$parameter()), i.get_promise();
        var n = new (t.makeGenericType(ue, [Object]))("api.FetchParametersCommand", 0, t.mkdel(this, function (t) {
          var n = j.$findAndCreateParameterImpl(e, t);
          this.$lastChangedParameterImpl = n, i.resolve(n.get_$parameter());
        }), function (e, t) {
          i.reject(U.createServerError(t));
        });
      ...
      $changeParameterValueAsync: function $changeParameterValueAsync(e, i) {
        ...
        if (t.isValue(this.$parameters)) {
          if (t.isNullOrUndefined(this.$parameters._get(e))) return n.reject(U.createInvalidParameter(e)), n.get_promise();
          if (a = this.$parameters._get(e)._impl, t.isNullOrUndefined(a)) return n.reject(U.createInvalidParameter(e)), n.get_promise();
        }

        var s = {};

        if (s["api.setParameterName"] = t.isValue(this.$parameters) ? a.get_$name() : e, t.isValue(i) && M.isDate(i)) {
          var o = t.cast(i, t.JsDate),
              l = M.serializeDateForServer(o);
          s["api.setParameterValue"] = l;
        } else s["api.setParameterValue"] = t.isValue(i) ? i.toString() : null;

        this.$lastChangedParameterImpl = null;
        var u = new (t.makeGenericType(ue, [Object]))("api.SetParameterValueCommand", 0, t.mkdel(this, function (i) {
          if (t.isNullOrUndefined(i)) n.reject(U.create("serverError", "server error"));else if (i.isValidPresModel) {
            var r = new g(i);
            this.$lastChangedParameterImpl = r, n.resolve(r.get_$parameter());
      ...
      $getDataSourcesAsync: function $getDataSourcesAsync() {
        ...
        var n = new (t.makeGenericType(ue, [Object]))("api.GetDataSourcesCommand", 0, function (t) {
      ...
      $getDataSourceAsync: function $getDataSourceAsync(e) {
        ...
        var i = new r._Deferred(),
            n = {};
        n["api.dataSourceName"] = e, n["api.worksheetName"] = this.get_name();
        var a = new (t.makeGenericType(ue, [Object]))("api.GetDataSourceCommand", 0, function (n) {
          var r = E.processDataSource(n);
          t.isValue(r) ? i.resolve(r.get_dataSource()) : i.reject(U.createServerError("Data source '" + e + "' not found"));
        }, function (e, t) {
          i.reject(U.createServerError(t));
        });
        return this.sendCommand(Object).call(this, n, a), i.get_promise();
      ...
      $verifyActiveSheetOrEmbeddedInActiveDashboard: function $verifyActiveSheetOrEmbeddedInActiveDashboard() {
        var e = this.get_isActive(),
            ...
            n = t.isValue(this.get_parentStoryPointImpl()) && this.get_parentStoryPointImpl().get_parentStoryImpl().get_isActive();
      ...
      $getFilterAsync: function $getFilterAsync(e, i, n) {
        if (!M.isNullOrEmpty(e) && !M.isNullOrEmpty(i)) throw U.createInternalError("Only fieldName OR fieldCaption is allowed, not both.");
        n = n || new Object();
        var a = new r._Deferred(),
            s = {};
        this.$addVisualIdToCommand(s), !M.isNullOrEmpty(i) && M.isNullOrEmpty(e) && (s["api.fieldCaption"] = i), M.isNullOrEmpty(e) || (s["api.fieldName"] = e), s["api.filterHierarchicalLevels"] = 0, s["api.ignoreDomain"] = n.ignoreDomain || !1;
        var o = new (t.makeGenericType(ue, [Object]))("api.GetOneFilterInfoCommand", 0, t.mkdel(this, function (e) {
      ...
      $getFiltersAsync: function $getFiltersAsync(e) {
        ...
        var i = new r._Deferred(),
            n = {};
        this.$addVisualIdToCommand(n), n["api.ignoreDomain"] = e.ignoreDomain || !1;
        var a = new (t.makeGenericType(ue, [Object]))("api.GetFiltersListCommand", 0, t.mkdel(this, function (e) {
      ...
      $applyHierarchicalFilterAsync: function $applyHierarchicalFilterAsync(e, i, n, r) {
        if (t.isNullOrUndefined(i) && "all" !== n) throw U.createInvalidParameter("values");
        return this.$applyHierarchicalFilterInternalAsync(e, i, n, r);
      },
      $clearFilterInternalAsync: function $clearFilterInternalAsync(e) {
        if (this.$verifyActiveSheetOrEmbeddedInActiveDashboard(), M.isNullOrEmpty(e)) throw U.createNullOrEmptyParameter("fieldName");
        var t = new r._Deferred(),
            i = {};
        i["api.fieldCaption"] = e, this.$addVisualIdToCommand(i);
        var n = W.$createFilterCommandReturnHandler("api.ClearFilterCommand", e, t);
      ...
      $applyFilterWithValuesInternalAsync: function $applyFilterWithValuesInternalAsync(e, i, n, a) {
        ...
        var s = [];
        if (k.isArray(i)) for (var o = 0; o < i.length; o++) {
          s.push(i[o].toString());
        } else t.isValue(i) && s.push(i.toString());
        var l = new r._Deferred(),
            u = {};
        u["api.fieldCaption"] = e, u["api.filterUpdateType"] = n, u["api.exclude"] = !(!t.isValue(a) || !a.isExcludeMode), "all" !== n && (u["api.filterCategoricalValues"] = s), this.$addVisualIdToCommand(u);
        var c = W.$createFilterCommandReturnHandler("api.ApplyCategoricalFilterCommand", e, l);
      ...
      $applyRangeFilterInternalAsync: function $applyRangeFilterInternalAsync(e, i) {
        if (this.$verifyActiveSheetOrEmbeddedInActiveDashboard(), M.isNullOrEmpty(e)) throw U.createNullOrEmptyParameter("fieldName");
        if (t.isNullOrUndefined(i)) throw U.createNullOrEmptyParameter("filterOptions");
        var n = {};
        if (n["api.fieldCaption"] = e, t.isValue(i.min)) if (M.isDate(i.min)) {
          var a = t.cast(i.min, t.JsDate);
          if (!M.isDateValid(a)) throw U.createInvalidDateParameter("filterOptions.min");
          n["api.filterRangeMin"] = M.serializeDateForServer(a);
        } else n["api.filterRangeMin"] = i.min;
        if (t.isValue(i.max)) if (M.isDate(i.max)) {
          var s = t.cast(i.max, t.JsDate);
          if (!M.isDateValid(s)) throw U.createInvalidDateParameter("filterOptions.max");
          n["api.filterRangeMax"] = M.serializeDateForServer(s);
        } else n["api.filterRangeMax"] = i.max;
        t.isValue(i.nullOption) && (n["api.filterRangeNullOption"] = i.nullOption), this.$addVisualIdToCommand(n);
        var o = new r._Deferred(),
            l = W.$createFilterCommandReturnHandler("api.ApplyRangeFilterCommand", e, o);
      ...
      $applyRelativeDateFilterInternalAsync: function $applyRelativeDateFilterInternalAsync(e, i) {
        if (this.$verifyActiveSheetOrEmbeddedInActiveDashboard(), M.isNullOrEmpty(e)) throw U.createInvalidParameter("fieldName");
        if (t.isNullOrUndefined(i)) throw U.createInvalidParameter("filterOptions");
        var n = {};
        ...
        if (n["api.fieldCaption"] = e, t.isValue(i)) {
          if (n["api.filterPeriodType"] = i.periodType, n["api.filterDateRangeType"] = i.rangeType, "lastn" === i.rangeType || "nextn" === i.rangeType) {
            if (t.isNullOrUndefined(i.rangeN)) throw U.create("missingRangeNForRelativeDateFilters", "Missing rangeN field for a relative date filter of LASTN or NEXTN.");
        ...
        var a = new r._Deferred(),
            s = W.$createFilterCommandReturnHandler("api.ApplyRelativeDateFilterCommand", e, a);
      ...
      $applyHierarchicalFilterInternalAsync: function $applyHierarchicalFilterInternalAsync(e, i, n, a) {
        ...
        if (k.isArray(i)) {
          ...
          for (var l = i, u = 0; u < l.length; u++) {
            s.push(l[u].toString());
          }
        } else if (M.isString(i)) (s = []).push(i.toString());else if (t.isValue(i) && t.isValue(i.levels)) {
          var c = i.levels;
          if (o = [], k.isArray(c)) for (var h = c, m = 0; m < h.length; m++) {
            o.push(h[m].toString());
          } else o.push(c.toString());
        } else if (t.isValue(i)) throw U.createInvalidParameter("values");

        var d = {};
        d["api.fieldCaption"] = e, d["api.filterUpdateType"] = n, d["api.exclude"] = !(!t.isValue(a) || !a.isExcludeMode), t.isValue(s) && (d["api.filterHierarchicalValues"] = JSON.stringify(s)), t.isValue(o) && (d["api.filterHierarchicalLevels"] = JSON.stringify(o)), this.$addVisualIdToCommand(d);
        var p = new r._Deferred(),
            f = W.$createFilterCommandReturnHandler("api.ApplyHierarchicalFilterCommand", e, p);
      ...
      $clearSelectedMarksAsync: function $clearSelectedMarksAsync() {
        ...
        var n = new (t.makeGenericType(ue, [Object]))("api.ClearSelectedMarksCommand", 1, function (t) {
          e.resolve();
        }, function (t, i) {
          e.reject(U.createServerError(i));
        });
      ...
      $getSelectedMarksAsync: function $getSelectedMarksAsync() {
        ...
        var e = new r._Deferred(),
            i = {};
        this.$addVisualIdToCommand(i);
        var n = new (t.makeGenericType(ue, [Object]))("api.FetchSelectedMarksCommand", 0, t.mkdel(this, function (t) {
      ...
      $selectMarksWithMultiDimOptionAsync: function $selectMarksWithMultiDimOptionAsync(e, i) {
        ...
        try {
          for (; c.moveNext();) {
            var h = c.current();
            e.hasOwnProperty(h.key) && (k.isFunction(n[h.key]) || this.$parseMarksParam(r, a, s, o, l, u, h.key, h.value));
          }
        } finally {
          c.dispose();
        }
      ...
      $selectMarksWithMarksArrayAsync: function $selectMarksWithMarksArrayAsync(e, i) {
        for (var n = [], r = [], a = [], s = [], o = [], l = [], u = [], c = 0; c < e.length; c++) {
          var h = e[c];
          if (t.isValue(h.$impl.get_$tupleId()) && h.$impl.get_$tupleId() > 0) u.push(h.$impl.get_$tupleId());else for (var m = h.$impl.get_$pairs(), d = 0; d < m.get__length(); d++) {
            var p = m.get_item(d);
            p.hasOwnProperty("fieldName") && p.hasOwnProperty("value") && !k.isFunction(p.fieldName) && !k.isFunction(p.value) && this.$parseMarksParam(n, r, a, s, o, l, p.fieldName, p.value);
          }
        }
      ...
      $parseMarksParam: function $parseMarksParam(e, i, n, r, a, s, o, l) {
        var u = l;
        if (W.$regexHierarchicalFieldName.test(o)) this.$addToParamLists(n, r, o, l);else if (t.isValue(u.min) || t.isValue(u.max)) {
          var c = new Object();
          if (t.isValue(u.min)) if (M.isDate(u.min)) {
            var h = t.cast(u.min, t.JsDate);
            if (!M.isDateValid(h)) throw U.createInvalidDateParameter("options.min");
            c.min = M.serializeDateForServer(h);
          } else c.min = u.min;
          if (t.isValue(u.max)) if (M.isDate(u.max)) {
            var m = t.cast(u.max, t.JsDate);
            if (!M.isDateValid(m)) throw U.createInvalidDateParameter("options.max");
            c.max = M.serializeDateForServer(m);
          } else c.max = u.max;

          if (t.isValue(u.nullOption)) {
            var d = $.$normalizeEnum(ee).call(null, u.nullOption, "options.nullOption");
            c.nullOption = d;
      ...
      $addToParamLists: function $addToParamLists(e, i, n, r) {
        var a = [];
        if (k.isArray(r)) for (var s = t.cast(r, Array), o = 0; o < s.length; o++) {
          a.push(s[o].toString());
      ...
      $selectMarksWithValuesAsync: function $selectMarksWithValuesAsync(e, i, n, a, s, o, l, u) {
        ...
        if (this.$addVisualIdToCommand(c), u = $.$normalizeEnum(re).call(null, u, "updateType"), c["api.filterUpdateType"] = u, M.isNullOrEmpty(e) || (c["api.tupleIds"] = JSON.stringify(e)), !M.isNullOrEmpty(i) && !M.isNullOrEmpty(n)) {
        ...
        if (M.isNullOrEmpty(c["api.tupleIds"]) && M.isNullOrEmpty(c["api.categoricalFieldCaption"]) && M.isNullOrEmpty(c["api.hierarchicalFieldCaption"]) && M.isNullOrEmpty(c["api.rangeFieldCaption"])) throw U.createInvalidParameter("fieldNameOrFieldValuesMap");
      ...
      $getSummaryDataAsync: function $getSummaryDataAsync(e) {
        ...
        var i = new r._Deferred(),
            n = {};
        this.$addVisualIdToCommand(n), e = e || new Object(), n["api.ignoreAliases"] = t.coalesce(e.ignoreAliases, !1), n["api.ignoreSelection"] = t.coalesce(e.ignoreSelection, !1), n["api.maxRows"] = t.coalesce(e.maxRows, 0);
        var a = new (t.makeGenericType(ue, [Object]))("api.GetSummaryTableCommand", 0, function (e) {
      ...
      $getUnderlyingDataAsync: function $getUnderlyingDataAsync(e) {
        ...
        var i = new r._Deferred(),
            n = {};
        this.$addVisualIdToCommand(n), e = e || new Object(), n["api.ignoreAliases"] = t.coalesce(e.ignoreAliases, !1), n["api.ignoreSelection"] = t.coalesce(e.ignoreSelection, !1), n["api.includeAllColumns"] = t.coalesce(e.includeAllColumns, !1), n["api.maxRows"] = t.coalesce(e.maxRows, 0);
        var a = new (t.makeGenericType(ue, [Object]))("api.GetUnderlyingTableCommand", 0, function (e) {
          var t = A.processGetDataPresModel(e);
          i.resolve(t);
        }, function (e, t) {
          i.reject(U.createServerError(t));
      ...
      $clearHighlightedMarksAsync: function $clearHighlightedMarksAsync() {
        ...
        var e = new r._Deferred(),
            i = {};
        this.$addVisualIdToCommand(i);
        var n = new (t.makeGenericType(ue, [Object]))("api.ClearHighlightedMarksCommand", 1, function (t) {
          e.resolve();
        }, function (t, i) {
          e.reject(U.createServerError(i));
        });
      ...
      $highlightMarksAsync: function $highlightMarksAsync(e, i) {
        T.verifyString(e, "fieldName"), this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
        var n = new r._Deferred(),
            a = {};
        a["api.fieldCaption"] = e, a["api.ObjectTextIDs"] = i, this.$addVisualIdToCommand(a);
        var s = new (t.makeGenericType(ue, [Object]))("api.HighlightMarksCommand", 0, function (e) {
          n.resolve();
        }, function (e, t) {
          n.reject(U.createServerError(t));
        });
      ...
      $highlightMarksByPatternMatchAsync: function $highlightMarksByPatternMatchAsync(e, i) {
        T.verifyString(e, "fieldName"), T.verifyString(i, "patternMatch"), this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
        var n = new r._Deferred(),
            a = {
          "api.filterUpdateType": "replace"
        };
        a["api.fieldCaption"] = e, a["api.Pattern"] = i, this.$addVisualIdToCommand(a);
        var s = new (t.makeGenericType(ue, [Object]))("api.HighlightMarksByPatternMatch", 0, function (e) {
          n.resolve();
        }, function (e, t) {
          n.reject(U.createServerError(t));
        });
      ...
      $getHighlightedMarksAsync: function $getHighlightedMarksAsync() {
        ...
        var e = new r._Deferred(),
            i = {};
        this.$addVisualIdToCommand(i);
        var n = new (t.makeGenericType(ue, [Object]))("api.FetchHighlightedMarksCommand", 0, t.mkdel(this, function (t) {
      ...
      tablet: "tablet",
      phone: "phone"
    }, !0), t.initClass(B, a, {}), t.initEnum(Q, a, {
      ...
      getCustomViewAsync: function getCustomViewAsync() {
        var e = new r._Deferred(),
            i = null;
        return t.isValue(this.$context.get__customViewImpl()) && (i = this.$context.get__customViewImpl().get_$customView()), e.resolve(i), e.get_promise();
      }
    }, Ae), t.initEnum(me, a, {
      float: "float",
      integer: "integer",
      ...
      date: "date",
      datetime: "datetime"
    }, !0), t.initClass(de, a, {}, Object), t.initClass(Fe, a, {
      ...
      getMarksAsync: function getMarksAsync() {
        ...
        return t.isValue(e.get_selectedMarks()) ? new r._Deferred().resolve(e.get_selectedMarks()._toApiCollection()) : e.$getSelectedMarksAsync();
      }
    }, Fe), t.initClass(we, a, {
    ...
    }, Ae), t.initClass(Se, a, {}, Object), t.initClass(be, a, {}, Object), t.initClass(Ie, a, {}), t.initClass(Ce, a, {}, Object), t.initClass(Ne, a, {}), t.initClass(Ee, a, {
      ...
      $calculateFrameSize: function $calculateFrameSize(e) {
        var t,
            ...
            o = 0,
            l = 0;
        if ("exactly" === s.behavior) o = s.maxSize.width, l = s.maxSize.height + a;else switch (s.behavior) {
          case "range":
            t = s.minSize.width, i = s.maxSize.width, n = s.minSize.height + a, r = s.maxSize.height + a, o = Math.max(t, Math.min(i, e.width)), l = Math.max(n, Math.min(r, e.height));
            break;

          case "atleast":
            t = s.minSize.width, n = s.minSize.height + a, o = Math.max(t, e.width), l = Math.max(n, e.height);
            break;

          case "atmost":
            i = s.maxSize.width, r = s.maxSize.height + a, o = Math.min(i, e.width), l = Math.min(r, e.height);
            break;
          ...
          default:
            throw U.createInternalError("Unknown SheetSizeBehavior for viz: " + s.behavior.toString());
        }
        return Ce.$ctor(o, l);
      },
      $getNewFrameSize: function $getNewFrameSize() {
        var e;
        return t.isValue(this.$initialAvailableSize) ? (e = this.$initialAvailableSize, this.$initialAvailableSize = null) : e = M.computeContentSize(this.get_$parentElement()), this.$raiseVizResizeEvent(e), this.$calculateFrameSize(e);
      },
        ...
        if (t.isValue(this.$vizSize)) {
          ...
          if (e.height !== this.$vizSize.chromeHeight) {
            ...
            for (var i = 0; i < 10; i++) {
              ...
              if (t.referenceEquals(JSON.stringify(e), JSON.stringify(n))) return;
      ...
      addEventListener: function addEventListener(e, i) {
        var n = {};
        if (!$.$tryNormalizeEnum(oe).call(null, e, n)) throw U.createUnsupportedEventName(e.toString());
      ...
      $showDownloadWorkbookDialog: function $showDownloadWorkbookDialog() {
        if (!this.get__workbookImpl().get_isDownloadAllowed()) throw U.create("downloadWorkbookNotAllowed", "Download workbook is not allowed");
      ...
      $sendVisibleRect: function $sendVisibleRect() {
        ...
        var e = M.visibleContentRectInDocumentCoordinates(this.get_iframe()),
            ...
            n = [];
        n.push("layoutInfoResp".toString()), n.push(e.left - i.left), n.push(e.top - i.top), n.push(e.width), n.push(e.height), this.$iframe.contentWindow.postMessage(n.join(","), "*");
      },
      ...
      $verifyOperationAllowedOnActiveSheetOrSheetWithinActiveDashboard: function $verifyOperationAllowedOnActiveSheetOrSheetWithinActiveDashboard(e) {
        if (t.isNullOrUndefined(e)) return null;
        var i = this.$workbookImpl.$findActiveSheetOrSheetWithinActiveDashboard(e);
      ...
      $invokeAutomaticUpdatesCommandAsync: function $invokeAutomaticUpdatesCommandAsync(e) {
        if ("pauseAutomaticUpdates" !== e && "resumeAutomaticUpdates" !== e && "toggleAutomaticUpdates" !== e) throw U.createInternalError(null);
        var i = {};
      ...
      $invokeCommand: function $invokeCommand(e, i) {
        if ("showExportImageDialog" !== e && "showExportDataDialog" !== e && "showExportCrosstabDialog" !== e && "showExportPDFDialog" !== e && "showShareDialog" !== e && "showDownloadWorkbookDialog" !== e) throw U.createInternalError(null);
        var n = {};
        n["api.invokeCommandName"] = e, t.isValue(i) && (n["api.invokeCommandParam"] = i);
        var r = new (t.makeGenericType(ue, [Object]))("api.InvokeCommandCommand", 0, null, null);
      ...
      $handleMarksSelectionChangedEvent: function $handleMarksSelectionChangedEvent(e) {
        if (!t.staticEquals(this.$1$MarksSelectionField, null) && t.referenceEquals(this.$workbookImpl.get_name(), e.get_workbookName())) {
          ...
          if (n.get_isStory() && (n = t.cast(n, z).get_activeStoryPointImpl().get_containedSheetImpl()), t.referenceEquals(n.get_name(), e.get_worksheetName())) i = t.cast(n, W);else if (n.get_isDashboard()) {
      ...
      $handleFilterChangedEvent: function $handleFilterChangedEvent(e) {
        if (!t.staticEquals(this.$1$FilterChangeField, null) && t.referenceEquals(this.$workbookImpl.get_name(), e.get_workbookName())) {
          var i = null,
              n = this.$workbookImpl.get_activeSheetImpl();
          if (t.referenceEquals(n.get_name(), e.get_worksheetName())) i = t.cast(n, W);else if (n.get_isDashboard()) {
            i = t.cast(n, N).get_worksheets()._get(e.get_worksheetName())._impl;
          } else if (n.get_isStory()) {
            var r = t.cast(n, z).get_activeStoryPointImpl().get_containedSheetImpl();
            if (r.get_isDashboard()) i = t.cast(r, N).get_worksheets()._get(e.get_worksheetName())._impl;else t.referenceEquals(r.get_name(), e.get_worksheetName()) && (i = t.cast(r, W));
          }
          ...
          if (t.isValue(i)) {
            var a = t.cast(JSON.parse(t.cast(e.get_data(), String)), Array),
                s = a[0],
                o = a[1];
            this.$1$FilterChangeField(new fe("filterchange", this.$viz, i, s, o));
          }
        }
      },
      ...
      $handleCustomViewSetDefaultEvent: function $handleCustomViewSetDefaultEvent(e) {
        var i = JSON.parse(t.cast(e.get_data(), String));
        if (t.isValue(this.$workbookImpl) && C._processCustomViews(this.$workbookImpl, this.$messagingOptions, i), !t.staticEquals(this.$1$CustomViewSetDefaultField, null) && t.isValue(i.defaultCustomViewId)) for (var n = this.$workbookImpl.get_$customViews(), r = 0; r < n.get__length(); r++) {
          var a = n.get_item(r);
      ...
      $ensureCalledAfterFirstInteractive: function $ensureCalledAfterFirstInteractive(e) {
        ...
        (n = t.mkdel(this, function () {
          ...
          if (this.$onFirstInteractiveAlreadyCalled) e();else {
            if (t - i > 3e5) throw U.createInternalError("Timed out while waiting for the viz to become interactive");
      ...
      $createStaticImageElement: function $createStaticImageElement(e) {
        var i = document.createElement("div"),
            n = t.cast(i, t.isValue(i) && t.isInstanceOfType(i, Element) && "DIV" === i.tagName);
        return n.style.background = "transparent url('" + this.$parameters.staticImageUrl + "') no-repeat scroll 0 0", n.style.left = "8px", n.style.top = this.$parameters.tabs ? "31px" : "9px", n.style.position = "absolute", n.style.width = e.width + "px", n.style.height = e.height + "px", this.$contentRootElement().appendChild(n), n;
      },
      $createIframe: function $createIframe() {
        if (t.isNullOrUndefined(this.$contentRootElement())) return null;
        var e = document.createElement("IFrame"),
            i = t.cast(e, t.isValue(e) && t.isInstanceOfType(e, Element) && "IFRAME" === e.tagName);
        return i.frameBorder = "0", i.setAttribute("allowTransparency", "true"), i.setAttribute("allowFullScreen", "true"), i.setAttribute("title", this.$getLocalizedTitle()), i.marginHeight = "0", i.marginWidth = "0", i.style.display = "block", this.$parameters.fixedSize ? (i.style.width = this.$parameters.width, i.style.height = this.$parameters.height) : (i.style.width = "1px", i.style.height = "1px", i.setAttribute("scrolling", "no")), M.isSafari() && i.addEventListener("mousewheel", t.mkdel(this, this.$onIframeMouseWheel), !1), this.$contentRootElement().appendChild(i), i;
      },
      ...
      $handleInitialVizSize: function $handleInitialVizSize(e) {
        ...
        this.$vizSize = Oe.$ctor(i, e.chromeHeight), t.isValue(this.$onFirstVizSizeKnownCallback) && this.$onFirstVizSizeKnownCallback(new ge("firstvizsizeknown", this.$viz, this.$vizSize)), this.$parameters.fixedSize || (this.$refreshSize(), this.$addWindowResizeHandler(), this.$show());
      },
    ...
    }, null, [_e]), t.initClass(Te, a, {
      getAvailableSize: function getAvailableSize() {
        return this.$availableSize;
      }
    }, Ae), t.initClass(Oe, a, {}, Object), t.initClass(He, a, {
    ...
    }), t.initClass(qe, a, {}), t.initClass(Ge, a, {
      getName: function getName() {
        return this._impl.get_$name();
      },
      ...
      setFrameSize: function setFrameSize(e, t) {
        var i = e,
            n = t;
        M.isNumber(e) && (i = e.toString() + "px"), M.isNumber(t) && (n = t.toString() + "px"), this._impl.$setFrameSizeAndUpdate(i, n);
      }
    }), t.initClass(it, a, {}), t.initClass(nt, a, {
      getViz: function getViz() {
      ...
      TOP: "top",
      BOTTOM: "bottom"
    }, y.$creationRegistry = null, y.$singletonInstanceRegistry = null, D.noZoneId = 4294967295, W.$regexHierarchicalFieldName = new RegExp("\\[[^\\]]+\\]\\.", "g"), et.$currentVersion = new et(2, 1, 2, "null");
