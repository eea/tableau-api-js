...
!function () {
  ...
  !function (e) {
    ...
    var E = a.Exception = a.mkType(a, "ss.Exception", function (e, t) {
    ...
    a.initClass(F, O);
    var R = a.ArgumentOutOfRangeException = a.mkType(a, "ss.ArgumentOutOfRangeException", function (e, t, i, n) {
      t || (t = "Value is out of range.", e && (t += "\nParameter name: " + e)), O.call(this, t, e, i), this.actualValue = n || null;
    });
    a.initClass(R, O);
    var D = a.FormatException = a.mkType(a, "ss.FormatException", function (e, t) {
      E.call(this, e || "Invalid format.", t);
    });
    a.initClass(D, E);
    var z = a.ArithmeticException = a.mkType(a, "ss.ArithmeticException", function (e, t) {
      E.call(this, e || "Overflow or underflow in the arithmetic operation.", t);
    });
    a.initClass(z, E);
    var x = a.OverflowException = a.mkType(a, "ss.OverflowException", function (e, t) {
      z.call(this, e || "Arithmetic operation resulted in an overflow.", t);
    });
    a.initClass(x, z);
    var P = a.DivideByZeroException = a.mkType(a, "ss.DivideByZeroException", function (e, t) {
  ...
  function () {
    ...
    var r = t.mkType(n, "tab.$DeferredUtil", null, null, {
      $coerceToTrustedPromise: function $coerceToTrustedPromise(e) {
        var i;
        if (e instanceof tableauSoftware.Promise) i = t.cast(e, g);else if (t.isValue(e) && "function" == typeof e.valueOf && (e = e.valueOf()), r.$isPromise(e)) {
          var n = new d();
          t.cast(e, g).then(t.mkdel(n, n.resolve), t.mkdel(n, n.reject)), i = n.get_promise();
        } else i = r.$resolved(e);
        return i;
      },
      ...
      parse: function parse(e) {
        ...
        if (r < 0) return i = t.cast(e, String), new s(i, null, null, null);
        i = t.cast(e.substr(0, r), String);
        var a,
            o = e.substr(r + 1);
        if ((r = o.indexOf(String.fromCharCode(44))) < 0) return new s(i, n = o, null, null);
        n = o.substr(0, r);
        var l = o.substr(r + 1);
        if ((r = l.indexOf(String.fromCharCode(44))) < 0) return new s(i, n, a = l, null);
        a = l.substr(0, r);
        var u = l.substr(r + 1);
        return s.lastResponseMessage = e, "api.GetClientInfoCommand" === i && (s.lastClientInfoResponseMessage = e), new s(i, n, a, u);
      }
    }),
        o = e.tab._ApiObjectRegistry = t.mkType(n, "tab._ApiObjectRegistry", null, null, {
      ...
      $createType: function $createType(e) {
        return function () {
          ...
          if (t.isNullOrUndefined(n)) throw v.createInternalError("No creation function has been registered for interface type '" + i + "'.");
          return n();
        };
      },
      $getSingleton: function $getSingleton(e) {
        return function () {
          var i = window._ApiObjectRegistryGlobalState.singletonInstanceRegistry,
              ...
              r = t.cast(i[n], e);
          return t.isNullOrUndefined(r) && (r = o.$createType(e).call(null), i[n] = r), r;
        };
      },
      ...
      $transitionToFulfilled: function $transitionToFulfilled(e) {
        ...
        this.$thenFunc = t.then, this.$resolveFunc = r.$coerceToTrustedPromise;
      ...
      parseJSON: function parseJSON(e) {
        ...
        if (e = p.trim(e), t.isValue(JSON) && t.isValue(JSON.parse)) return JSON.parse(e);
        if (p.$rvalidchars.test(e.replace(p.$rvalidescape, "@").replace(p.$rvalidtokens, "]").replace(p.$rvalidbraces, ""))) return new Function("return " + e)();
      ...
      intersect: function intersect(e) {
        ...
        return n <= t || r <= i ? new $(0, 0, 0, 0) : new $(t, i, n - t, r - i);
      }
    }),
        v = e.tab._TableauException = t.mkType(n, "tab._TableauException", null, null, {
      ...
      elementToString: function elementToString(e) {
        ...
        if (i.append(e.tagName.toLowerCase()), y.isNullOrEmpty(e.id) || i.append("#").append(e.id), !y.isNullOrEmpty(e.className)) {
      ...
      visibleContentRectInDocumentCoordinates: function visibleContentRectInDocumentCoordinates(e) {
        for (var i = y.contentRectInDocumentCoordinates(e), n = e.parentElement; t.isValue(n) && t.isValue(n.parentElement); n = n.parentElement) {
          ...
          "auto" !== r && "scroll" !== r && "hidden" !== r || (i = i.intersect(y.contentRectInDocumentCoordinates(n)));
        }
      ...
      getVisualViewportRect: function getVisualViewportRect(e) {
        ...
        return t.isValue(i) ? new $(t.trunc(i.pageLeft), t.trunc(i.pageTop), t.trunc(i.width), t.trunc(i.height)) : null;
      },
      $getViewportRect: function $getViewportRect() {
        var e = y.getVisualViewportRect(window.self);
        if (t.isValue(e)) return e;
        var n = y.contentRectInDocumentCoordinates(document.documentElement),
      ...
      serializeDateForServer: function serializeDateForServer(e) {
        var i = "";
        t.isValue(e) && y.isDate(e) && (i = e.getUTCFullYear() + "-" + (e.getUTCMonth() + 1) + "-" + e.getUTCDate() + " " + e.getUTCHours() + ":" + e.getUTCMinutes() + ":" + e.getUTCSeconds());
        return i;
      },
      ...
      second: "second"
        ...
        k = (e.tab.ApiSelectionUpdateType = t.mkEnum(n, "tab.ApiSelectionUpdateType", {
      replace: "replace",
      add: "add",
      remove: "remove"
    ...
    var E,
      ...
      registerHandler: function registerHandler(e) {
        ...
        if (t.isValue(e.get_hostId()) || t.isValue(this.$handlers[e.get_hostId()])) throw v.createInternalError("Host '" + e.get_hostId() + "' is already registered.");
      ...
      sendCommand: function sendCommand(e) {
        return function (e, i, n) {
          ...
          if (y.hasWindowPostMessage() && !t.isNullOrUndefined(r) && !t.isNullOrUndefined(r.contentWindow)) {
            var o = s.generateNextCommandId(),
                l = this.$commandCallbacks[a];
            t.isNullOrUndefined(l) && (l = {}, this.$commandCallbacks[a] = l), l[o] = n;
            var u = n.get_commandName(),
                c = null;
            t.isValue(i) && (c = JSON.stringify(i));
            var h = new s(u, o, a, c).serialize();
            y.isPostMessageSynchronous() ? window.setTimeout(function () {
      ...
      $handleStateReadyForQuery: function $handleStateReadyForQuery(e) {
        ...
        if (!y.isNullOrEmpty(i)) for (; i.length > 0;) {
          var n = i.pop();
          t.isValue(n) && n();
        }
      },
      $handleCrossDomainMessage: function $handleCrossDomainMessage(e) {
        ...
        if (!t.isNullOrUndefined(i.data)) {
          var n = s.parse(i.data.toString()),
              r = n.get_hostId(),
              a = this.$handlers[r];
          if (!t.isNullOrUndefined(a) && t.referenceEquals(a.get_hostId(), n.get_hostId()) || (a = this.$findHostIdByDomComparison(i)), n.get_isApiCommandName()) {
      ...
      $handleCrossDomainResponse: function $handleCrossDomainResponse(e) {
        ...
        if (!t.isNullOrUndefined(n) && (delete i[e.get_commandId()], e.get_name() === n.get_commandName())) {
          ...
          if ("api.success" === r.get_result()) switch (n.get_successCallbackTiming()) {
            ...
            default:
              throw v.createInternalError("Unknown timing value: " + n.get_successCallbackTiming());
      ...
      $ctor: function $ctor(e, t, i) {
        var n = new Object();
        return n.value = null, n.formattedValue = null, n.value = e, y.isNullOrEmpty(i) ? n.formattedValue = t : n.formattedValue = i, n;
      },
      ...
      buildApplyFiltersCommandParams: function buildApplyFiltersCommandParams(e, i, n, r) {
        if (y.isNullOrEmpty(e)) throw v.createNullOrEmptyParameter("fieldName");
        n = U.normalizeEnum(b).call(null, n, "updateType");
        var a = [];
        if (p.isArray(i)) for (var s = 0; s < i.length; s++) {
          a.push(i[s].toString());
      ...
      buildRangeFilterCommandParams: function buildRangeFilterCommandParams(e, i) {
        if (y.isNullOrEmpty(e)) throw v.createNullOrEmptyParameter("fieldName");
        if (t.isNullOrUndefined(i)) throw v.createNullOrEmptyParameter("filterOptions");
        var n = {};
        if (n["api.fieldCaption"] = e, t.isValue(i.min)) if (y.isDate(i.min)) {
          var r = t.cast(i.min, t.JsDate);
          if (!y.isDateValid(r)) throw v.createInvalidDateParameter("filterOptions.min");
          n["api.filterRangeMin"] = y.serializeDateForServer(r);
        } else n["api.filterRangeMin"] = i.min;
        if (t.isValue(i.max)) if (y.isDate(i.max)) {
          var a = t.cast(i.max, t.JsDate);
          if (!y.isDateValid(a)) throw v.createInvalidDateParameter("filterOptions.max");
      ...
      buildRelativeDateFilterCommandParams: function buildRelativeDateFilterCommandParams(e, i) {
        if (y.isNullOrEmpty(e)) throw v.createInvalidParameter("fieldName");
        if (t.isNullOrUndefined(i)) throw v.createInvalidParameter("filterOptions");
        var n = {};
        ...
        if (n["api.fieldCaption"] = e, t.isValue(i)) {
          if (n["api.filterPeriodType"] = i.periodType, n["api.filterDateRangeType"] = i.rangeType, "lastn" === i.rangeType || "nextn" === i.rangeType) {
            if (t.isNullOrUndefined(i.rangeN)) throw v.create("missingRangeNForRelativeDateFilters", "Missing rangeN field for a relative date filter of LASTN or NEXTN.");
      ...
      buildHierarchicalFilterCommandParams: function buildHierarchicalFilterCommandParams(e, i, n, r) {
        ...
        if (p.isArray(i)) {
          ...
          var u = i.levels;
          if (s = [], p.isArray(u)) for (var c = u, h = 0; h < c.length; h++) {
            s.push(c[h].toString());
          } else s.push(u.toString());
        } else if (t.isValue(i)) throw v.createInvalidParameter("values");

        var m = {};
        return m["api.fieldCaption"] = e, m["api.filterUpdateType"] = n, m["api.exclude"] = !(!t.isValue(r) || !r.isExcludeMode), t.isValue(a) && (m["api.filterHierarchicalValues"] = JSON.stringify(a)), t.isValue(s) && (m["api.filterHierarchicalLevels"] = JSON.stringify(s)), m;
      },
      ...
      normalizeRangeFilterOption: function normalizeRangeFilterOption(e) {
        if (t.isNullOrUndefined(e)) throw v.createNullOrEmptyParameter("filterOptions");
        if (t.isNullOrUndefined(e.min) && t.isNullOrUndefined(e.max)) throw v.create("invalidParameter", "At least one of filterOptions.min or filterOptions.max must be specified.");
        var i = new Object();
      ...
      normalizeRelativeDateFilterOptions: function normalizeRelativeDateFilterOptions(e) {
        ...
        if (i.rangeType = U.normalizeEnum(_).call(null, e.rangeType, "filterOptions.rangeType"), i.periodType = U.normalizeEnum(T).call(null, e.periodType, "filterOptions.periodType"), "lastn" === i.rangeType || "nextn" === i.rangeType) {
          if (t.isNullOrUndefined(e.rangeN)) throw v.create("missingRangeNForRelativeDateFilters", "Missing rangeN field for a relative date filter of LASTN or NEXTN.");
          i.rangeN = y.toInt(e.rangeN);
        }

        if (t.isValue(e.anchorDate)) {
          if (!y.isDate(e.anchorDate) || !y.isDateValid(e.anchorDate)) throw v.createInvalidDateParameter("filterOptions.anchorDate");
      ...
      $processUnderlyingColumns: function $processUnderlyingColumns(e) {
        for (var t = [], i = 0; i < e.length; i++) {
          var n = e[i],
              r = new h(n.fieldName, w.convertDataType(n.dataType), n.isReferenced, n.index);
          t.push(new W(r));
        }
      ...
      if (this.$clonedPairs = null, this.$collection = new i._Collection(), this.$tupleId = 0, p.isArray(e)) for (var n = e, r = 0; r < n.length; r++) {
        var a = n[r];
        if (!t.isValue(a.fieldName)) throw v.createInvalidParameter("pair.fieldName");
        if (!t.isValue(a.value)) throw v.createInvalidParameter("pair.value");
      ...
      normalizeEnum: function normalizeEnum(e) {
        return function (t, i) {
          var n = {};
          if (!U.tryNormalizeEnum(e).call(null, t, n)) throw v.createInvalidParameter(i);
          return n.$;
        };
      },
  ...
  function () {
    ...
    var r = t.mkType(n, "tab.$CustomViewEventContext", function (e, t) {
      ...
      get_$dateStepPeriod: function get_$dateStepPeriod() {
        ...
        h = e.tab._ApiBootstrap = t.mkType(n, "tab._ApiBootstrap", null, null, {
      ...
      $saveAsync: function $saveAsync() {
        ...
        var r = m.$createCustomViewCommandReturnHandler("api.UpdateCustomViewCommand", e, t.mkdel(this, function (t) {
      ...
      $removeAsync: function $removeAsync() {
        var e = new i._Deferred(),
            n = {};
        n["api.customViewParam"] = this.$presModel;
        var r = m.$createCustomViewCommandReturnHandler("api.RemoveCustomViewCommand", e, t.mkdel(this, function (t) {
      ...
      _saveNewAsync: function _saveNewAsync(e, n, r) {
        ...
        var o = m.$createCustomViewCommandReturnHandler("api.SaveNewCustomViewCommand", a, function (i) {
      ...
      _showCustomViewAsync: function _showCustomViewAsync(e, n, r) {
        ...
        var o = m.$createCustomViewCommandReturnHandler("api.ShowCustomViewCommand", a, function (t) {
      ...
      changeSizeAsync: function changeSizeAsync(e) {
        if (e = f.$normalizeSheetSize(e), "worksheet" === this.$sheetType && "automatic" !== e.behavior) throw i._TableauException.createInvalidSizeBehaviorOnWorksheet();
        var n = new i._Deferred();
      ...
      $normalizeSheetSize: function $normalizeSheetSize(e) {
        var n = i.PublicEnums.normalizeEnum(i.ApiSheetSizeBehavior).call(null, e.behavior, "size.behavior"),
            r = e.minSize;
        t.isValue(r) && (r = i.Size.$ctor(f.$convertValueToIntIfValid(e.minSize.width), f.$convertValueToIntIfValid(e.minSize.height)));
        var a = e.maxSize;
        return t.isValue(a) && (a = i.Size.$ctor(f.$convertValueToIntIfValid(e.maxSize.width), f.$convertValueToIntIfValid(e.maxSize.height))), i.SheetSize.$ctor(n, r, a);
      }
    }),
        g = e.tab._SheetInfoImpl = t.mkType(n, "tab._SheetInfoImpl", null, null, {
      ...
      update: function update(e) {
        ...
        if (h) {
          var d = v.createContainedSheet(i, this.get_workbookImpl(), this.get_messagingOptions(), this.$findSheetFunc);
      ...
      $updateActiveState: function $updateActiveState(e) {
        ...
        if (t.get_index() !== i) {
          var n = this.$storyPointsInfo[t.get_index()],
              ...
              a = v.createContainedSheet(e.containedSheetInfo, this.get_workbookImpl(), this.get_messagingOptions(), this.$findSheetFunc);
          r.isActive = !0, this.$activeStoryPointImpl = new v(r, a), t.set_isActive(!1), n._impl.isActive = !1, this.$raiseActiveStoryPointChange(n, this.$activeStoryPointImpl.get_storyPoint());
        }
      },
      ...
      createContainedSheet: function createContainedSheet(e, n, r, a) {
        ...
        var s = i.ApiEnumConverter.convertSheetType(e.sheetType),
            ...
            c = u ? "" : l.getUrl(),
            h = g.$ctor(e.name, s, -1, o, n.get_workbook(), c, !1, u, e.zoneId);
        ...
        y = e.tab._StoryPointInfoImpl = t.mkType(n, "tab._StoryPointInfoImpl", null, null, {
      ...
      _setActiveSheetAsync: function _setActiveSheetAsync(e) {
        ...
        if (this.$activeSheetImpl.get_isDashboard()) {
          var s = t.cast(this.$activeSheetImpl, d).get_worksheets()._get(r);
      ...
      $initializeActiveSheet: function $initializeActiveSheet(e) {
        ...
        if (!t.isValue(this.$activeSheetImpl) || !t.referenceEquals(this.$activeSheetImpl.get_name(), n)) {
          if (t.isValue(this.$activeSheetImpl)) {
            ...
            if (t.isValue(a) && (a.$impl.isActive = !1), "story" === this.$activeSheetImpl.get_sheetType()) t.cast(this.$activeSheetImpl, $).remove_activeStoryPointChange(t.mkdel(this.$vizImpl, this.$vizImpl.raiseStoryPointSwitch));
          }
          ...
          if (t.isValue(this.$activatingHiddenSheetImpl)) {
            ...
            if (t.isNullOrUndefined(o)) throw i._TableauException.createInternalError("No base sheet was found corresponding to the active sheet.");
            ...
            if ("dashboard" === o.sheetType) {
              ...
              var p = new $(r.$impl, this, this.$messagingOptions, e.story, c);
              this.$activeSheetImpl = p, p.add_activeStoryPointChange(t.mkdel(this.$vizImpl, this.$vizImpl.raiseStoryPointSwitch));
            } else this.$activeSheetImpl = new C(r.$impl, this, this.$messagingOptions, null);
        ...
        if (!t.isNullOrUndefined(n)) for (var r = 0; r < n.length; r++) {
          ...
          if (t.isNullOrUndefined(o)) {
            var u = t.referenceEquals(s, e.currentSheetName),
                ...
                h = g.$ctor(s, c, r, l, this.get_workbook(), a.repositoryUrl, u, !1, f.noZoneId);
      ...
      $showCustomViewAsync: function $showCustomViewAsync(e) {
        if (t.isNullOrUndefined(e) || i._Utility.isNullOrEmpty(e)) return m._showCustomViewAsync(this, this.$messagingOptions, null);
      ...
      $getFilterAsync: function $getFilterAsync(e, n, r) {
        ...
        var a = new i._Deferred(),
            s = {};
        this.$addVisualIdToCommand(s), !i._Utility.isNullOrEmpty(n) && i._Utility.isNullOrEmpty(e) && (s["api.fieldCaption"] = n), i._Utility.isNullOrEmpty(e) || (s["api.fieldName"] = e), s["api.filterHierarchicalLevels"] = 0, s["api.ignoreDomain"] = r.ignoreDomain || !1;
      ...
      $getFiltersAsync: function $getFiltersAsync(e) {
        ...
        var n = new i._Deferred(),
            r = {};
        this.$addVisualIdToCommand(r), r["api.ignoreDomain"] = e.ignoreDomain || !1;
      ...
      $parseMarksParam: function $parseMarksParam(e, n, r, a, s, o, l, u) {
        var c = u;
        if (C.$regexHierarchicalFieldName.test(l)) this.$addToParamLists(r, a, l, u);else if (t.isValue(c.min) || t.isValue(c.max)) {
          var h = new Object();
      ...
      getParameterAsync: function getParameterAsync() {
        ...
        D = e.tab.StoryPointInfoImplUtil = t.mkType(n, "tab.StoryPointInfoImplUtil", null, null, {
      clone: function clone(e) {
      ...
      this.$messagingOptions = new O(e, this), this.$viz = n, (t.isNullOrUndefined(r) || 1 !== r.nodeType) && (r = document.body), this.$parameters = new b(r, a, s), t.isValue(s) && (this.$onFirstInteractiveCallback = s.onFirstInteractive, this.$onFirstVizSizeKnownCallback = s.onFirstVizSizeKnown);
    }, {
      ...
      $invokeCommand: function $invokeCommand(e, n) {
        if ("showExportImageDialog" !== e && "showExportDataDialog" !== e && "showExportCrosstabDialog" !== e && "showExportPDFDialog" !== e && "showShareDialog" !== e && "showDownloadWorkbookDialog" !== e) throw i._TableauException.createInternalError(null);
        var r = {};
      ...
      $handleFilterChangedEvent: function $handleFilterChangedEvent(e) {
        if (!t.staticEquals(this.$1$FilterChangeField, null) && t.referenceEquals(this.$workbookImpl.get_name(), e.get_workbookName())) {
          ...
          if (t.referenceEquals(n.get_name(), e.get_worksheetName())) i = t.cast(n, C);else if (n.get_isDashboard()) {
            ...
            var r = t.cast(n, $).get_activeStoryPointImpl().get_containedSheetImpl();
            if (r.get_isDashboard()) i = t.cast(r, d).get_worksheets()._get(e.get_worksheetName())._impl;else t.referenceEquals(r.get_name(), e.get_worksheetName()) && (i = t.cast(r, C));
          }
          ...
          if (t.isValue(i)) {
            var a = t.cast(JSON.parse(t.cast(e.get_data(), String)), Array),
                s = a[0],
                o = a[1];
            this.$1$FilterChangeField(new k("filterchange", this.$viz, i, s, o));
          }
        }
      },
      ...
      $handleCustomViewSetDefaultEvent: function $handleCustomViewSetDefaultEvent(e) {
        var i = JSON.parse(t.cast(e.get_data(), String));
        if (t.isValue(this.$workbookImpl) && m._processCustomViews(this.$workbookImpl, this.$messagingOptions, i), !t.staticEquals(this.$1$CustomViewSetDefaultField, null) && t.isValue(i.defaultCustomViewId)) for (var n = this.$workbookImpl.get_$customViews(), r = 0; r < n.get__length(); r++) {
          var a = n.get_item(r);
      ...
      $handleInitialVizSize: function $handleInitialVizSize(e) {
        ...
        this.$vizSize = j.$ctor(n, e.chromeHeight), t.isValue(this.$onFirstVizSizeKnownCallback) && this.$onFirstVizSizeKnownCallback(new E("firstvizsizeknown", this.$viz, this.$vizSize)), this.$parameters.fixedSize || (this.$refreshSize(), this.$addWindowResizeHandler(), this.$show());
      },
    ...
    t.initClass(T), t.initClass(r, T), t.initClass(a), t.initClass(s, T), t.initClass(o, T), t.initClass(l, T), t.initClass(u, T), t.initClass(c), t.initClass(h), t.initClass(m), t.initClass(f), t.initClass(d, f), t.initClass(p), t.initClass(g, Object), t.initClass($, f), t.initClass(v), t.initClass(y, Object), t.initClass(_), t.initClass(w), t.initClass(b), t.initClass(S), t.initClass(C, f), t.initClass(x), t.initClass(I, x), t.initClass(W, x), t.initClass(k, W), t.initClass(E, x), t.initClass(A, W), t.initInterface(V, {
