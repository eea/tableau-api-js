       ...
       steps {
           script{
             withSonarQubeEnv('Sonarqube') {
               sh "sonar-scanner -Dsonar.javascript.lcov.reportPaths=.src/coverage/lcov.info -Dsonar.sources=./src -Dsonar.projectKey=$GIT_NAME-$BRANCH_NAME -Dsonar.projectVersion=$BRANCH_NAME-$BUILD_NUMBER"
